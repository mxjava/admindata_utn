...
namespace GeneXus.Programs {
   public class viewvacantes : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public viewvacantes( )
      {
      ...
      public viewvacantes( IGxContext context )
      {
      ...
      public void execute( int aP0_Vacantes_Id ,
                           String aP1_TabCode )
      {
         this.AV12Vacantes_Id = aP0_Vacantes_Id;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12Vacantes_Id = (int)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV12Vacantes_Id", StringUtil.LTrimStr( (decimal)(AV12Vacantes_Id), 9, 0));
               GxWebStd.gx_hidden_field( context, "gxhash_vVACANTES_ID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12Vacantes_Id), "ZZZZZZZZ9"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202262714345032", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("viewvacantes.aspx") + "?" + UrlEncode("" +AV12Vacantes_Id) + "," + UrlEncode(StringUtil.RTrim(AV6TabCode))+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("hshsalt", "hsh"+"ViewVacantes");
         forbiddenHiddens.Add("Vacantes_Nombre", StringUtil.RTrim( context.localUtil.Format( A264Vacantes_Nombre, "")));
         GxWebStd.gx_hidden_field( context, "hsh", GetEncryptedHash( forbiddenHiddens.ToString(), GXKey));
         GXUtil.WriteLogInfo("viewvacantes:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vVACANTES_ID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12Vacantes_Id), 9, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vVACANTES_ID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12Vacantes_Id), "ZZZZZZZZ9"), context));
      ...
      {
         return formatLink("viewvacantes.aspx") + "?" + UrlEncode("" +AV12Vacantes_Id) + "," + UrlEncode(StringUtil.RTrim(AV6TabCode)) ;
      }
      ...
      protected void WB260( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewtitle_Internalname, "Información Vacantes", "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, "HLP_ViewVacantes.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 ViewActionsBackCell", "Right", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Vacantes", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "BtnTextBlockBack", 0, "", lblViewall_Visible, 1, 0, "HLP_ViewVacantes.htm");
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtVacantes_Nombre_Internalname, A264Vacantes_Nombre, StringUtil.RTrim( context.localUtil.Format( A264Vacantes_Nombre, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtVacantes_Nombre_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtVacantes_Nombre_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_ViewVacantes.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_ViewVacantes.htm");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblUsuariosvacante_title_Internalname, "Usuarios Vacante", "", "", lblUsuariosvacante_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_ViewVacantes.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0038"+"", StringUtil.RTrim( WebComp_Usuariosvacantewc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
               ...
               if ( StringUtil.Len( sEvt) > 0 )
               {
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     ...
                     else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                     {
                        ...
                        {
                           OldUsuariosvacantewc = cgiGet( "W0038");
                           ...
                           if ( StringUtil.Len( WebComp_Usuariosvacantewc_Component) != 0 )
                           {
                              WebComp_Usuariosvacantewc.componentprocess("W0038", "", sEvt);
                           }
                           WebComp_Usuariosvacantewc_Component = OldUsuariosvacantewc;
                        }
                     }
      ...
      protected void RF262( )
      {
         ...
         {
            /* Using cursor H00262 */
            pr_default.execute(0, new Object[] {AV12Vacantes_Id});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A263Vacantes_Id = H00262_A263Vacantes_Id[0];
               A264Vacantes_Nombre = H00262_A264Vacantes_Nombre[0];
      ...
      protected void STRUP260( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV12Vacantes_Id = (int)(context.localUtil.CToN( cgiGet( "vVACANTES_ID"), ",", "."));
            ...
            {
               GXUtil.WriteLogError("viewvacantes:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
               GxWebError = 1;
      ...
      protected void E11262( )
      {
         ...
         AV16GXLvl6 = 0;
         /* Using cursor H00263 */
         pr_default.execute(1, new Object[] {AV12Vacantes_Id});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A263Vacantes_Id = H00263_A263Vacantes_Id[0];
            A264Vacantes_Nombre = H00263_A264Vacantes_Nombre[0];
            AssignAttri("", false, "A264Vacantes_Nombre", A264Vacantes_Nombre);
            AV16GXLvl6 = 1;
            Form.Caption = A264Vacantes_Nombre;
            AssignProp("", false, "FORM", "Caption", Form.Caption, true);
            lblViewall_Link = formatLink("wpvacantes.aspx") ;
      ...
      protected void S112( )
      {
         ...
         {
            /* Object Property */
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "VacantesGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "vacantesgeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "VacantesGeneral";
               WebComp_Generalwc_Component = "VacantesGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(String)"W0030",(String)"",(int)AV12Vacantes_Id});
         ...
         {
            /* Object Property */
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Usuariosvacantewc_Component), StringUtil.Lower( "VacantesUsuariosVacanteWC")) != 0 )
            {
               WebComp_Usuariosvacantewc = getWebComponent(GetType(), "GeneXus.Programs", "vacantesusuariosvacantewc", new Object[] {context} );
               WebComp_Usuariosvacantewc.ComponentInit();
               WebComp_Usuariosvacantewc.Name = "VacantesUsuariosVacanteWC";
               WebComp_Usuariosvacantewc_Component = "VacantesUsuariosVacanteWC";
            }
            if ( StringUtil.Len( WebComp_Usuariosvacantewc_Component) != 0 )
            {
               WebComp_Usuariosvacantewc.setjustcreated();
               WebComp_Usuariosvacantewc.componentprepare(new Object[] {(String)"W0038",(String)"",(int)AV12Vacantes_Id});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV12Vacantes_Id = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV12Vacantes_Id", StringUtil.LTrimStr( (decimal)(AV12Vacantes_Id), 9, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vVACANTES_ID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12Vacantes_Id), "ZZZZZZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202262714345051", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewvacantes.js", "?202262714345051", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12Vacantes_Id',fld:'vVACANTES_ID',pic:'ZZZZZZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A264Vacantes_Nombre',fld:'VACANTES_NOMBRE',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         AV15Pgmname = "";
         scmdbuf = "";
         H00262_A263Vacantes_Id = new int[1] ;
         H00262_A264Vacantes_Nombre = new String[] {""} ;
         hsh = "";
         H00263_A263Vacantes_Id = new int[1] ;
         H00263_A264Vacantes_Nombre = new String[] {""} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewvacantes__default(),
            new Object[][] {
                new Object[] {
               H00262_A263Vacantes_Id, H00262_A264Vacantes_Nombre
               }
               , new Object[] {
               H00263_A263Vacantes_Id, H00263_A264Vacantes_Nombre
               }
            }
         );
      ...
      private int wcpOAV12Vacantes_Id ;
      ...
      private int[] H00262_A263Vacantes_Id ;
      private String[] H00262_A264Vacantes_Nombre ;
      private int[] H00263_A263Vacantes_Id ;
      private String[] H00263_A264Vacantes_Nombre ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private GXWebForm Form ;
   }

   public class viewvacantes__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"AV12Vacantes_Id",System.Data.DbType.Int32,9,0}
          } ;
          Object[] prmH00263 ;
          ...
          def= new CursorDef[] {
              new CursorDef("H00262", "SELECT `Vacantes_Id`, `Vacantes_Nombre` FROM `Vacantes` WHERE `Vacantes_Id` = ? ORDER BY `Vacantes_Id` ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00262,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H00263", "SELECT `Vacantes_Id`, `Vacantes_Nombre` FROM `Vacantes` WHERE `Vacantes_Id` = ? ORDER BY `Vacantes_Id` ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00263,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
