...
namespace GeneXus.Programs {
   public class viewperfiles : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public viewperfiles( )
      {
      ...
      public viewperfiles( IGxContext context )
      {
      ...
      public void execute( int aP0_Perfiles_Id ,
                           String aP1_TabCode )
      {
         this.AV12Perfiles_Id = aP0_Perfiles_Id;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202262714345172", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         GXEncryptionTmp = "viewperfiles.aspx"+UrlEncode("" +AV12Perfiles_Id) + "," + UrlEncode(StringUtil.RTrim(AV6TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("viewperfiles.aspx") + "?" + Encrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_vPERFILES_ID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12Perfiles_Id), "ZZZZZZZZ9"), context));
         ...
         forbiddenHiddens.Add("hshsalt", "hsh"+"ViewPerfiles");
         forbiddenHiddens.Add("Perfiles_Nombre", StringUtil.RTrim( context.localUtil.Format( A279Perfiles_Nombre, "")));
         GxWebStd.gx_hidden_field( context, "hsh", GetEncryptedHash( forbiddenHiddens.ToString(), GXKey));
         GXUtil.WriteLogInfo("viewperfiles:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vPERFILES_ID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12Perfiles_Id), 9, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vPERFILES_ID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12Perfiles_Id), "ZZZZZZZZ9"), context));
      ...
      public override String GetSelfLink( )
      {
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "viewperfiles.aspx"+UrlEncode("" +AV12Perfiles_Id) + "," + UrlEncode(StringUtil.RTrim(AV6TabCode));
         return formatLink("viewperfiles.aspx") + "?" + Encrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }
      ...
      protected void WB2K0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewtitle_Internalname, "Información Perfiles", "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, "HLP_ViewPerfiles.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 ViewActionsBackCell", "Right", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Perfiles", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "BtnTextBlockBack", 0, "", lblViewall_Visible, 1, 0, "HLP_ViewPerfiles.htm");
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtPerfiles_Nombre_Internalname, A279Perfiles_Nombre, StringUtil.RTrim( context.localUtil.Format( A279Perfiles_Nombre, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtPerfiles_Nombre_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtPerfiles_Nombre_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_ViewPerfiles.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_ViewPerfiles.htm");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblUsuariosperfil_title_Internalname, "Usuarios Perfil", "", "", lblUsuariosperfil_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_ViewPerfiles.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0038"+"", StringUtil.RTrim( WebComp_Usuariosperfilwc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
               ...
               if ( StringUtil.Len( sEvt) > 0 )
               {
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     ...
                     else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                     {
                        ...
                        {
                           OldUsuariosperfilwc = cgiGet( "W0038");
                           ...
                           if ( StringUtil.Len( WebComp_Usuariosperfilwc_Component) != 0 )
                           {
                              WebComp_Usuariosperfilwc.componentprocess("W0038", "", sEvt);
                           }
                           WebComp_Usuariosperfilwc_Component = OldUsuariosperfilwc;
                        }
                     }
      ...
      protected void PA2K2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "viewperfiles.aspx")), "viewperfiles.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "viewperfiles.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV12Perfiles_Id = (int)(NumberUtil.Val( gxfirstwebparm, "."));
                     AssignAttri("", false, "AV12Perfiles_Id", StringUtil.LTrimStr( (decimal)(AV12Perfiles_Id), 9, 0));
                     GxWebStd.gx_hidden_field( context, "gxhash_vPERFILES_ID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12Perfiles_Id), "ZZZZZZZZ9"), context));
      ...
      protected void RF2K2( )
      {
         ...
         {
            /* Using cursor H002K2 */
            pr_default.execute(0, new Object[] {AV12Perfiles_Id});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A278Perfiles_Id = H002K2_A278Perfiles_Id[0];
               A279Perfiles_Nombre = H002K2_A279Perfiles_Nombre[0];
      ...
      protected void STRUP2K0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV12Perfiles_Id = (int)(context.localUtil.CToN( cgiGet( "vPERFILES_ID"), ",", "."));
            ...
            {
               GXUtil.WriteLogError("viewperfiles:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
               GxWebError = 1;
               context.HttpContext.Response.StatusDescription = 403.ToString();
               context.HttpContext.Response.StatusCode = 403;
               context.WriteHtmlText( "<title>403 Forbidden</title>") ;
      ...
      protected void E112K2( )
      {
         ...
         AV16GXLvl6 = 0;
         /* Using cursor H002K3 */
         pr_default.execute(1, new Object[] {AV12Perfiles_Id});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A278Perfiles_Id = H002K3_A278Perfiles_Id[0];
            A279Perfiles_Nombre = H002K3_A279Perfiles_Nombre[0];
            AssignAttri("", false, "A279Perfiles_Nombre", A279Perfiles_Nombre);
            AV16GXLvl6 = 1;
            Form.Caption = A279Perfiles_Nombre;
            AssignProp("", false, "FORM", "Caption", Form.Caption, true);
            lblViewall_Link = formatLink("wwperfiles.aspx") ;
      ...
      protected void S112( )
      {
         ...
         {
            /* Object Property */
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "PerfilesGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "perfilesgeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "PerfilesGeneral";
               WebComp_Generalwc_Component = "PerfilesGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(String)"W0030",(String)"",(int)AV12Perfiles_Id});
         ...
         {
            /* Object Property */
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Usuariosperfilwc_Component), StringUtil.Lower( "PerfilesUsuariosPerfilWC")) != 0 )
            {
               WebComp_Usuariosperfilwc = getWebComponent(GetType(), "GeneXus.Programs", "perfilesusuariosperfilwc", new Object[] {context} );
               WebComp_Usuariosperfilwc.ComponentInit();
               WebComp_Usuariosperfilwc.Name = "PerfilesUsuariosPerfilWC";
               WebComp_Usuariosperfilwc_Component = "PerfilesUsuariosPerfilWC";
            }
            if ( StringUtil.Len( WebComp_Usuariosperfilwc_Component) != 0 )
            {
               WebComp_Usuariosperfilwc.setjustcreated();
               WebComp_Usuariosperfilwc.componentprepare(new Object[] {(String)"W0038",(String)"",(int)AV12Perfiles_Id});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV12Perfiles_Id = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV12Perfiles_Id", StringUtil.LTrimStr( (decimal)(AV12Perfiles_Id), 9, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vPERFILES_ID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12Perfiles_Id), "ZZZZZZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202262714345190", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewperfiles.js", "?202262714345191", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12Perfiles_Id',fld:'vPERFILES_ID',pic:'ZZZZZZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A279Perfiles_Nombre',fld:'PERFILES_NOMBRE',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         AV15Pgmname = "";
         scmdbuf = "";
         H002K2_A278Perfiles_Id = new int[1] ;
         H002K2_A279Perfiles_Nombre = new String[] {""} ;
         hsh = "";
         H002K3_A278Perfiles_Id = new int[1] ;
         H002K3_A279Perfiles_Nombre = new String[] {""} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewperfiles__default(),
            new Object[][] {
                new Object[] {
               H002K2_A278Perfiles_Id, H002K2_A279Perfiles_Nombre
               }
               , new Object[] {
               H002K3_A278Perfiles_Id, H002K3_A279Perfiles_Nombre
               }
            }
         );
      ...
      private int wcpOAV12Perfiles_Id ;
      ...
      private int[] H002K2_A278Perfiles_Id ;
      private String[] H002K2_A279Perfiles_Nombre ;
      private int[] H002K3_A278Perfiles_Id ;
      private String[] H002K3_A279Perfiles_Nombre ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private GXWebForm Form ;
   }

   public class viewperfiles__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H002K2", "SELECT `Perfiles_Id`, `Perfiles_Nombre` FROM `Perfiles` WHERE `Perfiles_Id` = ? ORDER BY `Perfiles_Id` ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002K2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H002K3", "SELECT `Perfiles_Id`, `Perfiles_Nombre` FROM `Perfiles` WHERE `Perfiles_Id` = ? ORDER BY `Perfiles_Id` ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002K3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
