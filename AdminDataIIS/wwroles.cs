...
namespace GeneXus.Programs {
   public class wwroles : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrGrid_refresh( subGrid_Rows, AV13RolNombre, AV19Pgmname, AV14Update, AV15Delete) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202262714344897", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vROLNOMBRE", AV13RolNombre);
         /* Send saved values. */
      ...
      protected void WB1M0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            ClassString = "BtnAdd";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(25), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWRoles.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_label_element( context, edtavRolnombre_Internalname, "Rol Nombre", "col-sm-3 FilterSearchAttributeLabel", 0, true, "");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 16,'',false,'" + sGXsfl_25_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavRolnombre_Internalname, AV13RolNombre, StringUtil.RTrim( context.localUtil.Format( AV13RolNombre, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Nombre", edtavRolnombre_Jsonclick, 0, "FilterSearchAttribute", "", "", "", "", 1, edtavRolnombre_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_WWRoles.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            else
            {
               ...
               GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A24RolId), 9, 0, ".", "")));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", A127RolNombre);
               GridColumn.AddObjectProperty("Link", StringUtil.RTrim( edtRolNombre_Link));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", A128RolDescripcion);
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    {
                                       Rfr0gs = false;
                                       /* Set Refresh If Rolnombre Changed */
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vROLNOMBRE"), AV13RolNombre) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void PA1M2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ! context.isAjaxRequest( ) )
            {
               GX_FocusControl = edtavRolnombre_Internalname;
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_ROLID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(A24RolId), "ZZZZZZZZ9"), context));
      ...
      protected void RF1M2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV13RolNombre = StringUtil.Concat( StringUtil.RTrim( AV13RolNombre), "%", "");
            /* Using cursor H001M2 */
            pr_default.execute(0, new Object[] {lV13RolNombre, GXPagingFrom2, GXPagingTo2});
            nGXsfl_25_idx = 1;
            sGXsfl_25_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_25_idx), 4, 0), 4, "0");
            SubsflControlProps_252( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A128RolDescripcion = H001M2_A128RolDescripcion[0];
               A127RolNombre = H001M2_A127RolNombre[0];
               A24RolId = H001M2_A24RolId[0];
               E141M2 ();
      ...
      protected void send_integrity_lvl_hashes1M2( )
      {
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV19Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV19Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, "gxhash_ROLID"+"_"+sGXsfl_25_idx, GetSecureSignedToken( sGXsfl_25_idx, context.localUtil.Format( (decimal)(A24RolId), "ZZZZZZZZ9"), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV13RolNombre = StringUtil.Concat( StringUtil.RTrim( AV13RolNombre), "%", "");
         /* Using cursor H001M3 */
         pr_default.execute(1, new Object[] {lV13RolNombre});
      ...
      protected void STRUP1M0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV13RolNombre = cgiGet( edtavRolnombre_Internalname);
            AssignAttri("", false, "AV13RolNombre", AV13RolNombre);
      ...
      {
         /* Grid_Load Routine */
         edtavUpdate_Link = formatLink("roles.aspx") + "?" + UrlEncode(StringUtil.RTrim("UPD")) + "," + UrlEncode("" +A24RolId);
         edtavDelete_Link = formatLink("roles.aspx") + "?" + UrlEncode(StringUtil.RTrim("DLT")) + "," + UrlEncode("" +A24RolId);
      ...
      protected void S122( )
      {
         ...
         if ( StringUtil.StrCmp(AV7HTTPRequest.Method, "GET") == 0 )
         {
            ...
            {
               AV13RolNombre = ((SdtGridState_FilterValue)AV8GridState.gxTpr_Filtervalues.Item(1)).gxTpr_Value;
               AssignAttri("", false, "AV13RolNombre", AV13RolNombre);
            }
      ...
      protected void S132( )
      {
         ...
         AV9GridStateFilterValue.gxTpr_Value = AV13RolNombre;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202262714344920", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwroles.js", "?202262714344921", false, true);
         }
      ...
      protected void SubsflControlProps_252( )
      {
         ...
         edtRolNombre_Internalname = "ROLNOMBRE_"+sGXsfl_25_idx;
         edtRolDescripcion_Internalname = "ROLDESCRIPCION_"+sGXsfl_25_idx;
      ...
      protected void SubsflControlProps_fel_252( )
      {
         ...
         edtRolNombre_Internalname = "ROLNOMBRE_"+sGXsfl_25_fel_idx;
         edtRolDescripcion_Internalname = "ROLDESCRIPCION_"+sGXsfl_25_fel_idx;
      ...
      protected void sendrow_252( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_25_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtRolDescripcion_Internalname,(String)A128RolDescripcion,(String)"",(String)"",(String)"'"+""+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtRolDescripcion_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn WWOptionalColumn",(String)"",(short)-1,(short)0,(short)0,(String)"text",(String)"",(short)0,(String)"px",(short)17,(String)"px",(short)150,(short)0,(short)0,(short)25,(short)1,(short)-1,(short)-1,(bool)true,(String)"",(String)"left",(bool)true,(String)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
      ...
      protected void init_default_properties( )
      {
         ...
         edtavRolnombre_Internalname = "vROLNOMBRE";
      ...
      public override void initialize_properties( )
      {
         ...
         edtavRolnombre_Jsonclick = "";
         edtavRolnombre_Enabled = 1;
         Form.Headerrawhtml = "";
         Form.Background = "";
         Form.Textcolor = 0;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14Update',fld:'vUPDATE',pic:''},{av:'AV15Delete',fld:'vDELETE',pic:''},{av:'AV13RolNombre',fld:'vROLNOMBRE',pic:''},{av:'AV19Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E141M2',iparms:[{av:'A24RolId',fld:'ROLID',pic:'ZZZZZZZZ9',hsh:true}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtRolNombre_Link',ctrl:'ROLNOMBRE',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E111M2',iparms:[{av:'A24RolId',fld:'ROLID',pic:'ZZZZZZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14Update',fld:'vUPDATE',pic:''},{av:'AV15Delete',fld:'vDELETE',pic:''},{av:'AV19Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13RolNombre',fld:'vROLNOMBRE',pic:''}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14Update',fld:'vUPDATE',pic:''},{av:'AV15Delete',fld:'vDELETE',pic:''},{av:'AV19Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13RolNombre',fld:'vROLNOMBRE',pic:''}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14Update',fld:'vUPDATE',pic:''},{av:'AV15Delete',fld:'vDELETE',pic:''},{av:'AV19Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13RolNombre',fld:'vROLNOMBRE',pic:''}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14Update',fld:'vUPDATE',pic:''},{av:'AV15Delete',fld:'vDELETE',pic:''},{av:'AV19Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13RolNombre',fld:'vROLNOMBRE',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV13RolNombre = "";
         H001M2_A128RolDescripcion = new String[] {""} ;
         H001M2_A127RolNombre = new String[] {""} ;
         H001M2_A24RolId = new int[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwroles__default(),
            new Object[][] {
                new Object[] {
               H001M2_A128RolDescripcion, H001M2_A127RolNombre, H001M2_A24RolId
               }
               , new Object[] {
      ...
      private int edtavRolnombre_Enabled ;
      ...
      private String edtavRolnombre_Internalname ;
      private String edtavRolnombre_Jsonclick ;
      ...
      private String[] H001M2_A128RolDescripcion ;
      private String[] H001M2_A127RolNombre ;
      private int[] H001M2_A24RolId ;
   ...
   public class wwroles__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             String A127RolNombre )
      {
         ...
         String sFromString ;
         String sOrderString ;
         sSelectString = " `RolDescripcion`, `RolNombre`, `RolId`";
         sFromString = " FROM `Roles`";
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV13RolNombre)) )
         {
            if ( StringUtil.StrCmp("", sWhereString) != 0 )
            {
               sWhereString = sWhereString + " and (`RolNombre` like ?)";
            }
            else
            {
               sWhereString = sWhereString + " (`RolNombre` like ?)";
            }
         }
         else
         {
         ...
         sOrderString = sOrderString + " ORDER BY `RolNombre`";
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"lV13RolNombre",System.Data.DbType.String,40,0} ,
