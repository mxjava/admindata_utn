...
namespace GeneXus.Programs {
   public class wpreclusegcord : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public wpreclusegcord( )
      {
      ...
      public wpreclusegcord( IGxContext context )
      {
      ...
      {
         this.AV17vacantes_id = aP0_vacantes_id;
         executePrivate();
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
            {
               ...
               AssignProp("", false, edtavVacantes_id_envio_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtavVacantes_id_envio_Visible), 5, 0), !bGXsfl_44_Refreshing);
               AV5adjuntar = GetNextPar( );
               AV17vacantes_id = (int)(NumberUtil.Val( GetNextPar( ), "."));
               ...
               gxgrGrid1_refresh( subGrid1_Rows, AV5adjuntar, AV17vacantes_id, A263Vacantes_Id, A290VacantesUsuariosEstatus, AV24VacantesUsuariosEstatus, A11UsuariosId, A260UsuariosTelef, A261UsuariosCorreo, A284SUBT_ReclutadorId, A288VacantesUsuariosFechaP, A292VacantesUsuariosCV, A291VacantesUsuariosPrefiltro, A293VacantesUsuariosExTec, A295VacantesUsuariosFechaE, A314VacantesUsuariosFecha3, A304VacantesUsuariosAvConf, A303VacantesUsuariosAvPriv, A302VacantesUsuariosBusWeb, A301VacantesUsuariosExPsi, A300VacantesUsuariosRefLab, A299VacantesUsuariosCVRec, A313VacantesUsuariosFechaA, A289VacantesUsuariosFechaD, A294VacantesUsuariosMotD) ;
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid2") == 0 )
            {
               ...
               gxgrGrid2_refresh( subGrid1_Rows, AV17vacantes_id) ;
               AddString( context.getJSONResponse( )) ;
               return  ;
            }
            else
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20226271435011", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( nGXWrapped != 1 )
         {
            ...
            GXEncryptionTmp = "wpreclusegcord.aspx"+UrlEncode("" +AV17vacantes_id);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wpreclusegcord.aspx") + "?" + Encrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_vVACANTES_ID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV17vacantes_id), "ZZZZZZZZ9"), context));
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vVACANTES_ID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV17vacantes_id), 9, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vVACANTES_ID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV17vacantes_id), "ZZZZZZZZ9"), context));
      ...
      public override String GetSelfLink( )
      {
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "wpreclusegcord.aspx"+UrlEncode("" +AV17vacantes_id);
         return formatLink("wpreclusegcord.aspx") + "?" + Encrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override String GetPgmname( )
      {
         return "wpRecluSegCord" ;
      }
      ...
      protected void WB380( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock4_Internalname, "Text Block", "", "", lblTextblock4_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", lblTextblock4_Visible, 1, 0, "HLP_wpRecluSegCord.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock2_Internalname, lblTextblock2_Caption, "", "", lblTextblock2_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", ((lblTextblock2_Fontbold==1) ? "font-weight:bold;" : "font-weight:normal;"), "Title", 0, "", 1, 1, 0, "HLP_wpRecluSegCord.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 50, "px", "col-xs-6", "Right", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock3_Internalname, "Regresar", "", "", lblTextblock3_Jsonclick, "'"+""+"'"+",false,"+"'"+"e11381_client"+"'", "", "BtnTextBlockBack", 7, "", 1, 1, 0, "HLP_wpRecluSegCord.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock1_Internalname, "Text Block", "", "", lblTextblock1_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", lblTextblock1_Visible, 1, 0, "HLP_wpRecluSegCord.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_bitmap( context, imgImage1_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "Refrescar pantalla", 0, 0, 0, "px", 0, "px", 0, 0, 5, imgImage1_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'REFRESCAR\\'."+"'", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" "+TempTags, "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_wpRecluSegCord.htm");
            GxWebStd.gx_div_end( context, "Right", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
                              ...
                              else
                              {
                                 ...
                                 if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 10), "GRID1.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 15), "VADJUNTAR.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 16), "VSIGUIENTE.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 19), "VVARDESCARTAR.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 15), "VADJUNTAR.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 16), "VSIGUIENTE.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 19), "VVARDESCARTAR.CLICK") == 0 ) )
                                 {
                                    ...
                                    if ( ( ( context.localUtil.CToN( cgiGet( edtavVacantes_id_envio_Internalname), ",", ".") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavVacantes_id_envio_Internalname), ",", ".") > Convert.ToDecimal( 9999 )) ) )
                                    {
                                       ...
                                       wbErr = true;
                                       AV18vacantes_id_Envio = 0;
                                       AssignAttri("", false, edtavVacantes_id_envio_Internalname, StringUtil.LTrimStr( (decimal)(AV18vacantes_id_Envio), 4, 0));
                                       GxWebStd.gx_hidden_field( context, "gxhash_vVACANTES_ID_ENVIO"+"_"+sGXsfl_44_idx, GetSecureSignedToken( sGXsfl_44_idx, context.localUtil.Format( (decimal)(AV18vacantes_id_Envio), "ZZZ9"), context));
                                    }
                                    else
                                    {
                                       AV18vacantes_id_Envio = (short)(context.localUtil.CToN( cgiGet( edtavVacantes_id_envio_Internalname), ",", "."));
                                       AssignAttri("", false, edtavVacantes_id_envio_Internalname, StringUtil.LTrimStr( (decimal)(AV18vacantes_id_Envio), 4, 0));
                                       GxWebStd.gx_hidden_field( context, "gxhash_vVACANTES_ID_ENVIO"+"_"+sGXsfl_44_idx, GetSecureSignedToken( sGXsfl_44_idx, context.localUtil.Format( (decimal)(AV18vacantes_id_Envio), "ZZZ9"), context));
                                    }
                                    AV24VacantesUsuariosEstatus = (short)(context.localUtil.CToN( cgiGet( edtavVacantesusuariosestatus_Internalname), ",", "."));
                                    ...
                                    GxWebStd.gx_hidden_field( context, "gxhash_vUSUARIOSID"+"_"+sGXsfl_44_idx, GetSecureSignedToken( sGXsfl_44_idx, context.localUtil.Format( (decimal)(AV13UsuariosId), "ZZZZZ9"), context));
                                    ...
                                    AssignProp("", false, edtavVacantesusuariosprefiltro_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV31VacantesUsuariosPrefiltro)) ? AV45Vacantesusuariosprefiltro_GXI : context.convertURL( context.PathToRelativeUrl( AV31VacantesUsuariosPrefiltro))), !bGXsfl_44_Refreshing);
                                    ...
                                    AssignProp("", false, edtavVacantesusuarioscv_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV22VacantesUsuariosCV)) ? AV46Vacantesusuarioscv_GXI : context.convertURL( context.PathToRelativeUrl( AV22VacantesUsuariosCV))), !bGXsfl_44_Refreshing);
                                    ...
                                    AssignProp("", false, edtavVacantesusuariosextec_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV26VacantesUsuariosExTec)) ? AV48Vacantesusuariosextec_GXI : context.convertURL( context.PathToRelativeUrl( AV26VacantesUsuariosExTec))), !bGXsfl_44_Refreshing);
                                    ...
                                    AssignProp("", false, edtavVacantesusuariosavconf_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV19VacantesUsuariosAvConf)) ? AV54Vacantesusuariosavconf_GXI : context.convertURL( context.PathToRelativeUrl( AV19VacantesUsuariosAvConf))), !bGXsfl_44_Refreshing);
                                    ...
                                    AssignProp("", false, edtavVacantesusuariosavpriv_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV20VacantesUsuariosAvPriv)) ? AV53Vacantesusuariosavpriv_GXI : context.convertURL( context.PathToRelativeUrl( AV20VacantesUsuariosAvPriv))), !bGXsfl_44_Refreshing);
                                    ...
                                    AssignProp("", false, edtavVacantesusuariosbusweb_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV21VacantesUsuariosBusWeb)) ? AV52Vacantesusuariosbusweb_GXI : context.convertURL( context.PathToRelativeUrl( AV21VacantesUsuariosBusWeb))), !bGXsfl_44_Refreshing);
                                    ...
                                    AssignProp("", false, edtavVacantesusuariosreflab_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV32VacantesUsuariosRefLab)) ? AV50Vacantesusuariosreflab_GXI : context.convertURL( context.PathToRelativeUrl( AV32VacantesUsuariosRefLab))), !bGXsfl_44_Refreshing);
                                    ...
                                    AssignProp("", false, edtavVacantesusuariosexpsi_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV25VacantesUsuariosExPsi)) ? AV51Vacantesusuariosexpsi_GXI : context.convertURL( context.PathToRelativeUrl( AV25VacantesUsuariosExPsi))), !bGXsfl_44_Refreshing);
                                    ...
                                    AssignProp("", false, edtavVacantesusuarioscvrec_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV23VacantesUsuariosCVRec)) ? AV49Vacantesusuarioscvrec_GXI : context.convertURL( context.PathToRelativeUrl( AV23VacantesUsuariosCVRec))), !bGXsfl_44_Refreshing);
                                    AssignProp("", false, edtavVacantesusuarioscvrec_Internalname, "SrcSet", context.GetImageSrcSet( AV23VacantesUsuariosCVRec), true);
                                    AV5adjuntar = cgiGet( edtavAdjuntar_Internalname);
                                    AssignProp("", false, edtavAdjuntar_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV5adjuntar)) ? AV41Adjuntar_GXI : context.convertURL( context.PathToRelativeUrl( AV5adjuntar))), !bGXsfl_44_Refreshing);
                                    AssignProp("", false, edtavAdjuntar_Internalname, "SrcSet", context.GetImageSrcSet( AV5adjuntar), true);
                                    AV7Siguiente = cgiGet( edtavSiguiente_Internalname);
                                    AssignProp("", false, edtavSiguiente_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV7Siguiente)) ? AV47Siguiente_GXI : context.convertURL( context.PathToRelativeUrl( AV7Siguiente))), !bGXsfl_44_Refreshing);
                                    AssignProp("", false, edtavSiguiente_Internalname, "SrcSet", context.GetImageSrcSet( AV7Siguiente), true);
                                    AV34VarDescartar = cgiGet( edtavVardescartar_Internalname);
                                    AssignProp("", false, edtavVardescartar_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV34VarDescartar)) ? AV44Vardescartar_GXI : context.convertURL( context.PathToRelativeUrl( AV34VarDescartar))), !bGXsfl_44_Refreshing);
                                    AssignProp("", false, edtavVardescartar_Internalname, "SrcSet", context.GetImageSrcSet( AV34VarDescartar), true);
                                    sEvtType = StringUtil.Right( sEvt, 1);
                                    if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                                    {
                                       sEvt = StringUtil.Left( sEvt, (short)(StringUtil.Len( sEvt)-1));
      ...
      protected void PA382( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "wpreclusegcord.aspx")), "wpreclusegcord.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "wpreclusegcord.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV17vacantes_id = (int)(NumberUtil.Val( gxfirstwebparm, "."));
                     AssignAttri("", false, "AV17vacantes_id", StringUtil.LTrimStr( (decimal)(AV17vacantes_id), 9, 0));
                     GxWebStd.gx_hidden_field( context, "gxhash_vVACANTES_ID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV17vacantes_id), "ZZZZZZZZ9"), context));
                  }
                  if ( context.isSpaRequest( ) )
                  {
      ...
      protected void GXDLVvUSUARIOSID384( )
      {
         if ( ! context.isAjaxRequest( ) )
         {
            context.GX_webresponse.AppendHeader("Cache-Control", "no-store");
      ...
      protected void GXVvUSUARIOSID_html384( )
      {
         int gxdynajaxvalue ;
         GXDLVvUSUARIOSID_data384( ) ;
         gxdynajaxindex = 1;
      ...
      protected void GXDLVvUSUARIOSID_data384( )
      {
         ...
         {
            gxdynajaxctrlcodr.Add(StringUtil.LTrim( StringUtil.NToC( (decimal)(H00382_A11UsuariosId[0]), 6, 0, ".", "")));
            gxdynajaxctrldescr.Add(H00382_A97UsuariosNomCompleto[0]);
            pr_default.readNext(0);
         }
         pr_default.close(0);
      }

      protected void GXDLVvSUBT_RECLUTADORID384( )
      {
         if ( ! context.isAjaxRequest( ) )
         {
            context.GX_webresponse.AppendHeader("Cache-Control", "no-store");
         ...
         AddString( "[[") ;
         GXDLVvSUBT_RECLUTADORID_data384( ) ;
         gxdynajaxindex = 1;
         while ( gxdynajaxindex <= gxdynajaxctrlcodr.Count )
         {
            AddString( gxwrpcisep+"{\"c\":\""+GXUtil.EncodeJSConstant( ((String)gxdynajaxctrlcodr.Item(gxdynajaxindex)))+"\",\"d\":\""+GXUtil.EncodeJSConstant( ((String)gxdynajaxctrldescr.Item(gxdynajaxindex)))+"\"}") ;
      ...
      protected void GXVvSUBT_RECLUTADORID_html384( )
      {
         int gxdynajaxvalue ;
         GXDLVvSUBT_RECLUTADORID_data384( ) ;
         gxdynajaxindex = 1;
      ...
      protected void GXDLVvSUBT_RECLUTADORID_data384( )
      {
         gxdynajaxctrlcodr.Clear();
         gxdynajaxctrldescr.Clear();
         /* Using cursor H00383 */
         ...
         {
            gxdynajaxctrlcodr.Add(StringUtil.LTrim( StringUtil.NToC( (decimal)(H00383_A11UsuariosId[0]), 6, 0, ".", "")));
            gxdynajaxctrldescr.Add(H00383_A97UsuariosNomCompleto[0]);
      ...
      protected void send_integrity_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_vVACANTES_ID_ENVIO", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV18vacantes_id_Envio), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "vVACANTES_ID_ENVIO", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV18vacantes_id_Envio), 4, 0, ".", "")));
      }
      ...
      protected void RF382( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            SubsflControlProps_222( ) ;
            /* Using cursor H00384 */
            pr_default.execute(2, new Object[] {AV17vacantes_id});
            while ( (pr_default.getStatus(2) != 101) )
            {
               A290VacantesUsuariosEstatus = H00384_A290VacantesUsuariosEstatus[0];
               n290VacantesUsuariosEstatus = H00384_n290VacantesUsuariosEstatus[0];
               A263Vacantes_Id = H00384_A263Vacantes_Id[0];
               A11UsuariosId = H00384_A11UsuariosId[0];
               A260UsuariosTelef = H00384_A260UsuariosTelef[0];
               A261UsuariosCorreo = H00384_A261UsuariosCorreo[0];
               A284SUBT_ReclutadorId = H00384_A284SUBT_ReclutadorId[0];
               A288VacantesUsuariosFechaP = H00384_A288VacantesUsuariosFechaP[0];
               A291VacantesUsuariosPrefiltro = H00384_A291VacantesUsuariosPrefiltro[0];
               n291VacantesUsuariosPrefiltro = H00384_n291VacantesUsuariosPrefiltro[0];
               A292VacantesUsuariosCV = H00384_A292VacantesUsuariosCV[0];
               n292VacantesUsuariosCV = H00384_n292VacantesUsuariosCV[0];
               A295VacantesUsuariosFechaE = H00384_A295VacantesUsuariosFechaE[0];
               n295VacantesUsuariosFechaE = H00384_n295VacantesUsuariosFechaE[0];
               A293VacantesUsuariosExTec = H00384_A293VacantesUsuariosExTec[0];
               n293VacantesUsuariosExTec = H00384_n293VacantesUsuariosExTec[0];
               A299VacantesUsuariosCVRec = H00384_A299VacantesUsuariosCVRec[0];
               n299VacantesUsuariosCVRec = H00384_n299VacantesUsuariosCVRec[0];
               A300VacantesUsuariosRefLab = H00384_A300VacantesUsuariosRefLab[0];
               n300VacantesUsuariosRefLab = H00384_n300VacantesUsuariosRefLab[0];
               A301VacantesUsuariosExPsi = H00384_A301VacantesUsuariosExPsi[0];
               n301VacantesUsuariosExPsi = H00384_n301VacantesUsuariosExPsi[0];
               A302VacantesUsuariosBusWeb = H00384_A302VacantesUsuariosBusWeb[0];
               n302VacantesUsuariosBusWeb = H00384_n302VacantesUsuariosBusWeb[0];
               A303VacantesUsuariosAvPriv = H00384_A303VacantesUsuariosAvPriv[0];
               n303VacantesUsuariosAvPriv = H00384_n303VacantesUsuariosAvPriv[0];
               A304VacantesUsuariosAvConf = H00384_A304VacantesUsuariosAvConf[0];
               n304VacantesUsuariosAvConf = H00384_n304VacantesUsuariosAvConf[0];
               A314VacantesUsuariosFecha3 = H00384_A314VacantesUsuariosFecha3[0];
               n314VacantesUsuariosFecha3 = H00384_n314VacantesUsuariosFecha3[0];
               A313VacantesUsuariosFechaA = H00384_A313VacantesUsuariosFechaA[0];
               n313VacantesUsuariosFechaA = H00384_n313VacantesUsuariosFechaA[0];
               A294VacantesUsuariosMotD = H00384_A294VacantesUsuariosMotD[0];
               n294VacantesUsuariosMotD = H00384_n294VacantesUsuariosMotD[0];
               A289VacantesUsuariosFechaD = H00384_A289VacantesUsuariosFechaD[0];
               n289VacantesUsuariosFechaD = H00384_n289VacantesUsuariosFechaD[0];
               A260UsuariosTelef = H00384_A260UsuariosTelef[0];
               A261UsuariosCorreo = H00384_A261UsuariosCorreo[0];
               E14382 ();
      ...
      protected void send_integrity_lvl_hashes384( )
      {
         GxWebStd.gx_hidden_field( context, "gxhash_vUSUARIOSID"+"_"+sGXsfl_44_idx, GetSecureSignedToken( sGXsfl_44_idx, context.localUtil.Format( (decimal)(AV13UsuariosId), "ZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "gxhash_vVACANTES_ID_ENVIO"+"_"+sGXsfl_44_idx, GetSecureSignedToken( sGXsfl_44_idx, context.localUtil.Format( (decimal)(AV18vacantes_id_Envio), "ZZZ9"), context));
      }
      ...
      protected void E13382( )
      {
         ...
         AssignProp("", false, edtavAdjuntar_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV5adjuntar)) ? AV41Adjuntar_GXI : context.convertURL( context.PathToRelativeUrl( AV5adjuntar))), !bGXsfl_44_Refreshing);
         AssignProp("", false, edtavAdjuntar_Internalname, "SrcSet", context.GetImageSrcSet( AV5adjuntar), true);
         AV41Adjuntar_GXI = GXDbFile.PathToUrl( context.GetImagePath( "5046a98d-ab11-4d0f-b902-e472abde2a26", "", context.GetTheme( )));
         AssignProp("", false, edtavAdjuntar_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV5adjuntar)) ? AV41Adjuntar_GXI : context.convertURL( context.PathToRelativeUrl( AV5adjuntar))), !bGXsfl_44_Refreshing);
         AssignProp("", false, edtavAdjuntar_Internalname, "SrcSet", context.GetImageSrcSet( AV5adjuntar), true);
         /* Using cursor H00385 */
         pr_default.execute(3, new Object[] {AV17vacantes_id});
         while ( (pr_default.getStatus(3) != 101) )
         {
            A263Vacantes_Id = H00385_A263Vacantes_Id[0];
            A264Vacantes_Nombre = H00385_A264Vacantes_Nombre[0];
            AV36Nombre_Vacante = A264Vacantes_Nombre;
         ...
         pr_default.close(3);
         lblTextblock2_Caption = "SEGUIMIENTO DE LA VACANTE:   "+StringUtil.Upper( AV36Nombre_Vacante);
      ...
      protected void E16382( )
      {
         ...
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "popcargdocu.aspx"+UrlEncode("" +AV13UsuariosId) + "," + UrlEncode("" +AV18vacantes_id_Envio) + "," + UrlEncode("" +AV24VacantesUsuariosEstatus);
      ...
      protected void E17382( )
      {
         ...
         new pr_cambiastausvacante(context ).execute(  AV13UsuariosId,  AV18vacantes_id_Envio) ;
         CallWebObject(formatLink("wppantallacero.aspx") + "?" + UrlEncode("" +AV18vacantes_id_Envio) + "," + UrlEncode("" +2) + "," + UrlEncode("" +0) + "," + UrlEncode("" +0));
      ...
      protected void E18382( )
      {
         ...
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "pordescinf.aspx"+UrlEncode("" +AV13UsuariosId) + "," + UrlEncode("" +AV18vacantes_id_Envio);
      ...
      private void E15384( )
      {
         /* Grid1_Load Routine */
         /* Using cursor H00386 */
         pr_default.execute(4, new Object[] {AV17vacantes_id, AV24VacantesUsuariosEstatus});
         while ( (pr_default.getStatus(4) != 101) )
         {
            A290VacantesUsuariosEstatus = H00386_A290VacantesUsuariosEstatus[0];
            n290VacantesUsuariosEstatus = H00386_n290VacantesUsuariosEstatus[0];
            A263Vacantes_Id = H00386_A263Vacantes_Id[0];
            A11UsuariosId = H00386_A11UsuariosId[0];
            A260UsuariosTelef = H00386_A260UsuariosTelef[0];
            A261UsuariosCorreo = H00386_A261UsuariosCorreo[0];
            A284SUBT_ReclutadorId = H00386_A284SUBT_ReclutadorId[0];
            A288VacantesUsuariosFechaP = H00386_A288VacantesUsuariosFechaP[0];
            A291VacantesUsuariosPrefiltro = H00386_A291VacantesUsuariosPrefiltro[0];
            n291VacantesUsuariosPrefiltro = H00386_n291VacantesUsuariosPrefiltro[0];
            A292VacantesUsuariosCV = H00386_A292VacantesUsuariosCV[0];
            n292VacantesUsuariosCV = H00386_n292VacantesUsuariosCV[0];
            A295VacantesUsuariosFechaE = H00386_A295VacantesUsuariosFechaE[0];
            n295VacantesUsuariosFechaE = H00386_n295VacantesUsuariosFechaE[0];
            A293VacantesUsuariosExTec = H00386_A293VacantesUsuariosExTec[0];
            n293VacantesUsuariosExTec = H00386_n293VacantesUsuariosExTec[0];
            A299VacantesUsuariosCVRec = H00386_A299VacantesUsuariosCVRec[0];
            n299VacantesUsuariosCVRec = H00386_n299VacantesUsuariosCVRec[0];
            A300VacantesUsuariosRefLab = H00386_A300VacantesUsuariosRefLab[0];
            n300VacantesUsuariosRefLab = H00386_n300VacantesUsuariosRefLab[0];
            A301VacantesUsuariosExPsi = H00386_A301VacantesUsuariosExPsi[0];
            n301VacantesUsuariosExPsi = H00386_n301VacantesUsuariosExPsi[0];
            A302VacantesUsuariosBusWeb = H00386_A302VacantesUsuariosBusWeb[0];
            n302VacantesUsuariosBusWeb = H00386_n302VacantesUsuariosBusWeb[0];
            A303VacantesUsuariosAvPriv = H00386_A303VacantesUsuariosAvPriv[0];
            n303VacantesUsuariosAvPriv = H00386_n303VacantesUsuariosAvPriv[0];
            A304VacantesUsuariosAvConf = H00386_A304VacantesUsuariosAvConf[0];
            n304VacantesUsuariosAvConf = H00386_n304VacantesUsuariosAvConf[0];
            A314VacantesUsuariosFecha3 = H00386_A314VacantesUsuariosFecha3[0];
            n314VacantesUsuariosFecha3 = H00386_n314VacantesUsuariosFecha3[0];
            A313VacantesUsuariosFechaA = H00386_A313VacantesUsuariosFechaA[0];
            n313VacantesUsuariosFechaA = H00386_n313VacantesUsuariosFechaA[0];
            A294VacantesUsuariosMotD = H00386_A294VacantesUsuariosMotD[0];
            n294VacantesUsuariosMotD = H00386_n294VacantesUsuariosMotD[0];
            A289VacantesUsuariosFechaD = H00386_A289VacantesUsuariosFechaD[0];
            n289VacantesUsuariosFechaD = H00386_n289VacantesUsuariosFechaD[0];
            A260UsuariosTelef = H00386_A260UsuariosTelef[0];
            A261UsuariosCorreo = H00386_A261UsuariosCorreo[0];
            ...
            AV34VarDescartar = context.GetImagePath( "3e997551-1e5c-4df7-9720-51b3f49ee88a", "", context.GetTheme( ));
            AssignAttri("", false, edtavVardescartar_Internalname, AV34VarDescartar);
            AV44Vardescartar_GXI = GXDbFile.PathToUrl( context.GetImagePath( "3e997551-1e5c-4df7-9720-51b3f49ee88a", "", context.GetTheme( )));
            if ( AV24VacantesUsuariosEstatus == 0 )
            {
               ...
               {
                  AV7Siguiente = context.GetImagePath( "49e414a3-8ee9-4e69-bdc5-a9526c95bff1", "", context.GetTheme( ));
                  AssignAttri("", false, edtavSiguiente_Internalname, AV7Siguiente);
                  AV47Siguiente_GXI = GXDbFile.PathToUrl( context.GetImagePath( "49e414a3-8ee9-4e69-bdc5-a9526c95bff1", "", context.GetTheme( )));
            ...
            else if ( AV24VacantesUsuariosEstatus == 1 )
            {
               ...
               if ( A293VacantesUsuariosExTec == 1 )
               {
                  ...
                  AV48Vacantesusuariosextec_GXI = GXDbFile.PathToUrl( context.GetImagePath( "8a22deb1-46d0-4a5c-903d-de3f04cfc60e", "", context.GetTheme( )));
                  AV7Siguiente = context.GetImagePath( "49e414a3-8ee9-4e69-bdc5-a9526c95bff1", "", context.GetTheme( ));
                  AssignAttri("", false, edtavSiguiente_Internalname, AV7Siguiente);
                  AV47Siguiente_GXI = GXDbFile.PathToUrl( context.GetImagePath( "49e414a3-8ee9-4e69-bdc5-a9526c95bff1", "", context.GetTheme( )));
                  edtavSiguiente_Visible = 1;
               ...
               else
               {
                  ...
                  AssignAttri("", false, edtavVacantesusuariosextec_Internalname, AV26VacantesUsuariosExTec);
                  AV48Vacantesusuariosextec_GXI = GXDbFile.PathToUrl( context.GetImagePath( "6f43abfa-1cbe-43d0-ab83-cca376c19820", "", context.GetTheme( )));
                  edtavSiguiente_Visible = 0;
               }
            }
            else if ( AV24VacantesUsuariosEstatus == 2 )
            {
               ...
               if ( A299VacantesUsuariosCVRec == 1 )
               {
                  ...
                  AV49Vacantesusuarioscvrec_GXI = GXDbFile.PathToUrl( context.GetImagePath( "8a22deb1-46d0-4a5c-903d-de3f04cfc60e", "", context.GetTheme( )));
               }
               else
               {
                  AV23VacantesUsuariosCVRec = context.GetImagePath( "6f43abfa-1cbe-43d0-ab83-cca376c19820", "", context.GetTheme( ));
                  AssignAttri("", false, edtavVacantesusuarioscvrec_Internalname, AV23VacantesUsuariosCVRec);
                  AV49Vacantesusuarioscvrec_GXI = GXDbFile.PathToUrl( context.GetImagePath( "6f43abfa-1cbe-43d0-ab83-cca376c19820", "", context.GetTheme( )));
               }
               if ( A300VacantesUsuariosRefLab == 1 )
               {
                  ...
                  AV50Vacantesusuariosreflab_GXI = GXDbFile.PathToUrl( context.GetImagePath( "8a22deb1-46d0-4a5c-903d-de3f04cfc60e", "", context.GetTheme( )));
               }
               else
               {
                  AV32VacantesUsuariosRefLab = context.GetImagePath( "6f43abfa-1cbe-43d0-ab83-cca376c19820", "", context.GetTheme( ));
                  AssignAttri("", false, edtavVacantesusuariosreflab_Internalname, AV32VacantesUsuariosRefLab);
                  AV50Vacantesusuariosreflab_GXI = GXDbFile.PathToUrl( context.GetImagePath( "6f43abfa-1cbe-43d0-ab83-cca376c19820", "", context.GetTheme( )));
               }
               if ( A301VacantesUsuariosExPsi == 1 )
               {
                  ...
                  AV51Vacantesusuariosexpsi_GXI = GXDbFile.PathToUrl( context.GetImagePath( "8a22deb1-46d0-4a5c-903d-de3f04cfc60e", "", context.GetTheme( )));
               }
               else
               {
                  AV25VacantesUsuariosExPsi = context.GetImagePath( "6f43abfa-1cbe-43d0-ab83-cca376c19820", "", context.GetTheme( ));
                  AssignAttri("", false, edtavVacantesusuariosexpsi_Internalname, AV25VacantesUsuariosExPsi);
                  AV51Vacantesusuariosexpsi_GXI = GXDbFile.PathToUrl( context.GetImagePath( "6f43abfa-1cbe-43d0-ab83-cca376c19820", "", context.GetTheme( )));
               }
               if ( A302VacantesUsuariosBusWeb == 1 )
               {
                  ...
                  AV52Vacantesusuariosbusweb_GXI = GXDbFile.PathToUrl( context.GetImagePath( "8a22deb1-46d0-4a5c-903d-de3f04cfc60e", "", context.GetTheme( )));
               }
               else
               {
                  AV21VacantesUsuariosBusWeb = context.GetImagePath( "6f43abfa-1cbe-43d0-ab83-cca376c19820", "", context.GetTheme( ));
                  AssignAttri("", false, edtavVacantesusuariosbusweb_Internalname, AV21VacantesUsuariosBusWeb);
                  AV52Vacantesusuariosbusweb_GXI = GXDbFile.PathToUrl( context.GetImagePath( "6f43abfa-1cbe-43d0-ab83-cca376c19820", "", context.GetTheme( )));
               }
               if ( A303VacantesUsuariosAvPriv == 1 )
               {
                  ...
                  AV53Vacantesusuariosavpriv_GXI = GXDbFile.PathToUrl( context.GetImagePath( "8a22deb1-46d0-4a5c-903d-de3f04cfc60e", "", context.GetTheme( )));
               }
               else
               {
                  AV20VacantesUsuariosAvPriv = context.GetImagePath( "6f43abfa-1cbe-43d0-ab83-cca376c19820", "", context.GetTheme( ));
                  AssignAttri("", false, edtavVacantesusuariosavpriv_Internalname, AV20VacantesUsuariosAvPriv);
                  AV53Vacantesusuariosavpriv_GXI = GXDbFile.PathToUrl( context.GetImagePath( "6f43abfa-1cbe-43d0-ab83-cca376c19820", "", context.GetTheme( )));
               }
               if ( A304VacantesUsuariosAvConf == 1 )
               {
                  ...
                  AV54Vacantesusuariosavconf_GXI = GXDbFile.PathToUrl( context.GetImagePath( "8a22deb1-46d0-4a5c-903d-de3f04cfc60e", "", context.GetTheme( )));
               }
               else
               {
                  AV19VacantesUsuariosAvConf = context.GetImagePath( "6f43abfa-1cbe-43d0-ab83-cca376c19820", "", context.GetTheme( ));
                  AssignAttri("", false, edtavVacantesusuariosavconf_Internalname, AV19VacantesUsuariosAvConf);
                  AV54Vacantesusuariosavconf_GXI = GXDbFile.PathToUrl( context.GetImagePath( "6f43abfa-1cbe-43d0-ab83-cca376c19820", "", context.GetTheme( )));
               }
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV17vacantes_id = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV17vacantes_id", StringUtil.LTrimStr( (decimal)(AV17vacantes_id), 9, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vVACANTES_ID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV17vacantes_id), "ZZZZZZZZ9"), context));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20226271435111", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wpreclusegcord.js", "?20226271435111", false, true);
         }
      ...
      protected void sendrow_444( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_44_idx <= subGrid1_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtavVacantes_id_envio_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(AV18vacantes_id_Envio), 4, 0, ",", "")),((edtavVacantes_id_envio_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(AV18vacantes_id_Envio), "ZZZ9")) : context.localUtil.Format( (decimal)(AV18vacantes_id_Envio), "ZZZ9")),TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+((edtavVacantes_id_envio_Enabled!=0)&&(edtavVacantes_id_envio_Visible!=0) ? " onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,45);\"" : " "),(String)"'"+""+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtavVacantes_id_envio_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn",(String)"",(int)edtavVacantes_id_envio_Visible,(int)edtavVacantes_id_envio_Enabled,(short)0,(String)"number",(String)"1",(short)0,(String)"px",(short)17,(String)"px",(short)4,(short)0,(short)0,(short)44,(short)1,(short)-1,(short)0,(bool)true,(String)"",(String)"right",(bool)false,(String)""});
            /* Subfile cell */
            if ( Grid1Container.GetWrapped() == 1 )
            {
            ...
            ClassString = "Image";
            StyleString = "";
            AV26VacantesUsuariosExTec_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV26VacantesUsuariosExTec))&&String.IsNullOrEmpty(StringUtil.RTrim( AV48Vacantesusuariosextec_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV26VacantesUsuariosExTec)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV26VacantesUsuariosExTec)) ? AV48Vacantesusuariosextec_GXI : context.PathToRelativeUrl( AV26VacantesUsuariosExTec));
            ...
            ClassString = "Image";
            StyleString = "";
            AV19VacantesUsuariosAvConf_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV19VacantesUsuariosAvConf))&&String.IsNullOrEmpty(StringUtil.RTrim( AV54Vacantesusuariosavconf_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV19VacantesUsuariosAvConf)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV19VacantesUsuariosAvConf)) ? AV54Vacantesusuariosavconf_GXI : context.PathToRelativeUrl( AV19VacantesUsuariosAvConf));
            ...
            ClassString = "Image";
            StyleString = "";
            AV20VacantesUsuariosAvPriv_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV20VacantesUsuariosAvPriv))&&String.IsNullOrEmpty(StringUtil.RTrim( AV53Vacantesusuariosavpriv_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV20VacantesUsuariosAvPriv)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV20VacantesUsuariosAvPriv)) ? AV53Vacantesusuariosavpriv_GXI : context.PathToRelativeUrl( AV20VacantesUsuariosAvPriv));
            ...
            ClassString = "Image";
            StyleString = "";
            AV21VacantesUsuariosBusWeb_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV21VacantesUsuariosBusWeb))&&String.IsNullOrEmpty(StringUtil.RTrim( AV52Vacantesusuariosbusweb_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV21VacantesUsuariosBusWeb)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV21VacantesUsuariosBusWeb)) ? AV52Vacantesusuariosbusweb_GXI : context.PathToRelativeUrl( AV21VacantesUsuariosBusWeb));
            ...
            ClassString = "Image";
            StyleString = "";
            AV32VacantesUsuariosRefLab_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV32VacantesUsuariosRefLab))&&String.IsNullOrEmpty(StringUtil.RTrim( AV50Vacantesusuariosreflab_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV32VacantesUsuariosRefLab)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV32VacantesUsuariosRefLab)) ? AV50Vacantesusuariosreflab_GXI : context.PathToRelativeUrl( AV32VacantesUsuariosRefLab));
            ...
            ClassString = "Image";
            StyleString = "";
            AV25VacantesUsuariosExPsi_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV25VacantesUsuariosExPsi))&&String.IsNullOrEmpty(StringUtil.RTrim( AV51Vacantesusuariosexpsi_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV25VacantesUsuariosExPsi)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV25VacantesUsuariosExPsi)) ? AV51Vacantesusuariosexpsi_GXI : context.PathToRelativeUrl( AV25VacantesUsuariosExPsi));
            ...
            ClassString = "Image";
            StyleString = "";
            AV23VacantesUsuariosCVRec_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV23VacantesUsuariosCVRec))&&String.IsNullOrEmpty(StringUtil.RTrim( AV49Vacantesusuarioscvrec_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV23VacantesUsuariosCVRec)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV23VacantesUsuariosCVRec)) ? AV49Vacantesusuarioscvrec_GXI : context.PathToRelativeUrl( AV23VacantesUsuariosCVRec));
            ...
            ClassString = "Image";
            StyleString = "";
            AV34VarDescartar_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV34VarDescartar))&&String.IsNullOrEmpty(StringUtil.RTrim( AV44Vardescartar_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV34VarDescartar)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV34VarDescartar)) ? AV44Vardescartar_GXI : context.PathToRelativeUrl( AV34VarDescartar));
            Grid1Row.AddColumnProperties("bitmap", 1, isAjaxCallMode( ), new Object[] {(String)edtavVardescartar_Internalname,(String)sImgUrl,(String)"",(String)"",(String)"",context.GetTheme( ),(int)edtavVardescartar_Visible,(short)1,(String)"",(String)"Descartar",(short)0,(short)-1,(short)0,(String)"px",(short)0,(String)"px",(short)0,(short)0,(short)5,(String)edtavVardescartar_Jsonclick,"'"+""+"'"+",false,"+"'"+"EVVARDESCARTAR.CLICK."+sGXsfl_44_idx+"'",(String)StyleString,(String)ClassString,(String)"WWColumn",(String)"",(String)"",(String)"",(String)""+TempTags,(String)"",(String)"",(short)1,(bool)AV34VarDescartar_IsBlob,(bool)false,context.GetImageSrcSet( sImgUrl)});
            send_integrity_lvl_hashes384( ) ;
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("VADJUNTAR.CLICK","{handler:'E16382',iparms:[{av:'GRID2_nFirstRecordOnPage'},{av:'GRID2_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV17vacantes_id',fld:'vVACANTES_ID',pic:'ZZZZZZZZ9',hsh:true},{av:'edtavVacantesusuariosestatus_Visible',ctrl:'vVACANTESUSUARIOSESTATUS',prop:'Visible'},{av:'edtVacantesUsuariosEstatus_Visible',ctrl:'VACANTESUSUARIOSESTATUS',prop:'Visible'},{av:'dynavUsuariosid'},{av:'AV13UsuariosId',fld:'vUSUARIOSID',pic:'ZZZZZ9',hsh:true},{av:'AV18vacantes_id_Envio',fld:'vVACANTES_ID_ENVIO',pic:'ZZZ9',hsh:true},{av:'AV24VacantesUsuariosEstatus',fld:'vVACANTESUSUARIOSESTATUS',pic:'ZZZ9'},{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'edtavVacantes_id_envio_Visible',ctrl:'vVACANTES_ID_ENVIO',prop:'Visible'},{av:'AV5adjuntar',fld:'vADJUNTAR',pic:''},{av:'A263Vacantes_Id',fld:'VACANTES_ID',pic:'ZZZZZZZZ9'},{av:'A290VacantesUsuariosEstatus',fld:'VACANTESUSUARIOSESTATUS',pic:'ZZZ9'},{av:'A11UsuariosId',fld:'USUARIOSID',pic:'ZZZZZ9'},{av:'A260UsuariosTelef',fld:'USUARIOSTELEF',pic:''},{av:'A261UsuariosCorreo',fld:'USUARIOSCORREO',pic:''},{av:'A284SUBT_ReclutadorId',fld:'SUBT_RECLUTADORID',pic:'ZZZZZ9'},{av:'A288VacantesUsuariosFechaP',fld:'VACANTESUSUARIOSFECHAP',pic:'99/99/9999 99:99'},{av:'A292VacantesUsuariosCV',fld:'VACANTESUSUARIOSCV',pic:'ZZZ9'},{av:'A291VacantesUsuariosPrefiltro',fld:'VACANTESUSUARIOSPREFILTRO',pic:'ZZZ9'},{av:'A293VacantesUsuariosExTec',fld:'VACANTESUSUARIOSEXTEC',pic:'ZZZ9'},{av:'A295VacantesUsuariosFechaE',fld:'VACANTESUSUARIOSFECHAE',pic:'99/99/99 99:99'},{av:'A314VacantesUsuariosFecha3',fld:'VACANTESUSUARIOSFECHA3',pic:'99/99/99 99:99'},{av:'A304VacantesUsuariosAvConf',fld:'VACANTESUSUARIOSAVCONF',pic:'ZZZ9'},{av:'A303VacantesUsuariosAvPriv',fld:'VACANTESUSUARIOSAVPRIV',pic:'ZZZ9'},{av:'A302VacantesUsuariosBusWeb',fld:'VACANTESUSUARIOSBUSWEB',pic:'ZZZ9'},{av:'A301VacantesUsuariosExPsi',fld:'VACANTESUSUARIOSEXPSI',pic:'ZZZ9'},{av:'A300VacantesUsuariosRefLab',fld:'VACANTESUSUARIOSREFLAB',pic:'ZZZ9'},{av:'A299VacantesUsuariosCVRec',fld:'VACANTESUSUARIOSCVREC',pic:'ZZZ9'},{av:'A313VacantesUsuariosFechaA',fld:'VACANTESUSUARIOSFECHAA',pic:'99/99/99 99:99'},{av:'A289VacantesUsuariosFechaD',fld:'VACANTESUSUARIOSFECHAD',pic:'99/99/99 99:99'},{av:'A294VacantesUsuariosMotD',fld:'VACANTESUSUARIOSMOTD',pic:''}]");
         setEventMetadata("VADJUNTAR.CLICK",",oparms:[]}");
         setEventMetadata("VSIGUIENTE.CLICK","{handler:'E17382',iparms:[{av:'dynavUsuariosid'},{av:'AV13UsuariosId',fld:'vUSUARIOSID',pic:'ZZZZZ9',hsh:true},{av:'AV18vacantes_id_Envio',fld:'vVACANTES_ID_ENVIO',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("VSIGUIENTE.CLICK",",oparms:[]}");
         setEventMetadata("VVARDESCARTAR.CLICK","{handler:'E18382',iparms:[{av:'GRID2_nFirstRecordOnPage'},{av:'GRID2_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV17vacantes_id',fld:'vVACANTES_ID',pic:'ZZZZZZZZ9',hsh:true},{av:'edtavVacantesusuariosestatus_Visible',ctrl:'vVACANTESUSUARIOSESTATUS',prop:'Visible'},{av:'edtVacantesUsuariosEstatus_Visible',ctrl:'VACANTESUSUARIOSESTATUS',prop:'Visible'},{av:'dynavUsuariosid'},{av:'AV13UsuariosId',fld:'vUSUARIOSID',pic:'ZZZZZ9',hsh:true},{av:'AV18vacantes_id_Envio',fld:'vVACANTES_ID_ENVIO',pic:'ZZZ9',hsh:true},{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'edtavVacantes_id_envio_Visible',ctrl:'vVACANTES_ID_ENVIO',prop:'Visible'},{av:'AV5adjuntar',fld:'vADJUNTAR',pic:''},{av:'A263Vacantes_Id',fld:'VACANTES_ID',pic:'ZZZZZZZZ9'},{av:'A290VacantesUsuariosEstatus',fld:'VACANTESUSUARIOSESTATUS',pic:'ZZZ9'},{av:'AV24VacantesUsuariosEstatus',fld:'vVACANTESUSUARIOSESTATUS',pic:'ZZZ9'},{av:'A11UsuariosId',fld:'USUARIOSID',pic:'ZZZZZ9'},{av:'A260UsuariosTelef',fld:'USUARIOSTELEF',pic:''},{av:'A261UsuariosCorreo',fld:'USUARIOSCORREO',pic:''},{av:'A284SUBT_ReclutadorId',fld:'SUBT_RECLUTADORID',pic:'ZZZZZ9'},{av:'A288VacantesUsuariosFechaP',fld:'VACANTESUSUARIOSFECHAP',pic:'99/99/9999 99:99'},{av:'A292VacantesUsuariosCV',fld:'VACANTESUSUARIOSCV',pic:'ZZZ9'},{av:'A291VacantesUsuariosPrefiltro',fld:'VACANTESUSUARIOSPREFILTRO',pic:'ZZZ9'},{av:'A293VacantesUsuariosExTec',fld:'VACANTESUSUARIOSEXTEC',pic:'ZZZ9'},{av:'A295VacantesUsuariosFechaE',fld:'VACANTESUSUARIOSFECHAE',pic:'99/99/99 99:99'},{av:'A314VacantesUsuariosFecha3',fld:'VACANTESUSUARIOSFECHA3',pic:'99/99/99 99:99'},{av:'A304VacantesUsuariosAvConf',fld:'VACANTESUSUARIOSAVCONF',pic:'ZZZ9'},{av:'A303VacantesUsuariosAvPriv',fld:'VACANTESUSUARIOSAVPRIV',pic:'ZZZ9'},{av:'A302VacantesUsuariosBusWeb',fld:'VACANTESUSUARIOSBUSWEB',pic:'ZZZ9'},{av:'A301VacantesUsuariosExPsi',fld:'VACANTESUSUARIOSEXPSI',pic:'ZZZ9'},{av:'A300VacantesUsuariosRefLab',fld:'VACANTESUSUARIOSREFLAB',pic:'ZZZ9'},{av:'A299VacantesUsuariosCVRec',fld:'VACANTESUSUARIOSCVREC',pic:'ZZZ9'},{av:'A313VacantesUsuariosFechaA',fld:'VACANTESUSUARIOSFECHAA',pic:'99/99/99 99:99'},{av:'A289VacantesUsuariosFechaD',fld:'VACANTESUSUARIOSFECHAD',pic:'99/99/99 99:99'},{av:'A294VacantesUsuariosMotD',fld:'VACANTESUSUARIOSMOTD',pic:''}]");
         setEventMetadata("VVARDESCARTAR.CLICK",",oparms:[]}");
         setEventMetadata("'REGRESAR'","{handler:'E11381',iparms:[]");
         setEventMetadata("'REGRESAR'",",oparms:[]}");
         setEventMetadata("'REFRESCAR'","{handler:'E12382',iparms:[{av:'GRID2_nFirstRecordOnPage'},{av:'GRID2_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV17vacantes_id',fld:'vVACANTES_ID',pic:'ZZZZZZZZ9',hsh:true},{av:'edtavVacantesusuariosestatus_Visible',ctrl:'vVACANTESUSUARIOSESTATUS',prop:'Visible'},{av:'edtVacantesUsuariosEstatus_Visible',ctrl:'VACANTESUSUARIOSESTATUS',prop:'Visible'},{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'edtavVacantes_id_envio_Visible',ctrl:'vVACANTES_ID_ENVIO',prop:'Visible'},{av:'AV5adjuntar',fld:'vADJUNTAR',pic:''},{av:'A263Vacantes_Id',fld:'VACANTES_ID',pic:'ZZZZZZZZ9'},{av:'A290VacantesUsuariosEstatus',fld:'VACANTESUSUARIOSESTATUS',pic:'ZZZ9'},{av:'AV24VacantesUsuariosEstatus',fld:'vVACANTESUSUARIOSESTATUS',pic:'ZZZ9'},{av:'A11UsuariosId',fld:'USUARIOSID',pic:'ZZZZZ9'},{av:'A260UsuariosTelef',fld:'USUARIOSTELEF',pic:''},{av:'A261UsuariosCorreo',fld:'USUARIOSCORREO',pic:''},{av:'A284SUBT_ReclutadorId',fld:'SUBT_RECLUTADORID',pic:'ZZZZZ9'},{av:'A288VacantesUsuariosFechaP',fld:'VACANTESUSUARIOSFECHAP',pic:'99/99/9999 99:99'},{av:'A292VacantesUsuariosCV',fld:'VACANTESUSUARIOSCV',pic:'ZZZ9'},{av:'A291VacantesUsuariosPrefiltro',fld:'VACANTESUSUARIOSPREFILTRO',pic:'ZZZ9'},{av:'A293VacantesUsuariosExTec',fld:'VACANTESUSUARIOSEXTEC',pic:'ZZZ9'},{av:'A295VacantesUsuariosFechaE',fld:'VACANTESUSUARIOSFECHAE',pic:'99/99/99 99:99'},{av:'A314VacantesUsuariosFecha3',fld:'VACANTESUSUARIOSFECHA3',pic:'99/99/99 99:99'},{av:'A304VacantesUsuariosAvConf',fld:'VACANTESUSUARIOSAVCONF',pic:'ZZZ9'},{av:'A303VacantesUsuariosAvPriv',fld:'VACANTESUSUARIOSAVPRIV',pic:'ZZZ9'},{av:'A302VacantesUsuariosBusWeb',fld:'VACANTESUSUARIOSBUSWEB',pic:'ZZZ9'},{av:'A301VacantesUsuariosExPsi',fld:'VACANTESUSUARIOSEXPSI',pic:'ZZZ9'},{av:'A300VacantesUsuariosRefLab',fld:'VACANTESUSUARIOSREFLAB',pic:'ZZZ9'},{av:'A299VacantesUsuariosCVRec',fld:'VACANTESUSUARIOSCVREC',pic:'ZZZ9'},{av:'A313VacantesUsuariosFechaA',fld:'VACANTESUSUARIOSFECHAA',pic:'99/99/99 99:99'},{av:'A289VacantesUsuariosFechaD',fld:'VACANTESUSUARIOSFECHAD',pic:'99/99/99 99:99'},{av:'A294VacantesUsuariosMotD',fld:'VACANTESUSUARIOSMOTD',pic:''}]");
         setEventMetadata("'REFRESCAR'",",oparms:[]}");
         setEventMetadata("GRID1_FIRSTPAGE","{handler:'subgrid1_firstpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'edtavVacantesusuariosestatus_Visible',ctrl:'vVACANTESUSUARIOSESTATUS',prop:'Visible'},{av:'edtavVacantes_id_envio_Visible',ctrl:'vVACANTES_ID_ENVIO',prop:'Visible'},{av:'AV5adjuntar',fld:'vADJUNTAR',pic:''},{av:'AV17vacantes_id',fld:'vVACANTES_ID',pic:'ZZZZZZZZ9',hsh:true},{av:'A263Vacantes_Id',fld:'VACANTES_ID',pic:'ZZZZZZZZ9'},{av:'A290VacantesUsuariosEstatus',fld:'VACANTESUSUARIOSESTATUS',pic:'ZZZ9'},{av:'AV24VacantesUsuariosEstatus',fld:'vVACANTESUSUARIOSESTATUS',pic:'ZZZ9'},{av:'A11UsuariosId',fld:'USUARIOSID',pic:'ZZZZZ9'},{av:'A260UsuariosTelef',fld:'USUARIOSTELEF',pic:''},{av:'A261UsuariosCorreo',fld:'USUARIOSCORREO',pic:''},{av:'A284SUBT_ReclutadorId',fld:'SUBT_RECLUTADORID',pic:'ZZZZZ9'},{av:'A288VacantesUsuariosFechaP',fld:'VACANTESUSUARIOSFECHAP',pic:'99/99/9999 99:99'},{av:'A292VacantesUsuariosCV',fld:'VACANTESUSUARIOSCV',pic:'ZZZ9'},{av:'A291VacantesUsuariosPrefiltro',fld:'VACANTESUSUARIOSPREFILTRO',pic:'ZZZ9'},{av:'A293VacantesUsuariosExTec',fld:'VACANTESUSUARIOSEXTEC',pic:'ZZZ9'},{av:'A295VacantesUsuariosFechaE',fld:'VACANTESUSUARIOSFECHAE',pic:'99/99/99 99:99'},{av:'A314VacantesUsuariosFecha3',fld:'VACANTESUSUARIOSFECHA3',pic:'99/99/99 99:99'},{av:'A304VacantesUsuariosAvConf',fld:'VACANTESUSUARIOSAVCONF',pic:'ZZZ9'},{av:'A303VacantesUsuariosAvPriv',fld:'VACANTESUSUARIOSAVPRIV',pic:'ZZZ9'},{av:'A302VacantesUsuariosBusWeb',fld:'VACANTESUSUARIOSBUSWEB',pic:'ZZZ9'},{av:'A301VacantesUsuariosExPsi',fld:'VACANTESUSUARIOSEXPSI',pic:'ZZZ9'},{av:'A300VacantesUsuariosRefLab',fld:'VACANTESUSUARIOSREFLAB',pic:'ZZZ9'},{av:'A299VacantesUsuariosCVRec',fld:'VACANTESUSUARIOSCVREC',pic:'ZZZ9'},{av:'A313VacantesUsuariosFechaA',fld:'VACANTESUSUARIOSFECHAA',pic:'99/99/99 99:99'},{av:'A289VacantesUsuariosFechaD',fld:'VACANTESUSUARIOSFECHAD',pic:'99/99/99 99:99'},{av:'A294VacantesUsuariosMotD',fld:'VACANTESUSUARIOSMOTD',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         AV48Vacantesusuariosextec_GXI = "";
         AV19VacantesUsuariosAvConf = "";
         AV54Vacantesusuariosavconf_GXI = "";
         AV20VacantesUsuariosAvPriv = "";
         AV53Vacantesusuariosavpriv_GXI = "";
         AV21VacantesUsuariosBusWeb = "";
         AV52Vacantesusuariosbusweb_GXI = "";
         AV32VacantesUsuariosRefLab = "";
         AV50Vacantesusuariosreflab_GXI = "";
         AV25VacantesUsuariosExPsi = "";
         AV51Vacantesusuariosexpsi_GXI = "";
         AV23VacantesUsuariosCVRec = "";
         AV49Vacantesusuarioscvrec_GXI = "";
         AV41Adjuntar_GXI = "";
         AV7Siguiente = "";
         AV47Siguiente_GXI = "";
         AV34VarDescartar = "";
         AV44Vardescartar_GXI = "";
         GXDecQS = "";
         gxdynajaxctrlcodr = new GeneXus.Utils.GxStringCollection();
         gxdynajaxctrldescr = new GeneXus.Utils.GxStringCollection();
         gxwrpcisep = "";
         scmdbuf = "";
         H00382_A11UsuariosId = new int[1] ;
         H00382_A97UsuariosNomCompleto = new String[] {""} ;
         H00383_A11UsuariosId = new int[1] ;
         H00383_A97UsuariosNomCompleto = new String[] {""} ;
         H00384_A290VacantesUsuariosEstatus = new short[1] ;
         H00384_n290VacantesUsuariosEstatus = new bool[] {false} ;
         H00384_A263Vacantes_Id = new int[1] ;
         H00384_A11UsuariosId = new int[1] ;
         H00384_A260UsuariosTelef = new String[] {""} ;
         H00384_A261UsuariosCorreo = new String[] {""} ;
         H00384_A284SUBT_ReclutadorId = new int[1] ;
         H00384_A288VacantesUsuariosFechaP = new DateTime[] {DateTime.MinValue} ;
         H00384_A291VacantesUsuariosPrefiltro = new short[1] ;
         H00384_n291VacantesUsuariosPrefiltro = new bool[] {false} ;
         H00384_A292VacantesUsuariosCV = new short[1] ;
         H00384_n292VacantesUsuariosCV = new bool[] {false} ;
         H00384_A295VacantesUsuariosFechaE = new DateTime[] {DateTime.MinValue} ;
         H00384_n295VacantesUsuariosFechaE = new bool[] {false} ;
         H00384_A293VacantesUsuariosExTec = new short[1] ;
         H00384_n293VacantesUsuariosExTec = new bool[] {false} ;
         H00384_A299VacantesUsuariosCVRec = new short[1] ;
         H00384_n299VacantesUsuariosCVRec = new bool[] {false} ;
         H00384_A300VacantesUsuariosRefLab = new short[1] ;
         H00384_n300VacantesUsuariosRefLab = new bool[] {false} ;
         H00384_A301VacantesUsuariosExPsi = new short[1] ;
         H00384_n301VacantesUsuariosExPsi = new bool[] {false} ;
         H00384_A302VacantesUsuariosBusWeb = new short[1] ;
         H00384_n302VacantesUsuariosBusWeb = new bool[] {false} ;
         H00384_A303VacantesUsuariosAvPriv = new short[1] ;
         H00384_n303VacantesUsuariosAvPriv = new bool[] {false} ;
         H00384_A304VacantesUsuariosAvConf = new short[1] ;
         H00384_n304VacantesUsuariosAvConf = new bool[] {false} ;
         H00384_A314VacantesUsuariosFecha3 = new DateTime[] {DateTime.MinValue} ;
         H00384_n314VacantesUsuariosFecha3 = new bool[] {false} ;
         H00384_A313VacantesUsuariosFechaA = new DateTime[] {DateTime.MinValue} ;
         H00384_n313VacantesUsuariosFechaA = new bool[] {false} ;
         H00384_A294VacantesUsuariosMotD = new String[] {""} ;
         H00384_n294VacantesUsuariosMotD = new bool[] {false} ;
         H00384_A289VacantesUsuariosFechaD = new DateTime[] {DateTime.MinValue} ;
         H00384_n289VacantesUsuariosFechaD = new bool[] {false} ;
         H00385_A263Vacantes_Id = new int[1] ;
         H00385_A264Vacantes_Nombre = new String[] {""} ;
         A264Vacantes_Nombre = "";
         AV36Nombre_Vacante = "";
         Grid2Row = new GXWebRow();
         H00386_A290VacantesUsuariosEstatus = new short[1] ;
         H00386_n290VacantesUsuariosEstatus = new bool[] {false} ;
         H00386_A263Vacantes_Id = new int[1] ;
         H00386_A11UsuariosId = new int[1] ;
         H00386_A260UsuariosTelef = new String[] {""} ;
         H00386_A261UsuariosCorreo = new String[] {""} ;
         H00386_A284SUBT_ReclutadorId = new int[1] ;
         H00386_A288VacantesUsuariosFechaP = new DateTime[] {DateTime.MinValue} ;
         H00386_A291VacantesUsuariosPrefiltro = new short[1] ;
         H00386_n291VacantesUsuariosPrefiltro = new bool[] {false} ;
         H00386_A292VacantesUsuariosCV = new short[1] ;
         H00386_n292VacantesUsuariosCV = new bool[] {false} ;
         H00386_A295VacantesUsuariosFechaE = new DateTime[] {DateTime.MinValue} ;
         H00386_n295VacantesUsuariosFechaE = new bool[] {false} ;
         H00386_A293VacantesUsuariosExTec = new short[1] ;
         H00386_n293VacantesUsuariosExTec = new bool[] {false} ;
         H00386_A299VacantesUsuariosCVRec = new short[1] ;
         H00386_n299VacantesUsuariosCVRec = new bool[] {false} ;
         H00386_A300VacantesUsuariosRefLab = new short[1] ;
         H00386_n300VacantesUsuariosRefLab = new bool[] {false} ;
         H00386_A301VacantesUsuariosExPsi = new short[1] ;
         H00386_n301VacantesUsuariosExPsi = new bool[] {false} ;
         H00386_A302VacantesUsuariosBusWeb = new short[1] ;
         H00386_n302VacantesUsuariosBusWeb = new bool[] {false} ;
         H00386_A303VacantesUsuariosAvPriv = new short[1] ;
         H00386_n303VacantesUsuariosAvPriv = new bool[] {false} ;
         H00386_A304VacantesUsuariosAvConf = new short[1] ;
         H00386_n304VacantesUsuariosAvConf = new bool[] {false} ;
         H00386_A314VacantesUsuariosFecha3 = new DateTime[] {DateTime.MinValue} ;
         H00386_n314VacantesUsuariosFecha3 = new bool[] {false} ;
         H00386_A313VacantesUsuariosFechaA = new DateTime[] {DateTime.MinValue} ;
         H00386_n313VacantesUsuariosFechaA = new bool[] {false} ;
         H00386_A294VacantesUsuariosMotD = new String[] {""} ;
         H00386_n294VacantesUsuariosMotD = new bool[] {false} ;
         H00386_A289VacantesUsuariosFechaD = new DateTime[] {DateTime.MinValue} ;
         H00386_n289VacantesUsuariosFechaD = new bool[] {false} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wpreclusegcord__default(),
            new Object[][] {
                new Object[] {
               H00382_A11UsuariosId, H00382_A97UsuariosNomCompleto
               }
               , new Object[] {
               H00383_A11UsuariosId, H00383_A97UsuariosNomCompleto
               }
               , new Object[] {
               H00384_A290VacantesUsuariosEstatus, H00384_n290VacantesUsuariosEstatus, H00384_A263Vacantes_Id, H00384_A11UsuariosId, H00384_A260UsuariosTelef, H00384_A261UsuariosCorreo, H00384_A284SUBT_ReclutadorId, H00384_A288VacantesUsuariosFechaP, H00384_A291VacantesUsuariosPrefiltro, H00384_n291VacantesUsuariosPrefiltro,
               H00384_A292VacantesUsuariosCV, H00384_n292VacantesUsuariosCV, H00384_A295VacantesUsuariosFechaE, H00384_n295VacantesUsuariosFechaE, H00384_A293VacantesUsuariosExTec, H00384_n293VacantesUsuariosExTec, H00384_A299VacantesUsuariosCVRec, H00384_n299VacantesUsuariosCVRec, H00384_A300VacantesUsuariosRefLab, H00384_n300VacantesUsuariosRefLab,
               H00384_A301VacantesUsuariosExPsi, H00384_n301VacantesUsuariosExPsi, H00384_A302VacantesUsuariosBusWeb, H00384_n302VacantesUsuariosBusWeb, H00384_A303VacantesUsuariosAvPriv, H00384_n303VacantesUsuariosAvPriv, H00384_A304VacantesUsuariosAvConf, H00384_n304VacantesUsuariosAvConf, H00384_A314VacantesUsuariosFecha3, H00384_n314VacantesUsuariosFecha3,
               H00384_A313VacantesUsuariosFechaA, H00384_n313VacantesUsuariosFechaA, H00384_A294VacantesUsuariosMotD, H00384_n294VacantesUsuariosMotD, H00384_A289VacantesUsuariosFechaD, H00384_n289VacantesUsuariosFechaD
               }
               , new Object[] {
               H00385_A263Vacantes_Id, H00385_A264Vacantes_Nombre
               }
               , new Object[] {
               H00386_A290VacantesUsuariosEstatus, H00386_n290VacantesUsuariosEstatus, H00386_A263Vacantes_Id, H00386_A11UsuariosId, H00386_A260UsuariosTelef, H00386_A261UsuariosCorreo, H00386_A284SUBT_ReclutadorId, H00386_A288VacantesUsuariosFechaP, H00386_A291VacantesUsuariosPrefiltro, H00386_n291VacantesUsuariosPrefiltro,
               H00386_A292VacantesUsuariosCV, H00386_n292VacantesUsuariosCV, H00386_A295VacantesUsuariosFechaE, H00386_n295VacantesUsuariosFechaE, H00386_A293VacantesUsuariosExTec, H00386_n293VacantesUsuariosExTec, H00386_A299VacantesUsuariosCVRec, H00386_n299VacantesUsuariosCVRec, H00386_A300VacantesUsuariosRefLab, H00386_n300VacantesUsuariosRefLab,
               H00386_A301VacantesUsuariosExPsi, H00386_n301VacantesUsuariosExPsi, H00386_A302VacantesUsuariosBusWeb, H00386_n302VacantesUsuariosBusWeb, H00386_A303VacantesUsuariosAvPriv, H00386_n303VacantesUsuariosAvPriv, H00386_A304VacantesUsuariosAvConf, H00386_n304VacantesUsuariosAvConf, H00386_A314VacantesUsuariosFecha3, H00386_n314VacantesUsuariosFecha3,
               H00386_A313VacantesUsuariosFechaA, H00386_n313VacantesUsuariosFechaA, H00386_A294VacantesUsuariosMotD, H00386_n294VacantesUsuariosMotD, H00386_A289VacantesUsuariosFechaD, H00386_n289VacantesUsuariosFechaD
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private int AV17vacantes_id ;
      private int wcpOAV17vacantes_id ;
      ...
      private bool AV5adjuntar_IsBlob ;
      private bool AV7Siguiente_IsBlob ;
      private bool AV34VarDescartar_IsBlob ;
      ...
      private String AV48Vacantesusuariosextec_GXI ;
      private String AV54Vacantesusuariosavconf_GXI ;
      private String AV53Vacantesusuariosavpriv_GXI ;
      private String AV52Vacantesusuariosbusweb_GXI ;
      private String AV50Vacantesusuariosreflab_GXI ;
      private String AV51Vacantesusuariosexpsi_GXI ;
      private String AV49Vacantesusuarioscvrec_GXI ;
      private String AV41Adjuntar_GXI ;
      private String AV47Siguiente_GXI ;
      private String AV44Vardescartar_GXI ;
      private String A264Vacantes_Nombre ;
      private String AV36Nombre_Vacante ;
      ...
      private String AV7Siguiente ;
      private String AV34VarDescartar ;
      ...
      private int[] H00382_A11UsuariosId ;
      private String[] H00382_A97UsuariosNomCompleto ;
      private int[] H00383_A11UsuariosId ;
      private String[] H00383_A97UsuariosNomCompleto ;
      private short[] H00384_A290VacantesUsuariosEstatus ;
      private bool[] H00384_n290VacantesUsuariosEstatus ;
      private int[] H00384_A263Vacantes_Id ;
      private int[] H00384_A11UsuariosId ;
      private String[] H00384_A260UsuariosTelef ;
      private String[] H00384_A261UsuariosCorreo ;
      private int[] H00384_A284SUBT_ReclutadorId ;
      private DateTime[] H00384_A288VacantesUsuariosFechaP ;
      private short[] H00384_A291VacantesUsuariosPrefiltro ;
      private bool[] H00384_n291VacantesUsuariosPrefiltro ;
      private short[] H00384_A292VacantesUsuariosCV ;
      private bool[] H00384_n292VacantesUsuariosCV ;
      private DateTime[] H00384_A295VacantesUsuariosFechaE ;
      private bool[] H00384_n295VacantesUsuariosFechaE ;
      private short[] H00384_A293VacantesUsuariosExTec ;
      private bool[] H00384_n293VacantesUsuariosExTec ;
      private short[] H00384_A299VacantesUsuariosCVRec ;
      private bool[] H00384_n299VacantesUsuariosCVRec ;
      private short[] H00384_A300VacantesUsuariosRefLab ;
      private bool[] H00384_n300VacantesUsuariosRefLab ;
      private short[] H00384_A301VacantesUsuariosExPsi ;
      private bool[] H00384_n301VacantesUsuariosExPsi ;
      private short[] H00384_A302VacantesUsuariosBusWeb ;
      private bool[] H00384_n302VacantesUsuariosBusWeb ;
      private short[] H00384_A303VacantesUsuariosAvPriv ;
      private bool[] H00384_n303VacantesUsuariosAvPriv ;
      private short[] H00384_A304VacantesUsuariosAvConf ;
      private bool[] H00384_n304VacantesUsuariosAvConf ;
      private DateTime[] H00384_A314VacantesUsuariosFecha3 ;
      private bool[] H00384_n314VacantesUsuariosFecha3 ;
      private DateTime[] H00384_A313VacantesUsuariosFechaA ;
      private bool[] H00384_n313VacantesUsuariosFechaA ;
      private String[] H00384_A294VacantesUsuariosMotD ;
      private bool[] H00384_n294VacantesUsuariosMotD ;
      private DateTime[] H00384_A289VacantesUsuariosFechaD ;
      private bool[] H00384_n289VacantesUsuariosFechaD ;
      private int[] H00385_A263Vacantes_Id ;
      private String[] H00385_A264Vacantes_Nombre ;
      private short[] H00386_A290VacantesUsuariosEstatus ;
      private bool[] H00386_n290VacantesUsuariosEstatus ;
      private int[] H00386_A263Vacantes_Id ;
      private int[] H00386_A11UsuariosId ;
      private String[] H00386_A260UsuariosTelef ;
      private String[] H00386_A261UsuariosCorreo ;
      private int[] H00386_A284SUBT_ReclutadorId ;
      private DateTime[] H00386_A288VacantesUsuariosFechaP ;
      private short[] H00386_A291VacantesUsuariosPrefiltro ;
      private bool[] H00386_n291VacantesUsuariosPrefiltro ;
      private short[] H00386_A292VacantesUsuariosCV ;
      private bool[] H00386_n292VacantesUsuariosCV ;
      private DateTime[] H00386_A295VacantesUsuariosFechaE ;
      private bool[] H00386_n295VacantesUsuariosFechaE ;
      private short[] H00386_A293VacantesUsuariosExTec ;
      private bool[] H00386_n293VacantesUsuariosExTec ;
      private short[] H00386_A299VacantesUsuariosCVRec ;
      private bool[] H00386_n299VacantesUsuariosCVRec ;
      private short[] H00386_A300VacantesUsuariosRefLab ;
      private bool[] H00386_n300VacantesUsuariosRefLab ;
      private short[] H00386_A301VacantesUsuariosExPsi ;
      private bool[] H00386_n301VacantesUsuariosExPsi ;
      private short[] H00386_A302VacantesUsuariosBusWeb ;
      private bool[] H00386_n302VacantesUsuariosBusWeb ;
      private short[] H00386_A303VacantesUsuariosAvPriv ;
      private bool[] H00386_n303VacantesUsuariosAvPriv ;
      private short[] H00386_A304VacantesUsuariosAvConf ;
      private bool[] H00386_n304VacantesUsuariosAvConf ;
      private DateTime[] H00386_A314VacantesUsuariosFecha3 ;
      private bool[] H00386_n314VacantesUsuariosFecha3 ;
      private DateTime[] H00386_A313VacantesUsuariosFechaA ;
      private bool[] H00386_n313VacantesUsuariosFechaA ;
      private String[] H00386_A294VacantesUsuariosMotD ;
      private bool[] H00386_n294VacantesUsuariosMotD ;
      private DateTime[] H00386_A289VacantesUsuariosFechaD ;
      private bool[] H00386_n289VacantesUsuariosFechaD ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private GXWebForm Form ;
   }

   public class wpreclusegcord__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          Object[] prmH00384 ;
          prmH00384 = new Object[] {
          new Object[] {"AV17vacantes_id",System.Data.DbType.Int32,9,0}
          } ;
          Object[] prmH00385 ;
          prmH00385 = new Object[] {
          new Object[] {"AV17vacantes_id",System.Data.DbType.Int32,9,0}
          } ;
          Object[] prmH00386 ;
          prmH00386 = new Object[] {
          new Object[] {"AV17vacantes_id",System.Data.DbType.Int32,9,0} ,
          new Object[] {"AV24VacantesUsuariosEstatus",System.Data.DbType.Int16,4,0}
          } ;
          def= new CursorDef[] {
              new CursorDef("H00382", "SELECT `UsuariosId`, CONCAT(CONCAT(CONCAT(CONCAT(RTRIM(LTRIM(`UsuariosNombre`)), ' '), RTRIM(LTRIM(`UsuariosApPat`))), ' '), RTRIM(LTRIM(`UsuariosApMat`))) AS UsuariosNomCompleto FROM `Usuarios` ORDER BY `UsuariosNomCompleto` ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00382,0, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H00383", "SELECT `UsuariosId`, CONCAT(CONCAT(CONCAT(CONCAT(RTRIM(LTRIM(`UsuariosNombre`)), ' '), RTRIM(LTRIM(`UsuariosApPat`))), ' '), RTRIM(LTRIM(`UsuariosApMat`))) AS UsuariosNomCompleto FROM `Usuarios` ORDER BY `UsuariosNomCompleto` ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00383,0, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H00384", "SELECT DISTINCT `VacantesUsuariosEstatus`, NULL AS `Vacantes_Id`, NULL AS `UsuariosId`, NULL AS `UsuariosTelef`, NULL AS `UsuariosCorreo`, NULL AS `SUBT_ReclutadorId`, NULL AS `VacantesUsuariosFechaP`, NULL AS `VacantesUsuariosPrefiltro`, NULL AS `VacantesUsuariosCV`, NULL AS `VacantesUsuariosFechaE`, NULL AS `VacantesUsuariosExTec`, NULL AS `VacantesUsuariosCVRec`, NULL AS `VacantesUsuariosRefLab`, NULL AS `VacantesUsuariosExPsi`, NULL AS `VacantesUsuariosBusWeb`, NULL AS `VacantesUsuariosAvPriv`, NULL AS `VacantesUsuariosAvConf`, NULL AS `VacantesUsuariosFecha3`, NULL AS `VacantesUsuariosFechaA`, NULL AS `VacantesUsuariosMotD`, NULL AS `VacantesUsuariosFechaD` FROM ( SELECT T1.`VacantesUsuariosEstatus`, T1.`Vacantes_Id`, T1.`UsuariosId`, T2.`UsuariosTelef`, T2.`UsuariosCorreo`, T1.`SUBT_ReclutadorId`, T1.`VacantesUsuariosFechaP`, T1.`VacantesUsuariosPrefiltro`, T1.`VacantesUsuariosCV`, T1.`VacantesUsuariosFechaE`, T1.`VacantesUsuariosExTec`, T1.`VacantesUsuariosCVRec`, T1.`VacantesUsuariosRefLab`, T1.`VacantesUsuariosExPsi`, T1.`VacantesUsuariosBusWeb`, T1.`VacantesUsuariosAvPriv`, T1.`VacantesUsuariosAvConf`, T1.`VacantesUsuariosFecha3`, T1.`VacantesUsuariosFechaA`, T1.`VacantesUsuariosMotD`, T1.`VacantesUsuariosFechaD` FROM (`VacantesUsuariosVacante` T1 INNER JOIN `Usuarios` T2 ON T2.`UsuariosId` = T1.`UsuariosId`) WHERE T1.`Vacantes_Id` = ? ORDER BY T1.`VacantesUsuariosEstatus`) DistinctT ORDER BY `VacantesUsuariosEstatus` ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00384,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H00385", "SELECT `Vacantes_Id`, `Vacantes_Nombre` FROM `Vacantes` WHERE `Vacantes_Id` = ? ORDER BY `Vacantes_Id`  LIMIT 1",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00385,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("H00386", "SELECT T1.`VacantesUsuariosEstatus`, T1.`Vacantes_Id`, T1.`UsuariosId`, T2.`UsuariosTelef`, T2.`UsuariosCorreo`, T1.`SUBT_ReclutadorId`, T1.`VacantesUsuariosFechaP`, T1.`VacantesUsuariosPrefiltro`, T1.`VacantesUsuariosCV`, T1.`VacantesUsuariosFechaE`, T1.`VacantesUsuariosExTec`, T1.`VacantesUsuariosCVRec`, T1.`VacantesUsuariosRefLab`, T1.`VacantesUsuariosExPsi`, T1.`VacantesUsuariosBusWeb`, T1.`VacantesUsuariosAvPriv`, T1.`VacantesUsuariosAvConf`, T1.`VacantesUsuariosFecha3`, T1.`VacantesUsuariosFechaA`, T1.`VacantesUsuariosMotD`, T1.`VacantesUsuariosFechaD` FROM (`VacantesUsuariosVacante` T1 INNER JOIN `Usuarios` T2 ON T2.`UsuariosId` = T1.`UsuariosId`) WHERE (T1.`Vacantes_Id` = ?) AND (T1.`Vacantes_Id` <> 17) AND (T1.`VacantesUsuariosEstatus` = ?) ORDER BY T1.`Vacantes_Id` ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00386,100, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
