...
namespace GeneXus.Programs {
   public class accesobak : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public accesobak( )
      {
      ...
      public accesobak( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202262714345262", false, true);
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"Form\" data-gx-class=\"Form\" novalidate action=\""+formatLink("accesobak.aspx") +"\">") ;
      ...
      {
         return formatLink("accesobak.aspx")  ;
      }
      ...
      protected void START2C2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Acceso BAK", 0) ;
         }
         context.wjLoc = "";
      ...
      {
         /* Start Routine */
         CallWebObject(formatLink("asalir.aspx") );
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202262714345265", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("accesobak.js", "?202262714345265", false, true);
         }
