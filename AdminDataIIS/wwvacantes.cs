...
namespace GeneXus.Programs {
   public class wwvacantes : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public wwvacantes( )
      {
      ...
      public wwvacantes( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202262714344961", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wwvacantes.aspx") +"\">") ;
      ...
      {
         return formatLink("wwvacantes.aspx")  ;
      }
      ...
      {
         return "Work With Work With Vacantes" ;
      }
      ...
      protected void WB240( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "Vacantes", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, "HLP_WWVacantes.htm");
            ...
            ClassString = "BtnAdd";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(25), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWVacantes.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START242( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Work With Work With Vacantes", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void RF242( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A265Vacantes_Status = H00242_A265Vacantes_Status[0];
               A270Vacantes_Duracion_Nom = H00242_A270Vacantes_Duracion_Nom[0];
               A269Vacantes_Duracion = H00242_A269Vacantes_Duracion[0];
               A268Vacantes_Tipo = H00242_A268Vacantes_Tipo[0];
               A267Vacantes_Sueldo = H00242_A267Vacantes_Sueldo[0];
               A266Vacantes_FechaInicio = H00242_A266Vacantes_FechaInicio[0];
               A264Vacantes_Nombre = H00242_A264Vacantes_Nombre[0];
               A263Vacantes_Id = H00242_A263Vacantes_Id[0];
               E14242 ();
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202262714344995", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwvacantes.js", "?202262714344995", false, true);
         }
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Work With Work With Vacantes";
         subGrid_Rows = 15;
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E14242',iparms:[{av:'cmbVacantes_Status'},{av:'A265Vacantes_Status',fld:'VACANTES_STATUS',pic:'ZZZ9'},{av:'A263Vacantes_Id',fld:'VACANTES_ID',pic:'ZZZZZZZZ9',hsh:true}]");
         ...
         setEventMetadata("'DOINSERT'","{handler:'E11242',iparms:[{av:'A263Vacantes_Id',fld:'VACANTES_ID',pic:'ZZZZZZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV13Vacantes_Nombre = "";
         H00242_A265Vacantes_Status = new short[1] ;
         H00242_A270Vacantes_Duracion_Nom = new short[1] ;
         H00242_A269Vacantes_Duracion = new short[1] ;
         H00242_A268Vacantes_Tipo = new short[1] ;
         H00242_A267Vacantes_Sueldo = new decimal[1] ;
         H00242_A266Vacantes_FechaInicio = new DateTime[] {DateTime.MinValue} ;
         H00242_A264Vacantes_Nombre = new String[] {""} ;
         H00242_A263Vacantes_Id = new int[1] ;
         ...
         ROClassString = "";
         GXCCtl = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwvacantes__default(),
            new Object[][] {
                new Object[] {
               H00242_A265Vacantes_Status, H00242_A270Vacantes_Duracion_Nom, H00242_A269Vacantes_Duracion, H00242_A268Vacantes_Tipo, H00242_A267Vacantes_Sueldo, H00242_A266Vacantes_FechaInicio, H00242_A264Vacantes_Nombre, H00242_A263Vacantes_Id
               }
               , new Object[] {
      ...
      private short[] H00242_A265Vacantes_Status ;
      private short[] H00242_A270Vacantes_Duracion_Nom ;
      private short[] H00242_A269Vacantes_Duracion ;
      private short[] H00242_A268Vacantes_Tipo ;
      private decimal[] H00242_A267Vacantes_Sueldo ;
      private DateTime[] H00242_A266Vacantes_FechaInicio ;
      private String[] H00242_A264Vacantes_Nombre ;
      private int[] H00242_A263Vacantes_Id ;
   ...
   public class wwvacantes__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00242(context, (String)dynConstraints[0] , (String)dynConstraints[1] );
               case 1 :
                     return conditional_H00243(context, (String)dynConstraints[0] , (String)dynConstraints[1] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00242", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00242,16, GxCacheFrequency.OFF ,true,false )
