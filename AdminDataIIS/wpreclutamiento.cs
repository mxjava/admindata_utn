...
namespace GeneXus.Programs {
   public class wpreclutamiento : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public wpreclutamiento( )
      {
      ...
      public wpreclutamiento( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
            {
               ...
               AV17UsuarioId = (int)(NumberUtil.Val( GetNextPar( ), "."));
               ...
               gxgrGrid1_refresh( A263Vacantes_Id, A284SUBT_ReclutadorId, AV17UsuarioId, A290VacantesUsuariosEstatus, A277Vacantes_Plazas) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202262714345493", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wpreclutamiento.aspx") +"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_vUSUARIOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV17UsuarioId), "ZZZZZZZZ9"), context));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vUSUARIOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV17UsuarioId), 9, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vUSUARIOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV17UsuarioId), "ZZZZZZZZ9"), context));
      ...
      {
         return formatLink("wpreclutamiento.aspx")  ;
      }

      public override String GetPgmname( )
      {
         return "wpReclutamiento" ;
      }
      ...
      protected void WB320( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock4_Internalname, "Seguimiento por Vacante", "", "", lblTextblock4_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, "HLP_wpReclutamiento.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock5_Internalname, "Text Block", "", "", lblTextblock5_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitle", 0, "", lblTextblock5_Visible, 1, 0, "HLP_wpReclutamiento.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            else
            {
               ...
               Grid1Container.AddColumnProperties(Grid1Column);
               Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
               Grid1Column.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6Vacantes_Nombre), 4, 0, ".", "")));
               ...
               Grid1Container.AddColumnProperties(Grid1Column);
               Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
               Grid1Column.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12Vacantes_Id), 9, 0, ".", "")));
               ...
               Grid1Container.AddColumnProperties(Grid1Column);
               Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
               Grid1Column.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV7Proceso_Completo), 4, 0, ".", "")));
               ...
               Grid1Container.AddColumnProperties(Grid1Column);
               Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
               Grid1Column.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8Enviado_Cliente), 4, 0, ".", "")));
               ...
               Grid1Container.AddColumnProperties(Grid1Column);
               Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
               Grid1Column.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV9Descartados), 4, 0, ".", "")));
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 10), "GRID1.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "'REVISAR'") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "'REVISAR'") == 0 ) )
                           {
                              ...
                              AV6Vacantes_Nombre = (short)(NumberUtil.Val( cgiGet( dynavVacantes_nombre_Internalname), "."));
                              AssignAttri("", false, dynavVacantes_nombre_Internalname, StringUtil.LTrimStr( (decimal)(AV6Vacantes_Nombre), 4, 0));
                              GxWebStd.gx_hidden_field( context, "gxhash_vVACANTES_NOMBRE"+"_"+sGXsfl_15_idx, GetSecureSignedToken( sGXsfl_15_idx, context.localUtil.Format( (decimal)(AV6Vacantes_Nombre), "ZZZ9"), context));
                              if ( ( ( context.localUtil.CToN( cgiGet( edtavVacantes_id_Internalname), ",", ".") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavVacantes_id_Internalname), ",", ".") > Convert.ToDecimal( 999999999 )) ) )
                              {
                                 ...
                                 wbErr = true;
                                 AV12Vacantes_Id = 0;
                                 AssignAttri("", false, edtavVacantes_id_Internalname, StringUtil.LTrimStr( (decimal)(AV12Vacantes_Id), 9, 0));
                              }
                              else
                              {
                                 AV12Vacantes_Id = (int)(context.localUtil.CToN( cgiGet( edtavVacantes_id_Internalname), ",", "."));
                                 AssignAttri("", false, edtavVacantes_id_Internalname, StringUtil.LTrimStr( (decimal)(AV12Vacantes_Id), 9, 0));
                              }
                              if ( ( ( context.localUtil.CToN( cgiGet( edtavProceso_completo_Internalname), ",", ".") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavProceso_completo_Internalname), ",", ".") > Convert.ToDecimal( 9999 )) ) )
                              {
                                 ...
                                 AssignAttri("", false, "GX_FocusControl", GX_FocusControl);
                                 wbErr = true;
                                 AV7Proceso_Completo = 0;
                                 AssignAttri("", false, edtavProceso_completo_Internalname, StringUtil.LTrimStr( (decimal)(AV7Proceso_Completo), 4, 0));
                              }
                              else
                              {
                                 AV7Proceso_Completo = (short)(context.localUtil.CToN( cgiGet( edtavProceso_completo_Internalname), ",", "."));
                                 AssignAttri("", false, edtavProceso_completo_Internalname, StringUtil.LTrimStr( (decimal)(AV7Proceso_Completo), 4, 0));
                              }
                              if ( ( ( context.localUtil.CToN( cgiGet( edtavEnviado_cliente_Internalname), ",", ".") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavEnviado_cliente_Internalname), ",", ".") > Convert.ToDecimal( 9999 )) ) )
                              {
                                 ...
                                 AssignAttri("", false, "GX_FocusControl", GX_FocusControl);
                                 wbErr = true;
                                 AV8Enviado_Cliente = 0;
                                 AssignAttri("", false, edtavEnviado_cliente_Internalname, StringUtil.LTrimStr( (decimal)(AV8Enviado_Cliente), 4, 0));
                              }
                              else
                              {
                                 AV8Enviado_Cliente = (short)(context.localUtil.CToN( cgiGet( edtavEnviado_cliente_Internalname), ",", "."));
                                 AssignAttri("", false, edtavEnviado_cliente_Internalname, StringUtil.LTrimStr( (decimal)(AV8Enviado_Cliente), 4, 0));
                              }
                              if ( ( ( context.localUtil.CToN( cgiGet( edtavDescartados_Internalname), ",", ".") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavDescartados_Internalname), ",", ".") > Convert.ToDecimal( 9999 )) ) )
                              {
                                 ...
                                 wbErr = true;
                                 AV9Descartados = 0;
                                 AssignAttri("", false, edtavDescartados_Internalname, StringUtil.LTrimStr( (decimal)(AV9Descartados), 4, 0));
                              }
                              else
                              {
                                 AV9Descartados = (short)(context.localUtil.CToN( cgiGet( edtavDescartados_Internalname), ",", "."));
                                 AssignAttri("", false, edtavDescartados_Internalname, StringUtil.LTrimStr( (decimal)(AV9Descartados), 4, 0));
                              }
                              sEvtType = StringUtil.Right( sEvt, 1);
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_vVACANTES_NOMBRE", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV6Vacantes_Nombre), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "vVACANTES_NOMBRE", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6Vacantes_Nombre), 4, 0, ".", "")));
      }
      ...
      {
         /* Start Routine */
         AV17UsuarioId = (int)(NumberUtil.Val( AV18WebSession.Get("UsuarioId"), "."));
         AssignAttri("", false, "AV17UsuarioId", StringUtil.LTrimStr( (decimal)(AV17UsuarioId), 9, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vUSUARIOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV17UsuarioId), "ZZZZZZZZ9"), context));
      }
      ...
      private void E12322( )
      {
         ...
         /* Using cursor H00322 */
         pr_default.execute(0, new Object[] {AV17UsuarioId});
         while ( (pr_default.getStatus(0) != 101) )
         {
            BRK323 = false;
            A284SUBT_ReclutadorId = H00322_A284SUBT_ReclutadorId[0];
            A263Vacantes_Id = H00322_A263Vacantes_Id[0];
            A290VacantesUsuariosEstatus = H00322_A290VacantesUsuariosEstatus[0];
            n290VacantesUsuariosEstatus = H00322_n290VacantesUsuariosEstatus[0];
            A277Vacantes_Plazas = H00322_A277Vacantes_Plazas[0];
            A277Vacantes_Plazas = H00322_A277Vacantes_Plazas[0];
            AV12Vacantes_Id = A263Vacantes_Id;
            AssignAttri("", false, edtavVacantes_id_Internalname, StringUtil.LTrimStr( (decimal)(AV12Vacantes_Id), 9, 0));
            AV14ConteoProcComp = 0;
            AV15ConteoEnvClie = 0;
            AV16ContDescar = 0;
            AV7Proceso_Completo = 0;
            AssignAttri("", false, edtavProceso_completo_Internalname, StringUtil.LTrimStr( (decimal)(AV7Proceso_Completo), 4, 0));
            ...
            AV8Enviado_Cliente = 0;
            AssignAttri("", false, edtavEnviado_cliente_Internalname, StringUtil.LTrimStr( (decimal)(AV8Enviado_Cliente), 4, 0));
            while ( (pr_default.getStatus(0) != 101) && ( H00322_A263Vacantes_Id[0] == A263Vacantes_Id ) && ( H00322_A284SUBT_ReclutadorId[0] == A284SUBT_ReclutadorId ) )
            {
               BRK323 = false;
               A290VacantesUsuariosEstatus = H00322_A290VacantesUsuariosEstatus[0];
               n290VacantesUsuariosEstatus = H00322_n290VacantesUsuariosEstatus[0];
               if ( A263Vacantes_Id == AV12Vacantes_Id )
               {
                  if ( A284SUBT_ReclutadorId == AV17UsuarioId )
                  {
                     if ( A290VacantesUsuariosEstatus == 3 )
                     {
                        AV14ConteoProcComp = (short)(AV14ConteoProcComp+1);
                        AV7Proceso_Completo = AV14ConteoProcComp;
                        AssignAttri("", false, edtavProceso_completo_Internalname, StringUtil.LTrimStr( (decimal)(AV7Proceso_Completo), 4, 0));
                     }
                     else if ( A290VacantesUsuariosEstatus == 5 )
                     {
                        AV16ContDescar = (short)(AV16ContDescar+1);
                        AV9Descartados = AV16ContDescar;
                        AssignAttri("", false, edtavDescartados_Internalname, StringUtil.LTrimStr( (decimal)(AV9Descartados), 4, 0));
                     }
                     else if ( A290VacantesUsuariosEstatus == 4 )
                     {
                        AV15ConteoEnvClie = (short)(AV15ConteoEnvClie+1);
                        AV8Enviado_Cliente = AV15ConteoEnvClie;
                        AssignAttri("", false, edtavEnviado_cliente_Internalname, StringUtil.LTrimStr( (decimal)(AV8Enviado_Cliente), 4, 0));
                     }
                     else
                     {
            ...
            AV11NumPlazas = StringUtil.Str( (decimal)(A277Vacantes_Plazas), 4, 0);
            AV6Vacantes_Nombre = (short)(A263Vacantes_Id);
            AssignAttri("", false, dynavVacantes_nombre_Internalname, StringUtil.LTrimStr( (decimal)(AV6Vacantes_Nombre), 4, 0));
            GxWebStd.gx_hidden_field( context, "gxhash_vVACANTES_NOMBRE"+"_"+sGXsfl_15_idx, GetSecureSignedToken( sGXsfl_15_idx, context.localUtil.Format( (decimal)(AV6Vacantes_Nombre), "ZZZ9"), context));
            dynavVacantes_nombre.FontBold = 1;
            lblTextblock1_Caption = AV11NumPlazas;
            /* Load Method */
            if ( wbStart != -1 )
            {
               wbStart = 15;
         ...
         dynavVacantes_nombre.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(AV6Vacantes_Nombre), 4, 0));
      }
      ...
      protected void E13322( )
      {
         ...
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "wprecluseg.aspx"+UrlEncode("" +AV6Vacantes_Nombre);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202262714345516", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wpreclutamiento.js", "?202262714345517", false, true);
         }
      ...
      protected void sendrow_152( )
      {
         ...
         if ( ( dynavVacantes_nombre.ItemCount == 0 ) && isAjaxCallMode( ) )
         {
            ...
            {
               dynavVacantes_nombre.addItem(StringUtil.Trim( StringUtil.Str( (decimal)(H00323_A263Vacantes_Id[0]), 4, 0)), H00323_A264Vacantes_Nombre[0], 0);
               pr_default.readNext(1);
            }
            pr_default.close(1);
            if ( dynavVacantes_nombre.ItemCount > 0 )
            {
               AV6Vacantes_Nombre = (short)(NumberUtil.Val( dynavVacantes_nombre.getValidValue(StringUtil.Trim( StringUtil.Str( (decimal)(AV6Vacantes_Nombre), 4, 0))), "."));
               AssignAttri("", false, dynavVacantes_nombre_Internalname, StringUtil.LTrimStr( (decimal)(AV6Vacantes_Nombre), 4, 0));
               GxWebStd.gx_hidden_field( context, "gxhash_vVACANTES_NOMBRE"+"_"+sGXsfl_15_idx, GetSecureSignedToken( sGXsfl_15_idx, context.localUtil.Format( (decimal)(AV6Vacantes_Nombre), "ZZZ9"), context));
            }
         }
         /* ComboBox */
         Grid1Row.AddColumnProperties("combobox", 2, isAjaxCallMode( ), new Object[] {(GXCombobox)dynavVacantes_nombre,(String)dynavVacantes_nombre_Internalname,StringUtil.Trim( StringUtil.Str( (decimal)(AV6Vacantes_Nombre), 4, 0)),(short)1,(String)dynavVacantes_nombre_Jsonclick,(short)0,(String)"'"+""+"'"+",false,"+"'"+""+"'",(String)"int",(String)"",(short)1,dynavVacantes_nombre.Enabled,(short)0,(short)0,(short)0,(String)"em",(short)0,(String)"",((dynavVacantes_nombre.FontBold==1) ? "font-weight:bold;" : "font-weight:normal;"),(String)"AttributeLittle",(String)"",(String)"",TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+((dynavVacantes_nombre.Enabled!=0)&&(dynavVacantes_nombre.Visible!=0) ? " onblur=\""+""+";gx.evt.onblur(this,27);\"" : " "),(String)"",(bool)true});
         dynavVacantes_nombre.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(AV6Vacantes_Nombre), 4, 0));
      ...
      protected void sendrow_15230( )
      {
         ...
         ROClassString = "AttributeLittle";
         Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtavEnviado_cliente_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8Enviado_Cliente), 4, 0, ",", "")),((edtavEnviado_cliente_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(AV8Enviado_Cliente), "ZZZ9")) : context.localUtil.Format( (decimal)(AV8Enviado_Cliente), "ZZZ9")),TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+((edtavEnviado_cliente_Enabled!=0)&&(edtavEnviado_cliente_Visible!=0) ? " onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,48);\"" : " "),(String)"'"+""+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtavEnviado_cliente_Jsonclick,(short)0,(String)"AttributeLittle",(String)((edtavEnviado_cliente_Fontitalic==1) ? "font-style:italic;" : "font-style:normal;"),(String)ROClassString,(String)"",(String)"",(short)1,(int)edtavEnviado_cliente_Enabled,(short)0,(String)"number",(String)"1",(short)4,(String)"chr",(short)1,(String)"row",(short)4,(short)0,(short)0,(short)15,(short)1,(short)-1,(short)0,(bool)true,(String)"",(String)"right",(bool)false,(String)""});
         Grid1Row.AddColumnProperties("div_end", -1, isAjaxCallMode( ), new Object[] {(String)"left",(String)"top",(String)"div"});
         Grid1Row.AddColumnProperties("div_end", -1, isAjaxCallMode( ), new Object[] {(String)"left",(String)"top",(String)"div"});
         if ( Grid1Container.GetWrapped() == 1 )
         {
         ...
         ROClassString = "AttributeLittle";
         Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtavDescartados_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(AV9Descartados), 4, 0, ",", "")),((edtavDescartados_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(AV9Descartados), "ZZZ9")) : context.localUtil.Format( (decimal)(AV9Descartados), "ZZZ9")),TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+((edtavDescartados_Enabled!=0)&&(edtavDescartados_Visible!=0) ? " onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,53);\"" : " "),(String)"'"+""+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtavDescartados_Jsonclick,(short)0,(String)"AttributeLittle",(String)((edtavDescartados_Fontitalic==1) ? "font-style:italic;" : "font-style:normal;"),(String)ROClassString,(String)"",(String)"",(short)1,(int)edtavDescartados_Enabled,(short)0,(String)"number",(String)"1",(short)4,(String)"chr",(short)1,(String)"row",(short)4,(short)0,(short)0,(short)15,(short)1,(short)-1,(short)0,(bool)true,(String)"",(String)"right",(bool)false,(String)""});
         Grid1Row.AddColumnProperties("div_end", -1, isAjaxCallMode( ), new Object[] {(String)"left",(String)"top",(String)"div"});
         Grid1Row.AddColumnProperties("div_end", -1, isAjaxCallMode( ), new Object[] {(String)"left",(String)"top",(String)"div"});
         if ( Grid1Container.GetWrapped() == 1 )
         {
      ...
      protected void init_web_controls( )
      {
         ...
         {
            dynavVacantes_nombre.addItem(StringUtil.Trim( StringUtil.Str( (decimal)(H00324_A263Vacantes_Id[0]), 4, 0)), H00324_A264Vacantes_Nombre[0], 0);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'A263Vacantes_Id',fld:'VACANTES_ID',pic:'ZZZZZZZZ9'},{av:'A284SUBT_ReclutadorId',fld:'SUBT_RECLUTADORID',pic:'ZZZZZ9'},{av:'A290VacantesUsuariosEstatus',fld:'VACANTESUSUARIOSESTATUS',pic:'ZZZ9'},{av:'A277Vacantes_Plazas',fld:'VACANTES_PLAZAS',pic:'ZZZ9'},{av:'AV17UsuarioId',fld:'vUSUARIOID',pic:'ZZZZZZZZ9',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID1.LOAD","{handler:'E12322',iparms:[{av:'A263Vacantes_Id',fld:'VACANTES_ID',pic:'ZZZZZZZZ9'},{av:'A284SUBT_ReclutadorId',fld:'SUBT_RECLUTADORID',pic:'ZZZZZ9'},{av:'AV17UsuarioId',fld:'vUSUARIOID',pic:'ZZZZZZZZ9',hsh:true},{av:'A290VacantesUsuariosEstatus',fld:'VACANTESUSUARIOSESTATUS',pic:'ZZZ9'},{av:'A277Vacantes_Plazas',fld:'VACANTES_PLAZAS',pic:'ZZZ9'}]");
         setEventMetadata("GRID1.LOAD",",oparms:[{av:'lblTextblock1_Fontbold',ctrl:'TEXTBLOCK1',prop:'Fontbold'},{av:'lblTextblock1_Forecolor',ctrl:'TEXTBLOCK1',prop:'Forecolor'},{av:'lblTextblock1_Fontsize',ctrl:'TEXTBLOCK1',prop:'Fontsize'},{av:'lblTextblock5_Visible',ctrl:'TEXTBLOCK5',prop:'Visible'},{av:'edtavProceso_completo_Fontitalic',ctrl:'vPROCESO_COMPLETO',prop:'Fontitalic'},{av:'edtavEnviado_cliente_Fontitalic',ctrl:'vENVIADO_CLIENTE',prop:'Fontitalic'},{av:'edtavDescartados_Fontitalic',ctrl:'vDESCARTADOS',prop:'Fontitalic'},{av:'edtavVacantes_id_Visible',ctrl:'vVACANTES_ID',prop:'Visible'},{av:'AV12Vacantes_Id',fld:'vVACANTES_ID',pic:'ZZZZZZZZ9'},{av:'AV7Proceso_Completo',fld:'vPROCESO_COMPLETO',pic:'ZZZ9'},{av:'AV9Descartados',fld:'vDESCARTADOS',pic:'ZZZ9'},{av:'AV8Enviado_Cliente',fld:'vENVIADO_CLIENTE',pic:'ZZZ9'},{av:'dynavVacantes_nombre'},{av:'AV6Vacantes_Nombre',fld:'vVACANTES_NOMBRE',pic:'ZZZ9',hsh:true},{av:'lblTextblock1_Caption',ctrl:'TEXTBLOCK1',prop:'Caption'}]}");
         setEventMetadata("'REVISAR'","{handler:'E13322',iparms:[{av:'dynavVacantes_nombre'},{av:'AV6Vacantes_Nombre',fld:'vVACANTES_NOMBRE',pic:'ZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H00322_A11UsuariosId = new int[1] ;
         H00322_A284SUBT_ReclutadorId = new int[1] ;
         H00322_A263Vacantes_Id = new int[1] ;
         H00322_A290VacantesUsuariosEstatus = new short[1] ;
         H00322_n290VacantesUsuariosEstatus = new bool[] {false} ;
         H00322_A277Vacantes_Plazas = new short[1] ;
         AV11NumPlazas = "";
         ...
         TempTags = "";
         GXCCtl = "";
         H00323_A263Vacantes_Id = new int[1] ;
         H00323_A264Vacantes_Nombre = new String[] {""} ;
         ROClassString = "";
         ...
         H00324_A263Vacantes_Id = new int[1] ;
         H00324_A264Vacantes_Nombre = new String[] {""} ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wpreclutamiento__default(),
            new Object[][] {
                new Object[] {
               H00322_A11UsuariosId, H00322_A284SUBT_ReclutadorId, H00322_A263Vacantes_Id, H00322_A290VacantesUsuariosEstatus, H00322_n290VacantesUsuariosEstatus, H00322_A277Vacantes_Plazas
               }
               , new Object[] {
               H00323_A263Vacantes_Id, H00323_A264Vacantes_Nombre
               }
               , new Object[] {
               H00324_A263Vacantes_Id, H00324_A264Vacantes_Nombre
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private short AV6Vacantes_Nombre ;
      private short AV7Proceso_Completo ;
      private short edtavProceso_completo_Fontitalic ;
      private short AV8Enviado_Cliente ;
      private short edtavEnviado_cliente_Fontitalic ;
      private short AV9Descartados ;
      ...
      private short AV14ConteoProcComp ;
      private short AV15ConteoEnvClie ;
      private short AV16ContDescar ;
      ...
      private int AV17UsuarioId ;
      private int lblTextblock5_Visible ;
      private int AV12Vacantes_Id ;
      ...
      private int[] H00322_A11UsuariosId ;
      private int[] H00322_A284SUBT_ReclutadorId ;
      private int[] H00322_A263Vacantes_Id ;
      private short[] H00322_A290VacantesUsuariosEstatus ;
      private bool[] H00322_n290VacantesUsuariosEstatus ;
      private short[] H00322_A277Vacantes_Plazas ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private int[] H00323_A263Vacantes_Id ;
      private String[] H00323_A264Vacantes_Nombre ;
      private int[] H00324_A263Vacantes_Id ;
      private String[] H00324_A264Vacantes_Nombre ;
      private GXWebForm Form ;
   }

   public class wpreclutamiento__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"AV17UsuarioId",System.Data.DbType.Int32,9,0}
          } ;
          Object[] prmH00323 ;
          ...
          def= new CursorDef[] {
              new CursorDef("H00322", "SELECT T1.`UsuariosId`, T1.`SUBT_ReclutadorId`, T1.`Vacantes_Id`, T1.`VacantesUsuariosEstatus`, T2.`Vacantes_Plazas` FROM (`VacantesUsuariosVacante` T1 INNER JOIN `Vacantes` T2 ON T2.`Vacantes_Id` = T1.`Vacantes_Id`) WHERE (T1.`SUBT_ReclutadorId` = ?) AND (T1.`Vacantes_Id` <> 17) ORDER BY T1.`Vacantes_Id`, T1.`SUBT_ReclutadorId` ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00322,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H00323", "SELECT `Vacantes_Id`, `Vacantes_Nombre` FROM `Vacantes` ORDER BY `Vacantes_Nombre` ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00323,0, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H00324", "SELECT `Vacantes_Id`, `Vacantes_Nombre` FROM `Vacantes` ORDER BY `Vacantes_Nombre` ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00324,0, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
