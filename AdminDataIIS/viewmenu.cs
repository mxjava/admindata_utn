...
namespace GeneXus.Programs {
   public class viewmenu : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202262714345066", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void WB220( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblRol_title_Internalname, "Rol", "", "", lblRol_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_ViewMenu.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
      ...
      protected void RF222( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A1MenuXid = H00222_A1MenuXid[0];
               A2MenuXDesc = H00222_A2MenuXDesc[0];
               n2MenuXDesc = H00222_n2MenuXDesc[0];
      ...
      protected void E11222( )
      {
         ...
         {
            A1MenuXid = H00223_A1MenuXid[0];
            A2MenuXDesc = H00223_A2MenuXDesc[0];
            n2MenuXDesc = H00223_n2MenuXDesc[0];
            AssignAttri("", false, "A2MenuXDesc", A2MenuXDesc);
            AV16GXLvl6 = 1;
      ...
      protected void S112( )
      {
         ...
         {
            /* Object Property */
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Rolwc_Component), StringUtil.Lower( "MenuRolWC")) != 0 )
            {
               WebComp_Rolwc = getWebComponent(GetType(), "GeneXus.Programs", "menurolwc", new Object[] {context} );
               WebComp_Rolwc.ComponentInit();
               WebComp_Rolwc.Name = "MenuRolWC";
               WebComp_Rolwc_Component = "MenuRolWC";
            }
            if ( StringUtil.Len( WebComp_Rolwc_Component) != 0 )
            {
               WebComp_Rolwc.setjustcreated();
               WebComp_Rolwc.componentprepare(new Object[] {(String)"W0038",(String)"",(short)AV12MenuXid});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202262714345082", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewmenu.js", "?202262714345082", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      public override void initialize( )
      {
         ...
         AV15Pgmname = "";
         scmdbuf = "";
         H00222_A1MenuXid = new short[1] ;
         H00222_A2MenuXDesc = new String[] {""} ;
         H00222_n2MenuXDesc = new bool[] {false} ;
         hsh = "";
         H00223_A1MenuXid = new short[1] ;
         H00223_A2MenuXDesc = new String[] {""} ;
         H00223_n2MenuXDesc = new bool[] {false} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewmenu__default(),
            new Object[][] {
                new Object[] {
               H00222_A1MenuXid, H00222_A2MenuXDesc, H00222_n2MenuXDesc
               }
               , new Object[] {
               H00223_A1MenuXid, H00223_A2MenuXDesc, H00223_n2MenuXDesc
               }
            }
         );
      ...
      private short[] H00222_A1MenuXid ;
      private String[] H00222_A2MenuXDesc ;
      private bool[] H00222_n2MenuXDesc ;
      private short[] H00223_A1MenuXid ;
      private String[] H00223_A2MenuXDesc ;
      private bool[] H00223_n2MenuXDesc ;
   ...
   public class viewmenu__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"AV12MenuXid",System.Data.DbType.Int16,4,0}
          } ;
          Object[] prmH00223 ;
          ...
          def= new CursorDef[] {
              new CursorDef("H00222", "SELECT `MenuXid`, `MenuXDesc` FROM `Menu` WHERE `MenuXid` = ? ORDER BY `MenuXid` ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00222,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H00223", "SELECT `MenuXid`, `MenuXDesc` FROM `Menu` WHERE `MenuXid` = ? ORDER BY `MenuXid` ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00223,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
