...
namespace GeneXus.Programs {
   public class rolesrolwc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public rolesrolwc( )
      {
      ...
      public rolesrolwc( IGxContext context )
      {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Roles Rol WC") ;
         ...
         context.AddJavascriptSource("gxcfg.js", "?202262714342785", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("rolesrolwc.aspx") + "?" + UrlEncode("" +AV6RolId)+"\">") ;
      ...
      protected void RenderHtmlCloseForm2H2( )
      {
         ...
         {
            context.AddJavascriptSource("rolesrolwc.js", "?202262714342787", false, true);
         }
      ...
      protected void WB2H0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "rolesrolwc.aspx");
            }
            /* Div Control */
            ...
            ClassString = "BtnAdd";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(20), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_RolesRolWC.htm");
      ...
      protected void START2H2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Roles Rol WC", 0) ;
            }
            context.wjLoc = "";
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              n259MenIcono = false;
                              AssignProp(sPrefix, false, edtMenIcono_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A259MenIcono)) ? A40000MenIcono_GXI : context.convertURL( context.PathToRelativeUrl( A259MenIcono))), !bGXsfl_20_Refreshing);
                              AssignProp(sPrefix, false, edtMenIcono_Internalname, "SrcSet", context.GetImageSrcSet( A259MenIcono), true);
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_MENUXID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A1MenuXid), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"MENUXID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A1MenuXid), 4, 0, ".", "")));
      }
      ...
      protected void RF2H2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A24RolId = H002H2_A24RolId[0];
               AssignAttri(sPrefix, false, "A24RolId", StringUtil.LTrimStr( (decimal)(A24RolId), 9, 0));
               A262Descripcion = H002H2_A262Descripcion[0];
               A258MenPadre = H002H2_A258MenPadre[0];
               n258MenPadre = H002H2_n258MenPadre[0];
               A40000MenIcono_GXI = H002H2_A40000MenIcono_GXI[0];
               n40000MenIcono_GXI = H002H2_n40000MenIcono_GXI[0];
               AssignProp(sPrefix, false, edtMenIcono_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A259MenIcono)) ? A40000MenIcono_GXI : context.convertURL( context.PathToRelativeUrl( A259MenIcono))), !bGXsfl_20_Refreshing);
               AssignProp(sPrefix, false, edtMenIcono_Internalname, "SrcSet", context.GetImageSrcSet( A259MenIcono), true);
               A5MenXEst = H002H2_A5MenXEst[0];
               n5MenXEst = H002H2_n5MenXEst[0];
               A4MenXUrl = H002H2_A4MenXUrl[0];
               n4MenXUrl = H002H2_n4MenXUrl[0];
               A3MenuXPosi = H002H2_A3MenuXPosi[0];
               n3MenuXPosi = H002H2_n3MenuXPosi[0];
               A2MenuXDesc = H002H2_A2MenuXDesc[0];
               n2MenuXDesc = H002H2_n2MenuXDesc[0];
               A1MenuXid = H002H2_A1MenuXid[0];
               A259MenIcono = H002H2_A259MenIcono[0];
               n259MenIcono = H002H2_n259MenIcono[0];
               AssignProp(sPrefix, false, edtMenIcono_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A259MenIcono)) ? A40000MenIcono_GXI : context.convertURL( context.PathToRelativeUrl( A259MenIcono))), !bGXsfl_20_Refreshing);
               AssignProp(sPrefix, false, edtMenIcono_Internalname, "SrcSet", context.GetImageSrcSet( A259MenIcono), true);
               A262Descripcion = H002H2_A262Descripcion[0];
               A258MenPadre = H002H2_A258MenPadre[0];
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_MENUXID"+"_"+sGXsfl_20_idx, GetSecureSignedToken( sPrefix+sGXsfl_20_idx, context.localUtil.Format( (decimal)(A1MenuXid), "ZZZ9"), context));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "rolesrolwc", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202262714342826", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("rolesrolwc.js", "?202262714342826", false, true);
         }
      ...
      {
         edtMenuXid_Internalname = sPrefix+"MENUXID_"+sGXsfl_20_idx;
         edtMenuXDesc_Internalname = sPrefix+"MENUXDESC_"+sGXsfl_20_idx;
         edtMenuXPosi_Internalname = sPrefix+"MENUXPOSI_"+sGXsfl_20_idx;
         edtMenXUrl_Internalname = sPrefix+"MENXURL_"+sGXsfl_20_idx;
         cmbMenXEst_Internalname = sPrefix+"MENXEST_"+sGXsfl_20_idx;
         edtMenIcono_Internalname = sPrefix+"MENICONO_"+sGXsfl_20_idx;
         edtMenPadre_Internalname = sPrefix+"MENPADRE_"+sGXsfl_20_idx;
         edtDescripcion_Internalname = sPrefix+"DESCRIPCION_"+sGXsfl_20_idx;
      ...
      {
         edtMenuXid_Internalname = sPrefix+"MENUXID_"+sGXsfl_20_fel_idx;
         edtMenuXDesc_Internalname = sPrefix+"MENUXDESC_"+sGXsfl_20_fel_idx;
         edtMenuXPosi_Internalname = sPrefix+"MENUXPOSI_"+sGXsfl_20_fel_idx;
         edtMenXUrl_Internalname = sPrefix+"MENXURL_"+sGXsfl_20_fel_idx;
         cmbMenXEst_Internalname = sPrefix+"MENXEST_"+sGXsfl_20_fel_idx;
         edtMenIcono_Internalname = sPrefix+"MENICONO_"+sGXsfl_20_fel_idx;
         edtMenPadre_Internalname = sPrefix+"MENPADRE_"+sGXsfl_20_fel_idx;
         edtDescripcion_Internalname = sPrefix+"DESCRIPCION_"+sGXsfl_20_fel_idx;
      ...
      protected void sendrow_202( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_20_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtMenXUrl_Internalname,(String)A4MenXUrl,(String)"",(String)"",(String)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(String)A4MenXUrl,(String)"_blank",(String)"",(String)"",(String)edtMenXUrl_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn WWOptionalColumn",(String)"",(short)-1,(short)0,(short)0,(String)"url",(String)"",(short)490,(String)"px",(short)17,(String)"px",(short)1000,(short)0,(short)0,(short)20,(short)1,(short)-1,(short)0,(bool)true,(String)"GeneXus\\Url",(String)"left",(bool)true,(String)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
            }
            GXCCtl = "MENXEST_" + sGXsfl_20_idx;
            ...
            AssignProp(sPrefix, false, cmbMenXEst_Internalname, "Values", (String)(cmbMenXEst.ToJavascriptSource()), !bGXsfl_20_Refreshing);
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtDescripcion_Internalname,(String)A262Descripcion,(String)"",(String)"",(String)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtDescripcion_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn WWOptionalColumn",(String)"",(short)-1,(short)0,(short)0,(String)"text",(String)"",(short)0,(String)"px",(short)17,(String)"px",(short)120,(short)0,(short)0,(short)20,(short)1,(short)-1,(short)-1,(bool)true,(String)"",(String)"left",(bool)true,(String)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
      ...
      protected void init_default_properties( )
      {
         ...
         edtMenIcono_Internalname = sPrefix+"MENICONO";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E132H2',iparms:[{av:'A1MenuXid',fld:'MENUXID',pic:'ZZZ9',hsh:true}]");
         ...
         setEventMetadata("'DOINSERT'","{handler:'E112H2',iparms:[{av:'A1MenuXid',fld:'MENUXID',pic:'ZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         A40000MenIcono_GXI = "";
         scmdbuf = "";
         H002H2_A24RolId = new int[1] ;
         H002H2_A262Descripcion = new String[] {""} ;
         H002H2_A258MenPadre = new short[1] ;
         H002H2_n258MenPadre = new bool[] {false} ;
         H002H2_A40000MenIcono_GXI = new String[] {""} ;
         H002H2_n40000MenIcono_GXI = new bool[] {false} ;
         H002H2_A5MenXEst = new String[] {""} ;
         H002H2_n5MenXEst = new bool[] {false} ;
         H002H2_A4MenXUrl = new String[] {""} ;
         H002H2_n4MenXUrl = new bool[] {false} ;
         H002H2_A3MenuXPosi = new short[1] ;
         H002H2_n3MenuXPosi = new bool[] {false} ;
         H002H2_A2MenuXDesc = new String[] {""} ;
         H002H2_n2MenuXDesc = new bool[] {false} ;
         H002H2_A1MenuXid = new short[1] ;
         H002H2_A259MenIcono = new String[] {""} ;
         H002H2_n259MenIcono = new bool[] {false} ;
         ...
         GXCCtl = "";
         sImgUrl = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.rolesrolwc__default(),
            new Object[][] {
                new Object[] {
               H002H2_A24RolId, H002H2_A262Descripcion, H002H2_A258MenPadre, H002H2_n258MenPadre, H002H2_A40000MenIcono_GXI, H002H2_n40000MenIcono_GXI, H002H2_A5MenXEst, H002H2_n5MenXEst, H002H2_A4MenXUrl, H002H2_n4MenXUrl,
               H002H2_A3MenuXPosi, H002H2_n3MenuXPosi, H002H2_A2MenuXDesc, H002H2_n2MenuXDesc, H002H2_A1MenuXid, H002H2_A259MenIcono, H002H2_n259MenIcono
               }
               , new Object[] {
      ...
      private int[] H002H2_A24RolId ;
      private String[] H002H2_A262Descripcion ;
      private short[] H002H2_A258MenPadre ;
      private bool[] H002H2_n258MenPadre ;
      private String[] H002H2_A40000MenIcono_GXI ;
      private bool[] H002H2_n40000MenIcono_GXI ;
      private String[] H002H2_A5MenXEst ;
      private bool[] H002H2_n5MenXEst ;
      private String[] H002H2_A4MenXUrl ;
      private bool[] H002H2_n4MenXUrl ;
      private short[] H002H2_A3MenuXPosi ;
      private bool[] H002H2_n3MenuXPosi ;
      private String[] H002H2_A2MenuXDesc ;
      private bool[] H002H2_n2MenuXDesc ;
      private short[] H002H2_A1MenuXid ;
      private String[] H002H2_A259MenIcono ;
      private bool[] H002H2_n259MenIcono ;
   ...
   public class rolesrolwc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H002H2", "SELECT T1.`RolId`, T2.`Descripcion`, T2.`MenPadre`, T2.`MenIcono_GXI`, T2.`MenXEst`, T2.`MenXUrl`, T2.`MenuXPosi`, T2.`MenuXDesc`, T1.`MenuXid`, T2.`MenIcono` FROM (`MenuRol` T1 INNER JOIN `Menu` T2 ON T2.`MenuXid` = T1.`MenuXid`) WHERE T1.`RolId` = ? ORDER BY T1.`RolId`  LIMIT ?, ?",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002H2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H002H3", "SELECT COUNT(*) FROM (`MenuRol` T1 INNER JOIN `Menu` T2 ON T2.`MenuXid` = T1.`MenuXid`) WHERE T1.`RolId` = ? ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002H3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
                            ...
                            Object[] buf )
    {
       switch ( cursor )
       {
             case 0 :
                ...
                ((String[]) buf[15])[0] = rslt.getMultimediaFile(10, rslt.getVarchar(4)) ;
