...
namespace GeneXus.Programs {
   public class login : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202262714344525", false, true);
      ...
      protected void WB0E0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            context.WriteHtmlText( "<div class=\"gx_usercontrol_child\" id=\""+"CLICKLOGINUC1Container"+"addusuarioin2"+"\" style=\"display:none;\">") ;
            /* Div Control */
            GxWebStd.gx_div_start( context, divAddusuarioin2_Internalname, 1, 0, "px", 0, "px", "Table", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavVusuario_Internalname, AV11vUsuario, StringUtil.RTrim( context.localUtil.Format( AV11vUsuario, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,12);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Email", edtavVusuario_Jsonclick, 0, "input100", "", "", "", "", 1, edtavVusuario_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, false, "", "left", true, "", "HLP_Login.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</div>") ;
            context.WriteHtmlText( "<div class=\"gx_usercontrol_child\" id=\""+"CLICKLOGINUC1Container"+"addpasswordin2"+"\" style=\"display:none;\">") ;
            /* Div Control */
            GxWebStd.gx_div_start( context, divAddpasswordin2_Internalname, 1, 0, "px", 0, "px", "Table", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavVpassword_Internalname, AV9vPassword, StringUtil.RTrim( context.localUtil.Format( AV9vPassword, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,18);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Contraseña", edtavVpassword_Jsonclick, 0, "input100", "", "", "", "", 1, edtavVpassword_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, -1, 0, 0, 1, 0, -1, false, "", "left", true, "", "HLP_Login.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202262714344534", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("login.js", "?202262714344534", false, true);
            context.AddJavascriptSource("UserControls/ClickLoginUCRender.js", "", false, true);
         }
      ...
      protected void init_default_properties( )
      {
         ...
         divAddusuarioin2_Internalname = "ADDUSUARIOIN2";
         edtavVpassword_Internalname = "vVPASSWORD";
         divAddpasswordin2_Internalname = "ADDPASSWORDIN2";
      ...
      private String divAddusuarioin2_Internalname ;
      private String edtavVusuario_Internalname ;
      private String TempTags ;
      private String edtavVusuario_Jsonclick ;
      private String divAddpasswordin2_Internalname ;
