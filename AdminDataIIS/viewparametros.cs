...
namespace GeneXus.Programs {
   public class viewparametros : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public viewparametros( IGxContext context )
      {
      ...
      public void execute( int aP0_ParametroId ,
                           String aP1_TabCode )
      {
         this.AV12ParametroId = aP0_ParametroId;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12ParametroId = (int)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV12ParametroId", StringUtil.LTrimStr( (decimal)(AV12ParametroId), 9, 0));
               GxWebStd.gx_hidden_field( context, "gxhash_vPARAMETROID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12ParametroId), "ZZZZZZZZ9"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202262714344817", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("viewparametros.aspx") + "?" + UrlEncode("" +AV12ParametroId) + "," + UrlEncode(StringUtil.RTrim(AV6TabCode))+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("hshsalt", "hsh"+"ViewParametros");
         forbiddenHiddens.Add("ParametroHoraIni", StringUtil.RTrim( context.localUtil.Format( A133ParametroHoraIni, "")));
         GxWebStd.gx_hidden_field( context, "hsh", GetEncryptedHash( forbiddenHiddens.ToString(), GXKey));
         GXUtil.WriteLogInfo("viewparametros:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vPARAMETROID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12ParametroId), 9, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vPARAMETROID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12ParametroId), "ZZZZZZZZ9"), context));
      ...
      {
         return formatLink("viewparametros.aspx") + "?" + UrlEncode("" +AV12ParametroId) + "," + UrlEncode(StringUtil.RTrim(AV6TabCode)) ;
      }

      public override String GetPgmname( )
      {
         return "ViewParametros" ;
      }
      ...
      protected void WB180( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewtitle_Internalname, "Parametros Information", "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, "HLP_ViewParametros.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 ViewActionsBackCell", "Right", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Parametross", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "BtnTextBlockBack", 0, "", lblViewall_Visible, 1, 0, "HLP_ViewParametros.htm");
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtParametroHoraIni_Internalname, StringUtil.RTrim( A133ParametroHoraIni), StringUtil.RTrim( context.localUtil.Format( A133ParametroHoraIni, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtParametroHoraIni_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtParametroHoraIni_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_ViewParametros.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_ViewParametros.htm");
            /* Div Control */
      ...
      protected void START182( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "View Parametros", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void RF182( )
      {
         ...
         {
            /* Using cursor H00182 */
            pr_default.execute(0, new Object[] {AV12ParametroId});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A29ParametroId = H00182_A29ParametroId[0];
               A133ParametroHoraIni = H00182_A133ParametroHoraIni[0];
      ...
      protected void STRUP180( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV12ParametroId = (int)(context.localUtil.CToN( cgiGet( "vPARAMETROID"), ",", "."));
            ...
            {
               GXUtil.WriteLogError("viewparametros:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
               GxWebError = 1;
      ...
      protected void E11182( )
      {
         ...
         AV16GXLvl6 = 0;
         /* Using cursor H00183 */
         pr_default.execute(1, new Object[] {AV12ParametroId});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A29ParametroId = H00183_A29ParametroId[0];
            A133ParametroHoraIni = H00183_A133ParametroHoraIni[0];
            AssignAttri("", false, "A133ParametroHoraIni", A133ParametroHoraIni);
            AV16GXLvl6 = 1;
            Form.Caption = A133ParametroHoraIni;
            AssignProp("", false, "FORM", "Caption", Form.Caption, true);
            lblViewall_Link = formatLink("wwparametros.aspx") ;
      ...
      protected void S112( )
      {
         ...
         {
            /* Object Property */
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "ParametrosGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "parametrosgeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "ParametrosGeneral";
               WebComp_Generalwc_Component = "ParametrosGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(String)"W0030",(String)"",(int)AV12ParametroId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV12ParametroId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV12ParametroId", StringUtil.LTrimStr( (decimal)(AV12ParametroId), 9, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vPARAMETROID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12ParametroId), "ZZZZZZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202262714344831", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewparametros.js", "?202262714344831", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12ParametroId',fld:'vPARAMETROID',pic:'ZZZZZZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A133ParametroHoraIni',fld:'PARAMETROHORAINI',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         AV15Pgmname = "";
         scmdbuf = "";
         H00182_A29ParametroId = new int[1] ;
         H00182_A133ParametroHoraIni = new String[] {""} ;
         hsh = "";
         H00183_A29ParametroId = new int[1] ;
         H00183_A133ParametroHoraIni = new String[] {""} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewparametros__default(),
            new Object[][] {
                new Object[] {
               H00182_A29ParametroId, H00182_A133ParametroHoraIni
               }
               , new Object[] {
               H00183_A29ParametroId, H00183_A133ParametroHoraIni
               }
            }
         );
      ...
      private int AV12ParametroId ;
      private int wcpOAV12ParametroId ;
      ...
      private int[] H00182_A29ParametroId ;
      private String[] H00182_A133ParametroHoraIni ;
      private int[] H00183_A29ParametroId ;
      private String[] H00183_A133ParametroHoraIni ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private GXWebForm Form ;
   }

   public class viewparametros__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"AV12ParametroId",System.Data.DbType.Int32,9,0}
          } ;
          Object[] prmH00183 ;
          ...
          def= new CursorDef[] {
              new CursorDef("H00182", "SELECT `ParametroId`, `ParametroHoraIni` FROM `Parametros` WHERE `ParametroId` = ? ORDER BY `ParametroId` ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00182,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H00183", "SELECT `ParametroId`, `ParametroHoraIni` FROM `Parametros` WHERE `ParametroId` = ? ORDER BY `ParametroId` ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00183,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
