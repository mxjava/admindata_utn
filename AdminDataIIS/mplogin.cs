...
namespace GeneXus.Programs {
   public class mplogin : GXMasterPage, System.Web.SessionState.IRequiresSessionState
   {
      public mplogin( )
      {
      ...
      public mplogin( IGxContext context )
      {
      ...
      protected void RenderHtmlCloseForm0K2( )
      {
         ...
         context.AddJavascriptSource("mplogin.js", "?202262714344749", false, true);
      ...
      {
         /* Start Routine */
         (getDataAreaObject() == null ? Form : getDataAreaObject().GetForm()).Headerrawhtml = "<link href=\""+context.convertURL( (String)(context.GetImagePath( "6c4e657c-6882-474f-9ba4-cffe7e37d7b8", "", context.GetTheme( ))))+"\" rel=\"shortcut icon\">";
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)(getDataAreaObject() == null ? Form : getDataAreaObject().GetForm()).Jscriptsrc.Item(idxLst))), "?202262714344752", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("mplogin.js", "?202262714344752", false, true);
         }
