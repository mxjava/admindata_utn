...
namespace GeneXus.Programs {
   public class vacantesusuariosvacantewc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public vacantesusuariosvacantewc( )
      {
      ...
      public vacantesusuariosvacantewc( IGxContext context )
      {
      ...
      {
         this.AV6Vacantes_Id = aP0_Vacantes_Id;
         executePrivate();
      }
         ...
         if ( StringUtil.Len( (String)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  setjustcreated();
                  componentprepare(new Object[] {(String)sCompPrefix,(String)sSFPrefix,(int)AV6Vacantes_Id});
                  componentstart();
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
               {
                  ...
                  gxgrGrid_refresh( subGrid_Rows, AV6Vacantes_Id, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV14Pgmname = "VacantesUsuariosVacanteWC";
               context.Gx_err = 0;
               WS282( ) ;
               if ( ! isAjaxCallMode( ) )
               {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Vacantes Usuarios Vacante WC") ;
         ...
         context.AddJavascriptSource("gxcfg.js", "?202262714341614", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("vacantesusuariosvacantewc.aspx") + "?" + UrlEncode("" +AV6Vacantes_Id)+"\">") ;
      ...
      protected void RenderHtmlCloseForm282( )
      {
         ...
         {
            context.AddJavascriptSource("vacantesusuariosvacantewc.js", "?202262714341616", false, true);
         }
      ...
      {
         return "VacantesUsuariosVacanteWC" ;
      }

      public override String GetPgmdesc( )
      {
         return "Vacantes Usuarios Vacante WC" ;
      }
      ...
      protected void WB280( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "vacantesusuariosvacantewc.aspx");
            }
            /* Div Control */
            ...
            else
            {
               ...
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A273UsuariosVacanteEstatus), 1, 0, ".", "")));
               GridContainer.AddColumnProperties(GridColumn);
         ...
         if ( wbEnd == 12 )
         {
            ...
            GxWebStd.gx_label_element( context, edtVacantes_Id_Internalname, "ID", "col-sm-3 AttributeLabel", 0, true, "");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtVacantes_Id_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A263Vacantes_Id), 9, 0, ",", "")), ((edtVacantes_Id_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(A263Vacantes_Id), "ZZZZZZZZ9")) : context.localUtil.Format( (decimal)(A263Vacantes_Id), "ZZZZZZZZ9")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtVacantes_Id_Jsonclick, 0, "Attribute", "", "", "", "", edtVacantes_Id_Visible, edtVacantes_Id_Enabled, 0, "number", "1", 9, "chr", 1, "row", 9, 0, 0, 0, 1, -1, 0, true, "Id", "right", false, "", "HLP_VacantesUsuariosVacanteWC.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START282( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Vacantes Usuarios Vacante WC", 0) ;
            }
            context.wjLoc = "";
      ...
      protected void RF282( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H00282 */
            pr_default.execute(0, new Object[] {AV6Vacantes_Id, GXPagingFrom2, GXPagingTo2});
            nGXsfl_12_idx = 1;
            sGXsfl_12_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_12_idx), 4, 0), 4, "0");
            SubsflControlProps_122( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A263Vacantes_Id = H00282_A263Vacantes_Id[0];
               AssignAttri(sPrefix, false, "A263Vacantes_Id", StringUtil.LTrimStr( (decimal)(A263Vacantes_Id), 9, 0));
               A273UsuariosVacanteEstatus = H00282_A273UsuariosVacanteEstatus[0];
               A64UsuariosApMat = H00282_A64UsuariosApMat[0];
               A65UsuariosApPat = H00282_A65UsuariosApPat[0];
               A66UsuariosNombre = H00282_A66UsuariosNombre[0];
               A11UsuariosId = H00282_A11UsuariosId[0];
               A64UsuariosApMat = H00282_A64UsuariosApMat[0];
               A65UsuariosApPat = H00282_A65UsuariosApPat[0];
               A66UsuariosNombre = H00282_A66UsuariosNombre[0];
               E12282 ();
      ...
      {
         /* Using cursor H00283 */
         pr_default.execute(1, new Object[] {AV6Vacantes_Id});
      ...
      protected void E11282( )
      {
         ...
         AssignProp(sPrefix, false, edtVacantes_Id_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtVacantes_Id_Visible), 5, 0), true);
      ...
      protected void S112( )
      {
         ...
         AV10TrnContextAtt.gxTpr_Attributename = "Vacantes_Id";
         AV10TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV6Vacantes_Id), 9, 0);
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV6Vacantes_Id = Convert.ToInt32(getParm(obj,0));
         AssignAttri(sPrefix, false, "AV6Vacantes_Id", StringUtil.LTrimStr( (decimal)(AV6Vacantes_Id), 9, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV6Vacantes_Id = (String)((String)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "vacantesusuariosvacantewc", GetJustCreated( ));
         ...
         {
            AV6Vacantes_Id = Convert.ToInt32(getParm(obj,2));
            AssignAttri(sPrefix, false, "AV6Vacantes_Id", StringUtil.LTrimStr( (decimal)(AV6Vacantes_Id), 9, 0));
         }
         wcpOAV6Vacantes_Id = (int)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6Vacantes_Id"), ",", "."));
         if ( ! GetJustCreated( ) && ( ( AV6Vacantes_Id != wcpOAV6Vacantes_Id ) ) )
         {
            setjustcreated();
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202262714341643", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("vacantesusuariosvacantewc.js", "?202262714341643", false, true);
         }
      ...
      protected void SubsflControlProps_122( )
      {
         ...
         cmbUsuariosVacanteEstatus_Internalname = sPrefix+"USUARIOSVACANTEESTATUS_"+sGXsfl_12_idx;
      }
      ...
      protected void SubsflControlProps_fel_122( )
      {
         ...
         cmbUsuariosVacanteEstatus_Internalname = sPrefix+"USUARIOSVACANTEESTATUS_"+sGXsfl_12_fel_idx;
      }
      ...
      protected void sendrow_122( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_12_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            {
               GXCCtl = "USUARIOSVACANTEESTATUS_" + sGXsfl_12_idx;
      ...
      protected void init_default_properties( )
      {
         ...
         cmbUsuariosVacanteEstatus_Internalname = sPrefix+"USUARIOSVACANTEESTATUS";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6Vacantes_Id',fld:'vVACANTES_ID',pic:'ZZZZZZZZ9'},{av:'sPrefix'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E12282',iparms:[]");
         setEventMetadata("GRID.LOAD",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6Vacantes_Id',fld:'vVACANTES_ID',pic:'ZZZZZZZZ9'},{av:'sPrefix'}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6Vacantes_Id',fld:'vVACANTES_ID',pic:'ZZZZZZZZ9'},{av:'sPrefix'}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6Vacantes_Id',fld:'vVACANTES_ID',pic:'ZZZZZZZZ9'},{av:'sPrefix'}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6Vacantes_Id',fld:'vVACANTES_ID',pic:'ZZZZZZZZ9'},{av:'sPrefix'}]");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         scmdbuf = "";
         H00282_A263Vacantes_Id = new int[1] ;
         H00282_A273UsuariosVacanteEstatus = new short[1] ;
         H00282_A64UsuariosApMat = new String[] {""} ;
         H00282_A65UsuariosApPat = new String[] {""} ;
         H00282_A66UsuariosNombre = new String[] {""} ;
         H00282_A11UsuariosId = new int[1] ;
         ...
         ROClassString = "";
         GXCCtl = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.vacantesusuariosvacantewc__default(),
            new Object[][] {
                new Object[] {
               H00282_A263Vacantes_Id, H00282_A273UsuariosVacanteEstatus, H00282_A64UsuariosApMat, H00282_A65UsuariosApPat, H00282_A66UsuariosNombre, H00282_A11UsuariosId
               }
               , new Object[] {
      ...
      private int[] H00282_A263Vacantes_Id ;
      private short[] H00282_A273UsuariosVacanteEstatus ;
      private String[] H00282_A64UsuariosApMat ;
      private String[] H00282_A65UsuariosApPat ;
      private String[] H00282_A66UsuariosNombre ;
      private int[] H00282_A11UsuariosId ;
   ...
   public class vacantesusuariosvacantewc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00282", "SELECT T1.`Vacantes_Id`, T1.`UsuariosVacanteEstatus`, T2.`UsuariosApMat`, T2.`UsuariosApPat`, T2.`UsuariosNombre`, T1.`UsuariosId` FROM (`VacantesUsuariosVacante` T1 INNER JOIN `Usuarios` T2 ON T2.`UsuariosId` = T1.`UsuariosId`) WHERE T1.`Vacantes_Id` = ? ORDER BY T1.`Vacantes_Id`  LIMIT ?, ?",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00282,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H00283", "SELECT COUNT(*) FROM (`VacantesUsuariosVacante` T1 INNER JOIN `Usuarios` T2 ON T2.`UsuariosId` = T1.`UsuariosId`) WHERE T1.`Vacantes_Id` = ? ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00283,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
