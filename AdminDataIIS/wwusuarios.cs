...
namespace GeneXus.Programs {
   public class wwusuarios : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public wwusuarios( )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               nRC_GXsfl_26 = (int)(NumberUtil.Val( GetNextPar( ), "."));
               nGXsfl_26_idx = (int)(NumberUtil.Val( GetNextPar( ), "."));
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrGrid_refresh( subGrid_Rows, AV16UsuariosNombre, AV19Pgmname, AV13Update) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202262714344546", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vUSUARIOSNOMBRE", AV16UsuariosNombre);
         /* Send saved values. */
      ...
      {
         return formatLink("wwusuarios.aspx")  ;
      }
      ...
      {
         return "Work With Alta Usuarios" ;
      }
      ...
      protected void WB0F0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            ClassString = "BtnAdd";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(26), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWUsuarios.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_label_element( context, edtavUsuariosnombre_Internalname, "Usuarios Nombre", "col-sm-3 FilterSearchAttributeLabel", 0, true, "");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 16,'',false,'" + sGXsfl_26_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavUsuariosnombre_Internalname, AV16UsuariosNombre, StringUtil.RTrim( context.localUtil.Format( AV16UsuariosNombre, "@!")), TempTags+" onchange=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Nombre", edtavUsuariosnombre_Jsonclick, 0, "FilterSearchAttribute", "", "", "", "", 1, edtavUsuariosnombre_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_WWUsuarios.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            if ( GridContainer.GetWrapped() == 1 )
            {
               ...
               context.WriteHtmlTextNl( "</th>") ;
               context.WriteHtmlText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
               context.SendWebValue( "P. Apellido") ;
               context.WriteHtmlTextNl( "</th>") ;
               context.WriteHtmlText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
               context.SendWebValue( "S. Apellido") ;
               context.WriteHtmlTextNl( "</th>") ;
               context.WriteHtmlText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
               context.SendWebValue( "F. Nacimiento") ;
               context.WriteHtmlTextNl( "</th>") ;
               context.WriteHtmlText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            ...
            else
            {
               ...
               GridColumn.AddObjectProperty("Backcolor", StringUtil.LTrim( StringUtil.NToC( (decimal)(cmbUsuariosStatus.BackColor), 9, 0, ".", "")));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      protected void START0F2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Work With Alta Usuarios", 0) ;
         }
         context.wjLoc = "";
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    {
                                       Rfr0gs = false;
                                       /* Set Refresh If Usuariosnombre Changed */
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vUSUARIOSNOMBRE"), AV16UsuariosNombre) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      {
         /* GeneXus formulas. */
         AV19Pgmname = "WWUsuarios";
         context.Gx_err = 0;
         edtavUpdate_Enabled = 0;
         AssignProp("", false, edtavUpdate_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavUpdate_Enabled), 5, 0), !bGXsfl_26_Refreshing);
      }
      ...
      protected void RF0F2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV16UsuariosNombre = StringUtil.Concat( StringUtil.RTrim( AV16UsuariosNombre), "%", "");
            /* Using cursor H000F2 */
            pr_default.execute(0, new Object[] {lV16UsuariosNombre, GXPagingFrom2, GXPagingTo2});
            nGXsfl_26_idx = 1;
            sGXsfl_26_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_26_idx), 4, 0), 4, "0");
            SubsflControlProps_262( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A286UsuariosStatus = H000F2_A286UsuariosStatus[0];
               A272UsuariosTipo = H000F2_A272UsuariosTipo[0];
               A261UsuariosCorreo = H000F2_A261UsuariosCorreo[0];
               A260UsuariosTelef = H000F2_A260UsuariosTelef[0];
               A257UsuariosSexo = H000F2_A257UsuariosSexo[0];
               A256UsuariosEdad = H000F2_A256UsuariosEdad[0];
               A255UsuariosFecNacimiento = H000F2_A255UsuariosFecNacimiento[0];
               A64UsuariosApMat = H000F2_A64UsuariosApMat[0];
               A65UsuariosApPat = H000F2_A65UsuariosApPat[0];
               A66UsuariosNombre = H000F2_A66UsuariosNombre[0];
               A105UsuariosCurp = H000F2_A105UsuariosCurp[0];
               A11UsuariosId = H000F2_A11UsuariosId[0];
               E140F2 ();
      ...
      protected void send_integrity_lvl_hashes0F2( )
      {
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV19Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV19Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, "gxhash_USUARIOSID"+"_"+sGXsfl_26_idx, GetSecureSignedToken( sGXsfl_26_idx, context.localUtil.Format( (decimal)(A11UsuariosId), "ZZZZZ9"), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV16UsuariosNombre = StringUtil.Concat( StringUtil.RTrim( AV16UsuariosNombre), "%", "");
         /* Using cursor H000F3 */
         pr_default.execute(1, new Object[] {lV16UsuariosNombre});
      ...
      protected void STRUP0F0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV16UsuariosNombre = StringUtil.Upper( cgiGet( edtavUsuariosnombre_Internalname));
            AssignAttri("", false, "AV16UsuariosNombre", AV16UsuariosNombre);
      ...
      {
         /* Grid_Load Routine */
         if ( A286UsuariosStatus == 1 )
         {
            cmbUsuariosStatus.BackColor = GXUtil.RGB( 119, 221, 119);
         }
         else
         {
            cmbUsuariosStatus.BackColor = GXUtil.RGB( 255, 105, 97);
         }
         if ( String.IsNullOrEmpty(StringUtil.RTrim( context.GetCookie( "GX_SESSION_ID"))) )
         {
            gxcookieaux = context.SetCookie( "GX_SESSION_ID", Encrypt64( Crypto.GetEncryptionKey( ), Crypto.GetServerKey( )), "", (DateTime)(DateTime.MinValue), "", 0);
         ...
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "wpaltausuariosadm.aspx"+UrlEncode(StringUtil.RTrim("Modificar")) + "," + UrlEncode("" +A11UsuariosId);
         edtavUpdate_Link = formatLink("wpaltausuariosadm.aspx") + "?" + Encrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
         /* Load Method */
         if ( wbStart != -1 )
         {
            wbStart = 26;
      ...
      protected void E110F2( )
      {
         ...
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "wpaltausuariosadm.aspx"+UrlEncode(StringUtil.RTrim("Insertar")) + "," + UrlEncode("" +0);
      ...
      protected void S112( )
      {
         ...
         AV11TrnContext.gxTpr_Transactionname = "Usuarios";
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202262714344581", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwusuarios.js", "?202262714344581", false, true);
         }
      ...
      {
         edtUsuariosId_Internalname = "USUARIOSID_"+sGXsfl_26_idx;
         edtUsuariosCurp_Internalname = "USUARIOSCURP_"+sGXsfl_26_idx;
         edtUsuariosNombre_Internalname = "USUARIOSNOMBRE_"+sGXsfl_26_idx;
         edtUsuariosApPat_Internalname = "USUARIOSAPPAT_"+sGXsfl_26_idx;
         edtUsuariosApMat_Internalname = "USUARIOSAPMAT_"+sGXsfl_26_idx;
         edtUsuariosFecNacimiento_Internalname = "USUARIOSFECNACIMIENTO_"+sGXsfl_26_idx;
         edtUsuariosEdad_Internalname = "USUARIOSEDAD_"+sGXsfl_26_idx;
         edtUsuariosSexo_Internalname = "USUARIOSSEXO_"+sGXsfl_26_idx;
         edtUsuariosTelef_Internalname = "USUARIOSTELEF_"+sGXsfl_26_idx;
         edtUsuariosCorreo_Internalname = "USUARIOSCORREO_"+sGXsfl_26_idx;
         cmbUsuariosTipo_Internalname = "USUARIOSTIPO_"+sGXsfl_26_idx;
         cmbUsuariosStatus_Internalname = "USUARIOSSTATUS_"+sGXsfl_26_idx;
         edtavUpdate_Internalname = "vUPDATE_"+sGXsfl_26_idx;
      }

      protected void SubsflControlProps_fel_262( )
      {
         edtUsuariosId_Internalname = "USUARIOSID_"+sGXsfl_26_fel_idx;
         edtUsuariosCurp_Internalname = "USUARIOSCURP_"+sGXsfl_26_fel_idx;
         edtUsuariosNombre_Internalname = "USUARIOSNOMBRE_"+sGXsfl_26_fel_idx;
         edtUsuariosApPat_Internalname = "USUARIOSAPPAT_"+sGXsfl_26_fel_idx;
         edtUsuariosApMat_Internalname = "USUARIOSAPMAT_"+sGXsfl_26_fel_idx;
         edtUsuariosFecNacimiento_Internalname = "USUARIOSFECNACIMIENTO_"+sGXsfl_26_fel_idx;
         edtUsuariosEdad_Internalname = "USUARIOSEDAD_"+sGXsfl_26_fel_idx;
         edtUsuariosSexo_Internalname = "USUARIOSSEXO_"+sGXsfl_26_fel_idx;
         edtUsuariosTelef_Internalname = "USUARIOSTELEF_"+sGXsfl_26_fel_idx;
         edtUsuariosCorreo_Internalname = "USUARIOSCORREO_"+sGXsfl_26_fel_idx;
         cmbUsuariosTipo_Internalname = "USUARIOSTIPO_"+sGXsfl_26_fel_idx;
         cmbUsuariosStatus_Internalname = "USUARIOSSTATUS_"+sGXsfl_26_fel_idx;
      ...
      protected void sendrow_262( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_26_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtUsuariosCurp_Internalname,(String)A105UsuariosCurp,StringUtil.RTrim( context.localUtil.Format( A105UsuariosCurp, "@!")),(String)"",(String)"'"+""+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtUsuariosCurp_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn WWOptionalColumn",(String)"",(short)-1,(short)0,(short)0,(String)"text",(String)"",(short)0,(String)"px",(short)17,(String)"px",(short)18,(short)0,(short)0,(short)26,(short)1,(short)-1,(short)-1,(bool)true,(String)"",(String)"left",(bool)true,(String)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtUsuariosApPat_Internalname,(String)A65UsuariosApPat,StringUtil.RTrim( context.localUtil.Format( A65UsuariosApPat, "@!")),(String)"",(String)"'"+""+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"Primer Apellido",(String)"",(String)edtUsuariosApPat_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn",(String)"",(short)-1,(short)0,(short)0,(String)"text",(String)"",(short)0,(String)"px",(short)17,(String)"px",(short)40,(short)0,(short)0,(short)26,(short)1,(short)-1,(short)-1,(bool)true,(String)"",(String)"left",(bool)true,(String)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtUsuariosApMat_Internalname,(String)A64UsuariosApMat,StringUtil.RTrim( context.localUtil.Format( A64UsuariosApMat, "@!")),(String)"",(String)"'"+""+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"Segundo Apellido",(String)"",(String)edtUsuariosApMat_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn WWOptionalColumn",(String)"",(short)-1,(short)0,(short)0,(String)"text",(String)"",(short)0,(String)"px",(short)17,(String)"px",(short)40,(short)0,(short)0,(short)26,(short)1,(short)-1,(short)-1,(bool)true,(String)"",(String)"left",(bool)true,(String)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtUsuariosFecNacimiento_Internalname,context.localUtil.Format(A255UsuariosFecNacimiento, "99/99/99"),context.localUtil.Format( A255UsuariosFecNacimiento, "99/99/99"),(String)"",(String)"'"+""+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"Fecha de Nacimiento",(String)"",(String)edtUsuariosFecNacimiento_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn WWOptionalColumn",(String)"",(short)-1,(short)0,(short)0,(String)"text",(String)"",(short)0,(String)"px",(short)17,(String)"px",(short)8,(short)0,(short)0,(short)26,(short)1,(short)-1,(short)0,(bool)true,(String)"",(String)"right",(bool)false,(String)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtUsuariosSexo_Internalname,StringUtil.RTrim( A257UsuariosSexo),(String)"",(String)"",(String)"'"+""+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtUsuariosSexo_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn WWOptionalColumn",(String)"",(short)-1,(short)0,(short)0,(String)"text",(String)"",(short)0,(String)"px",(short)17,(String)"px",(short)1,(short)0,(short)0,(short)26,(short)1,(short)-1,(short)-1,(bool)true,(String)"Sexo",(String)"left",(bool)true,(String)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtUsuariosCorreo_Internalname,(String)A261UsuariosCorreo,(String)"",(String)"",(String)"'"+""+"'"+",false,"+"'"+""+"'",(String)"mailto:"+A261UsuariosCorreo,(String)"",(String)"Correo electrónico",(String)"",(String)edtUsuariosCorreo_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn WWOptionalColumn",(String)"",(short)-1,(short)0,(short)0,(String)"email",(String)"",(short)0,(String)"px",(short)17,(String)"px",(short)100,(short)0,(short)0,(short)26,(short)1,(short)-1,(short)0,(bool)true,(String)"GeneXus\\Email",(String)"left",(bool)true,(String)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
            ...
            {
               GXCCtl = "USUARIOSTIPO_" + sGXsfl_26_idx;
            ...
            AssignProp("", false, cmbUsuariosTipo_Internalname, "Values", (String)(cmbUsuariosTipo.ToJavascriptSource()), !bGXsfl_26_Refreshing);
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\""+" bgcolor="+context.BuildHTMLColor( cmbUsuariosStatus.BackColor)+">") ;
            }
            if ( ( cmbUsuariosStatus.ItemCount == 0 ) && isAjaxCallMode( ) )
            {
               GXCCtl = "USUARIOSSTATUS_" + sGXsfl_26_idx;
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Work With Alta Usuarios";
         subGrid_Rows = 10;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16UsuariosNombre',fld:'vUSUARIOSNOMBRE',pic:'@!'},{av:'AV13Update',fld:'vUPDATE',pic:''},{av:'AV19Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E140F2',iparms:[{av:'cmbUsuariosStatus'},{av:'A286UsuariosStatus',fld:'USUARIOSSTATUS',pic:'9'},{av:'A11UsuariosId',fld:'USUARIOSID',pic:'ZZZZZ9',hsh:true}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'cmbUsuariosStatus'},{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E110F2',iparms:[{av:'A11UsuariosId',fld:'USUARIOSID',pic:'ZZZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16UsuariosNombre',fld:'vUSUARIOSNOMBRE',pic:'@!'},{av:'AV13Update',fld:'vUPDATE',pic:''},{av:'AV19Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16UsuariosNombre',fld:'vUSUARIOSNOMBRE',pic:'@!'},{av:'AV13Update',fld:'vUPDATE',pic:''},{av:'AV19Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16UsuariosNombre',fld:'vUSUARIOSNOMBRE',pic:'@!'},{av:'AV13Update',fld:'vUPDATE',pic:''},{av:'AV19Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16UsuariosNombre',fld:'vUSUARIOSNOMBRE',pic:'@!'},{av:'AV13Update',fld:'vUPDATE',pic:''},{av:'AV19Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV16UsuariosNombre = "";
         H000F2_A286UsuariosStatus = new short[1] ;
         H000F2_A272UsuariosTipo = new short[1] ;
         H000F2_A261UsuariosCorreo = new String[] {""} ;
         H000F2_A260UsuariosTelef = new String[] {""} ;
         H000F2_A257UsuariosSexo = new String[] {""} ;
         H000F2_A256UsuariosEdad = new short[1] ;
         H000F2_A255UsuariosFecNacimiento = new DateTime[] {DateTime.MinValue} ;
         H000F2_A64UsuariosApMat = new String[] {""} ;
         H000F2_A65UsuariosApPat = new String[] {""} ;
         H000F2_A66UsuariosNombre = new String[] {""} ;
         H000F2_A105UsuariosCurp = new String[] {""} ;
         H000F2_A11UsuariosId = new int[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwusuarios__default(),
            new Object[][] {
                new Object[] {
               H000F2_A286UsuariosStatus, H000F2_A272UsuariosTipo, H000F2_A261UsuariosCorreo, H000F2_A260UsuariosTelef, H000F2_A257UsuariosSexo, H000F2_A256UsuariosEdad, H000F2_A255UsuariosFecNacimiento, H000F2_A64UsuariosApMat, H000F2_A65UsuariosApPat, H000F2_A66UsuariosNombre,
               H000F2_A105UsuariosCurp, H000F2_A11UsuariosId
               }
               , new Object[] {
      ...
      private String AV16UsuariosNombre ;
      ...
      private String lV16UsuariosNombre ;
      ...
      private short[] H000F2_A286UsuariosStatus ;
      private short[] H000F2_A272UsuariosTipo ;
      private String[] H000F2_A261UsuariosCorreo ;
      private String[] H000F2_A260UsuariosTelef ;
      private String[] H000F2_A257UsuariosSexo ;
      private short[] H000F2_A256UsuariosEdad ;
      private DateTime[] H000F2_A255UsuariosFecNacimiento ;
      private String[] H000F2_A64UsuariosApMat ;
      private String[] H000F2_A65UsuariosApPat ;
      private String[] H000F2_A66UsuariosNombre ;
      private String[] H000F2_A105UsuariosCurp ;
      private int[] H000F2_A11UsuariosId ;
   ...
   public class wwusuarios__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             String A66UsuariosNombre )
      {
         ...
         String sFromString ;
         String sOrderString ;
         sSelectString = " `UsuariosStatus`, `UsuariosTipo`, `UsuariosCorreo`, `UsuariosTelef`, `UsuariosSexo`, `UsuariosEdad`, `UsuariosFecNacimiento`, `UsuariosApMat`, `UsuariosApPat`, `UsuariosNombre`, `UsuariosCurp`, `UsuariosId`";
         sFromString = " FROM `Usuarios`";
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV16UsuariosNombre)) )
         {
            ...
            {
               sWhereString = sWhereString + " (`UsuariosNombre` like ?)";
            }
         }
         else
         {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"lV16UsuariosNombre",System.Data.DbType.String,40,0} ,
