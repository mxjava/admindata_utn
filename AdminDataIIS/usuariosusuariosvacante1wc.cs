...
namespace GeneXus.Programs {
   public class usuariosusuariosvacante1wc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public usuariosusuariosvacante1wc( )
      {
      ...
      public usuariosusuariosvacante1wc( IGxContext context )
      {
      ...
      {
         this.AV6SUBT_ReclutadorId = aP0_SUBT_ReclutadorId;
         executePrivate();
      }
         ...
         if ( StringUtil.Len( (String)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV6SUBT_ReclutadorId = (int)(NumberUtil.Val( GetNextPar( ), "."));
                  AssignAttri(sPrefix, false, "AV6SUBT_ReclutadorId", StringUtil.LTrimStr( (decimal)(AV6SUBT_ReclutadorId), 6, 0));
                  setjustcreated();
                  componentprepare(new Object[] {(String)sCompPrefix,(String)sSFPrefix,(int)AV6SUBT_ReclutadorId});
                  componentstart();
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
               {
                  ...
                  gxgrGrid_refresh( subGrid_Rows, AV6SUBT_ReclutadorId, AV11Update, AV12Delete, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV16Pgmname = "UsuariosUsuariosVacante1WC";
               context.Gx_err = 0;
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Usuarios Usuarios Vacante1 WC") ;
         ...
         context.AddJavascriptSource("gxcfg.js", "?202262714344126", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("usuariosusuariosvacante1wc.aspx") + "?" + UrlEncode("" +AV6SUBT_ReclutadorId)+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV6SUBT_ReclutadorId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV6SUBT_ReclutadorId), 6, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vSUBT_RECLUTADORID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6SUBT_ReclutadorId), 6, 0, ",", "")));
      ...
      protected void RenderHtmlCloseForm2V2( )
      {
         ...
         {
            context.AddJavascriptSource("usuariosusuariosvacante1wc.js", "?202262714344128", false, true);
         }
      ...
      {
         return "UsuariosUsuariosVacante1WC" ;
      }

      public override String GetPgmdesc( )
      {
         return "Usuarios Usuarios Vacante1 WC" ;
      }
      ...
      protected void WB2V0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "usuariosusuariosvacante1wc.aspx");
            }
            /* Div Control */
            ...
            ClassString = "BtnAdd";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(20), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_UsuariosUsuariosVacante1WC.htm");
            ...
            else
            {
               ...
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", A274Vacantes_Descripcion);
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               ...
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A277Vacantes_Plazas), 4, 0, ".", "")));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
         ...
         if ( wbEnd == 20 )
         {
            ...
            GxWebStd.gx_label_element( context, edtSUBT_ReclutadorId_Internalname, "Reclutador", "col-sm-3 AttributeLabel", 0, true, "");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtSUBT_ReclutadorId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A284SUBT_ReclutadorId), 6, 0, ",", "")), ((edtSUBT_ReclutadorId_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(A284SUBT_ReclutadorId), "ZZZZZ9")) : context.localUtil.Format( (decimal)(A284SUBT_ReclutadorId), "ZZZZZ9")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtSUBT_ReclutadorId_Jsonclick, 0, "Attribute", "", "", "", "", edtSUBT_ReclutadorId_Visible, edtSUBT_ReclutadorId_Enabled, 0, "number", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 1, -1, 0, true, "NumId", "right", false, "", "HLP_UsuariosUsuariosVacante1WC.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START2V2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Usuarios Usuarios Vacante1 WC", 0) ;
            }
            context.wjLoc = "";
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_VACANTES_ID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A263Vacantes_Id), "ZZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"VACANTES_ID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A263Vacantes_Id), 9, 0, ".", "")));
      }
      ...
      protected void RF2V2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H002V2 */
            pr_default.execute(0, new Object[] {AV6SUBT_ReclutadorId, GXPagingFrom2, GXPagingTo2});
            nGXsfl_20_idx = 1;
            sGXsfl_20_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_20_idx), 4, 0), 4, "0");
            SubsflControlProps_202( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A284SUBT_ReclutadorId = H002V2_A284SUBT_ReclutadorId[0];
               AssignAttri(sPrefix, false, "A284SUBT_ReclutadorId", StringUtil.LTrimStr( (decimal)(A284SUBT_ReclutadorId), 6, 0));
               A277Vacantes_Plazas = H002V2_A277Vacantes_Plazas[0];
               A270Vacantes_Duracion_Nom = H002V2_A270Vacantes_Duracion_Nom[0];
               A269Vacantes_Duracion = H002V2_A269Vacantes_Duracion[0];
               A268Vacantes_Tipo = H002V2_A268Vacantes_Tipo[0];
               A267Vacantes_Sueldo = H002V2_A267Vacantes_Sueldo[0];
               A266Vacantes_FechaInicio = H002V2_A266Vacantes_FechaInicio[0];
               A265Vacantes_Status = H002V2_A265Vacantes_Status[0];
               A274Vacantes_Descripcion = H002V2_A274Vacantes_Descripcion[0];
               A264Vacantes_Nombre = H002V2_A264Vacantes_Nombre[0];
               A263Vacantes_Id = H002V2_A263Vacantes_Id[0];
               A277Vacantes_Plazas = H002V2_A277Vacantes_Plazas[0];
               A270Vacantes_Duracion_Nom = H002V2_A270Vacantes_Duracion_Nom[0];
               A269Vacantes_Duracion = H002V2_A269Vacantes_Duracion[0];
               A268Vacantes_Tipo = H002V2_A268Vacantes_Tipo[0];
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_VACANTES_ID"+"_"+sGXsfl_20_idx, GetSecureSignedToken( sPrefix+sGXsfl_20_idx, context.localUtil.Format( (decimal)(A263Vacantes_Id), "ZZZZZZZZ9"), context));
      }
      ...
      {
         /* Using cursor H002V3 */
         pr_default.execute(1, new Object[] {AV6SUBT_ReclutadorId});
      ...
      protected void STRUP2V0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV6SUBT_ReclutadorId = (int)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6SUBT_ReclutadorId"), ",", "."));
            GRID_nFirstRecordOnPage = (long)(context.localUtil.CToN( cgiGet( sPrefix+"GRID_nFirstRecordOnPage"), ",", "."));
            GRID_nEOF = (short)(context.localUtil.CToN( cgiGet( sPrefix+"GRID_nEOF"), ",", "."));
            subGrid_Rows = (int)(context.localUtil.CToN( cgiGet( sPrefix+"GRID_Rows"), ",", "."));
            GxWebStd.gx_hidden_field( context, sPrefix+"GRID_Rows", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGrid_Rows), 6, 0, ".", "")));
            /* Read variables values. */
            A284SUBT_ReclutadorId = (int)(context.localUtil.CToN( cgiGet( edtSUBT_ReclutadorId_Internalname), ",", "."));
            AssignAttri(sPrefix, false, "A284SUBT_ReclutadorId", StringUtil.LTrimStr( (decimal)(A284SUBT_ReclutadorId), 6, 0));
      ...
      protected void E122V2( )
      {
         ...
         AV12Delete = "Eliminar";
         AssignAttri(sPrefix, false, edtavDelete_Internalname, AV12Delete);
         edtSUBT_ReclutadorId_Visible = 0;
         AssignProp(sPrefix, false, edtSUBT_ReclutadorId_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtSUBT_ReclutadorId_Visible), 5, 0), true);
      ...
      protected void S112( )
      {
         ...
         AV9TrnContext.gxTpr_Transactionname = "Vacantes";
         AV10TrnContextAtt = new SdtTransactionContext_Attribute(context);
         AV10TrnContextAtt.gxTpr_Attributename = "SUBT_ReclutadorId";
         AV10TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV6SUBT_ReclutadorId), 6, 0);
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV6SUBT_ReclutadorId = Convert.ToInt32(getParm(obj,0));
         AssignAttri(sPrefix, false, "AV6SUBT_ReclutadorId", StringUtil.LTrimStr( (decimal)(AV6SUBT_ReclutadorId), 6, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV6SUBT_ReclutadorId = (String)((String)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "usuariosusuariosvacante1wc", GetJustCreated( ));
         ...
         {
            AV6SUBT_ReclutadorId = Convert.ToInt32(getParm(obj,2));
            AssignAttri(sPrefix, false, "AV6SUBT_ReclutadorId", StringUtil.LTrimStr( (decimal)(AV6SUBT_ReclutadorId), 6, 0));
         }
         wcpOAV6SUBT_ReclutadorId = (int)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6SUBT_ReclutadorId"), ",", "."));
         if ( ! GetJustCreated( ) && ( ( AV6SUBT_ReclutadorId != wcpOAV6SUBT_ReclutadorId ) ) )
         {
            setjustcreated();
         }
         wcpOAV6SUBT_ReclutadorId = AV6SUBT_ReclutadorId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlAV6SUBT_ReclutadorId = cgiGet( sPrefix+"AV6SUBT_ReclutadorId_CTRL");
         if ( StringUtil.Len( sCtrlAV6SUBT_ReclutadorId) > 0 )
         {
            AV6SUBT_ReclutadorId = (int)(context.localUtil.CToN( cgiGet( sCtrlAV6SUBT_ReclutadorId), ",", "."));
            AssignAttri(sPrefix, false, "AV6SUBT_ReclutadorId", StringUtil.LTrimStr( (decimal)(AV6SUBT_ReclutadorId), 6, 0));
         }
         else
         {
            AV6SUBT_ReclutadorId = (int)(context.localUtil.CToN( cgiGet( sPrefix+"AV6SUBT_ReclutadorId_PARM"), ",", "."));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV6SUBT_ReclutadorId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6SUBT_ReclutadorId), 6, 0, ",", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV6SUBT_ReclutadorId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV6SUBT_ReclutadorId_CTRL", StringUtil.RTrim( sCtrlAV6SUBT_ReclutadorId));
         }
      }
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("usuariosusuariosvacante1wc.js", "?202262714344159", false, true);
         }
      ...
      {
         edtVacantes_Id_Internalname = sPrefix+"VACANTES_ID_"+sGXsfl_20_idx;
         edtVacantes_Nombre_Internalname = sPrefix+"VACANTES_NOMBRE_"+sGXsfl_20_idx;
         edtVacantes_Descripcion_Internalname = sPrefix+"VACANTES_DESCRIPCION_"+sGXsfl_20_idx;
         cmbVacantes_Status_Internalname = sPrefix+"VACANTES_STATUS_"+sGXsfl_20_idx;
         edtVacantes_FechaInicio_Internalname = sPrefix+"VACANTES_FECHAINICIO_"+sGXsfl_20_idx;
         edtVacantes_Sueldo_Internalname = sPrefix+"VACANTES_SUELDO_"+sGXsfl_20_idx;
         cmbVacantes_Tipo_Internalname = sPrefix+"VACANTES_TIPO_"+sGXsfl_20_idx;
         edtVacantes_Duracion_Internalname = sPrefix+"VACANTES_DURACION_"+sGXsfl_20_idx;
         cmbVacantes_Duracion_Nom_Internalname = sPrefix+"VACANTES_DURACION_NOM_"+sGXsfl_20_idx;
         edtVacantes_Plazas_Internalname = sPrefix+"VACANTES_PLAZAS_"+sGXsfl_20_idx;
      ...
      {
         edtVacantes_Id_Internalname = sPrefix+"VACANTES_ID_"+sGXsfl_20_fel_idx;
         edtVacantes_Nombre_Internalname = sPrefix+"VACANTES_NOMBRE_"+sGXsfl_20_fel_idx;
         edtVacantes_Descripcion_Internalname = sPrefix+"VACANTES_DESCRIPCION_"+sGXsfl_20_fel_idx;
         cmbVacantes_Status_Internalname = sPrefix+"VACANTES_STATUS_"+sGXsfl_20_fel_idx;
         edtVacantes_FechaInicio_Internalname = sPrefix+"VACANTES_FECHAINICIO_"+sGXsfl_20_fel_idx;
         edtVacantes_Sueldo_Internalname = sPrefix+"VACANTES_SUELDO_"+sGXsfl_20_fel_idx;
         cmbVacantes_Tipo_Internalname = sPrefix+"VACANTES_TIPO_"+sGXsfl_20_fel_idx;
         edtVacantes_Duracion_Internalname = sPrefix+"VACANTES_DURACION_"+sGXsfl_20_fel_idx;
         cmbVacantes_Duracion_Nom_Internalname = sPrefix+"VACANTES_DURACION_NOM_"+sGXsfl_20_fel_idx;
         edtVacantes_Plazas_Internalname = sPrefix+"VACANTES_PLAZAS_"+sGXsfl_20_fel_idx;
      ...
      protected void sendrow_202( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_20_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtVacantes_Id_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A263Vacantes_Id), 9, 0, ",", "")),context.localUtil.Format( (decimal)(A263Vacantes_Id), "ZZZZZZZZ9"),(String)"",(String)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtVacantes_Id_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn WWOptionalColumn",(String)"",(short)-1,(short)0,(short)0,(String)"number",(String)"1",(short)0,(String)"px",(short)17,(String)"px",(short)9,(short)0,(short)0,(short)20,(short)1,(short)-1,(short)0,(bool)true,(String)"Id",(String)"right",(bool)false,(String)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtVacantes_Descripcion_Internalname,(String)A274Vacantes_Descripcion,(String)"",(String)"",(String)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtVacantes_Descripcion_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn WWOptionalColumn",(String)"",(short)-1,(short)0,(short)0,(String)"text",(String)"",(short)0,(String)"px",(short)17,(String)"px",(short)1000,(short)0,(short)0,(short)20,(short)1,(short)-1,(short)-1,(bool)true,(String)"",(String)"left",(bool)true,(String)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
            }
            GXCCtl = "VACANTES_STATUS_" + sGXsfl_20_idx;
            ...
            AssignProp(sPrefix, false, cmbVacantes_Status_Internalname, "Values", (String)(cmbVacantes_Status.ToJavascriptSource()), !bGXsfl_20_Refreshing);
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtVacantes_FechaInicio_Internalname,context.localUtil.Format(A266Vacantes_FechaInicio, "99/99/99"),context.localUtil.Format( A266Vacantes_FechaInicio, "99/99/99"),(String)"",(String)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtVacantes_FechaInicio_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn WWOptionalColumn",(String)"",(short)-1,(short)0,(short)0,(String)"text",(String)"",(short)0,(String)"px",(short)17,(String)"px",(short)8,(short)0,(short)0,(short)20,(short)1,(short)-1,(short)0,(bool)true,(String)"",(String)"right",(bool)false,(String)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtVacantes_Sueldo_Internalname,StringUtil.LTrim( StringUtil.NToC( A267Vacantes_Sueldo, 6, 3, ",", "")),context.localUtil.Format( A267Vacantes_Sueldo, "Z9.999"),(String)"",(String)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtVacantes_Sueldo_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn WWOptionalColumn",(String)"",(short)-1,(short)0,(short)0,(String)"text",(String)"",(short)0,(String)"px",(short)17,(String)"px",(short)6,(short)0,(short)0,(short)20,(short)1,(short)-1,(short)0,(bool)true,(String)"",(String)"right",(bool)false,(String)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
            }
            GXCCtl = "VACANTES_TIPO_" + sGXsfl_20_idx;
            ...
            AssignProp(sPrefix, false, cmbVacantes_Tipo_Internalname, "Values", (String)(cmbVacantes_Tipo.ToJavascriptSource()), !bGXsfl_20_Refreshing);
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtVacantes_Duracion_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A269Vacantes_Duracion), 4, 0, ",", "")),context.localUtil.Format( (decimal)(A269Vacantes_Duracion), "ZZZ9"),(String)"",(String)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtVacantes_Duracion_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn WWOptionalColumn",(String)"",(short)-1,(short)0,(short)0,(String)"number",(String)"1",(short)0,(String)"px",(short)17,(String)"px",(short)4,(short)0,(short)0,(short)20,(short)1,(short)-1,(short)0,(bool)true,(String)"",(String)"right",(bool)false,(String)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
            }
            GXCCtl = "VACANTES_DURACION_NOM_" + sGXsfl_20_idx;
            ...
            AssignProp(sPrefix, false, cmbVacantes_Duracion_Nom_Internalname, "Values", (String)(cmbVacantes_Duracion_Nom.ToJavascriptSource()), !bGXsfl_20_Refreshing);
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtVacantes_Plazas_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A277Vacantes_Plazas), 4, 0, ",", "")),context.localUtil.Format( (decimal)(A277Vacantes_Plazas), "ZZZ9"),(String)"",(String)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtVacantes_Plazas_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn WWOptionalColumn",(String)"",(short)-1,(short)0,(short)0,(String)"number",(String)"1",(short)0,(String)"px",(short)17,(String)"px",(short)4,(short)0,(short)0,(short)20,(short)1,(short)-1,(short)0,(bool)true,(String)"",(String)"right",(bool)false,(String)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
      ...
      protected void init_default_properties( )
      {
         ...
         edtSUBT_ReclutadorId_Internalname = sPrefix+"SUBT_RECLUTADORID";
      ...
      public override void initialize_properties( )
      {
         ...
         edtVacantes_Descripcion_Jsonclick = "";
         edtVacantes_Nombre_Jsonclick = "";
         edtVacantes_Id_Jsonclick = "";
         edtSUBT_ReclutadorId_Jsonclick = "";
         edtSUBT_ReclutadorId_Enabled = 0;
         edtSUBT_ReclutadorId_Visible = 1;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6SUBT_ReclutadorId',fld:'vSUBT_RECLUTADORID',pic:'ZZZZZ9'},{av:'AV11Update',fld:'vUPDATE',pic:''},{av:'AV12Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E132V2',iparms:[{av:'A263Vacantes_Id',fld:'VACANTES_ID',pic:'ZZZZZZZZ9',hsh:true}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtVacantes_Nombre_Link',ctrl:'VACANTES_NOMBRE',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E112V2',iparms:[{av:'A263Vacantes_Id',fld:'VACANTES_ID',pic:'ZZZZZZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6SUBT_ReclutadorId',fld:'vSUBT_RECLUTADORID',pic:'ZZZZZ9'},{av:'AV11Update',fld:'vUPDATE',pic:''},{av:'AV12Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6SUBT_ReclutadorId',fld:'vSUBT_RECLUTADORID',pic:'ZZZZZ9'},{av:'AV11Update',fld:'vUPDATE',pic:''},{av:'AV12Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6SUBT_ReclutadorId',fld:'vSUBT_RECLUTADORID',pic:'ZZZZZ9'},{av:'AV11Update',fld:'vUPDATE',pic:''},{av:'AV12Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6SUBT_ReclutadorId',fld:'vSUBT_RECLUTADORID',pic:'ZZZZZ9'},{av:'AV11Update',fld:'vUPDATE',pic:''},{av:'AV12Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         scmdbuf = "";
         H002V2_A11UsuariosId = new int[1] ;
         H002V2_A284SUBT_ReclutadorId = new int[1] ;
         H002V2_A277Vacantes_Plazas = new short[1] ;
         H002V2_A270Vacantes_Duracion_Nom = new short[1] ;
         H002V2_A269Vacantes_Duracion = new short[1] ;
         H002V2_A268Vacantes_Tipo = new short[1] ;
         H002V2_A267Vacantes_Sueldo = new decimal[1] ;
         H002V2_A266Vacantes_FechaInicio = new DateTime[] {DateTime.MinValue} ;
         H002V2_A265Vacantes_Status = new short[1] ;
         H002V2_A274Vacantes_Descripcion = new String[] {""} ;
         H002V2_A264Vacantes_Nombre = new String[] {""} ;
         H002V2_A263Vacantes_Id = new int[1] ;
         ...
         sCtrlAV6SUBT_ReclutadorId = "";
         ROClassString = "";
         GXCCtl = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.usuariosusuariosvacante1wc__default(),
            new Object[][] {
                new Object[] {
               H002V2_A11UsuariosId, H002V2_A284SUBT_ReclutadorId, H002V2_A277Vacantes_Plazas, H002V2_A270Vacantes_Duracion_Nom, H002V2_A269Vacantes_Duracion, H002V2_A268Vacantes_Tipo, H002V2_A267Vacantes_Sueldo, H002V2_A266Vacantes_FechaInicio, H002V2_A265Vacantes_Status, H002V2_A274Vacantes_Descripcion,
               H002V2_A264Vacantes_Nombre, H002V2_A263Vacantes_Id
               }
               , new Object[] {
      ...
      private int AV6SUBT_ReclutadorId ;
      private int wcpOAV6SUBT_ReclutadorId ;
      ...
      private int edtSUBT_ReclutadorId_Enabled ;
      private int edtSUBT_ReclutadorId_Visible ;
      ...
      private String edtSUBT_ReclutadorId_Internalname ;
      private String edtSUBT_ReclutadorId_Jsonclick ;
      ...
      private int[] H002V2_A11UsuariosId ;
      private int[] H002V2_A284SUBT_ReclutadorId ;
      private short[] H002V2_A277Vacantes_Plazas ;
      private short[] H002V2_A270Vacantes_Duracion_Nom ;
      private short[] H002V2_A269Vacantes_Duracion ;
      private short[] H002V2_A268Vacantes_Tipo ;
      private decimal[] H002V2_A267Vacantes_Sueldo ;
      private DateTime[] H002V2_A266Vacantes_FechaInicio ;
      private short[] H002V2_A265Vacantes_Status ;
      private String[] H002V2_A274Vacantes_Descripcion ;
      private String[] H002V2_A264Vacantes_Nombre ;
      private int[] H002V2_A263Vacantes_Id ;
   ...
   public class usuariosusuariosvacante1wc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"AV6SUBT_ReclutadorId",System.Data.DbType.Int32,6,0} ,
          ...
          def= new CursorDef[] {
              new CursorDef("H002V2", "SELECT T1.`UsuariosId`, T1.`SUBT_ReclutadorId`, T2.`Vacantes_Plazas`, T2.`Vacantes_Duracion_Nom`, T2.`Vacantes_Duracion`, T2.`Vacantes_Tipo`, T2.`Vacantes_Sueldo`, T2.`Vacantes_FechaInicio`, T2.`Vacantes_Status`, T2.`Vacantes_Descripcion`, T2.`Vacantes_Nombre`, T1.`Vacantes_Id` FROM (`VacantesUsuariosVacante` T1 INNER JOIN `Vacantes` T2 ON T2.`Vacantes_Id` = T1.`Vacantes_Id`) WHERE T1.`SUBT_ReclutadorId` = ? ORDER BY T1.`SUBT_ReclutadorId`  LIMIT ?, ?",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002V2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H002V3", "SELECT COUNT(*) FROM (`VacantesUsuariosVacante` T1 INNER JOIN `Vacantes` T2 ON T2.`Vacantes_Id` = T1.`Vacantes_Id`) WHERE T1.`SUBT_ReclutadorId` = ? ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002V3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
