...
namespace GeneXus.Programs {
   public class wwmeninicio : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public wwmeninicio( )
      {
      ...
      public wwmeninicio( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrGrid_refresh( subGrid_Rows, AV13menInicioDes, AV19Pgmname, AV14Update, AV15Delete) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202262714344631", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wwmeninicio.aspx") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vMENINICIODES", AV13menInicioDes);
         /* Send saved values. */
      ...
      {
         return formatLink("wwmeninicio.aspx")  ;
      }
      ...
      {
         return "Work With Tabla de mensajes de inicio" ;
      }
      ...
      protected void WB0I0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "Tabla de mensajes de inicios", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, "HLP_WWmenInicio.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 WWActionsCell", "left", "top", "", "", "div");
            /* Div Control */
            ...
            ClassString = "BtnAdd";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(23), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWmenInicio.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_label_element( context, edtavMeniniciodes_Internalname, "men Inicio Des", "col-sm-3 FilterAttributeLabel", 0, true, "");
            /* Multiple line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 20,'',false,'" + sGXsfl_23_idx + "',0)\"";
            ClassString = "FilterAttribute";
            StyleString = "";
            ClassString = "FilterAttribute";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtavMeniniciodes_Internalname, AV13menInicioDes, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,20);\"", 0, 1, edtavMeniniciodes_Enabled, 0, 80, "chr", 4, "row", StyleString, ClassString, "", "", "255", -1, 0, "", "Mensaje", -1, true, "", "'"+""+"'"+",false,"+"'"+""+"'", 0, "HLP_WWmenInicio.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            if ( GridContainer.GetWrapped() == 1 )
            {
               ...
               context.SendWebValue( "Usuario Captura") ;
               context.WriteHtmlTextNl( "</th>") ;
            ...
            else
            {
               ...
               GridColumn.AddObjectProperty("Link", StringUtil.RTrim( edtmenInicioDes_Link));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               ...
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A59sgUsrMenId), 6, 0, ".", "")));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", A187sgUsrMenNom);
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      protected void START0I2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Work With Tabla de mensajes de inicio", 0) ;
         }
         context.wjLoc = "";
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    {
                                       Rfr0gs = false;
                                       /* Set Refresh If Meniniciodes Changed */
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vMENINICIODES"), AV13menInicioDes) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void PA0I2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ! context.isAjaxRequest( ) )
            {
               GX_FocusControl = edtavMeniniciodes_Internalname;
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_MENINICIOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(A58menInicioId), "ZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "MENINICIOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A58menInicioId), 6, 0, ".", "")));
      }
      ...
      {
         /* GeneXus formulas. */
         AV19Pgmname = "WWmenInicio";
         context.Gx_err = 0;
         edtavUpdate_Enabled = 0;
         AssignProp("", false, edtavUpdate_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavUpdate_Enabled), 5, 0), !bGXsfl_23_Refreshing);
         edtavDelete_Enabled = 0;
         AssignProp("", false, edtavDelete_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavDelete_Enabled), 5, 0), !bGXsfl_23_Refreshing);
      }
      ...
      protected void RF0I2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV13menInicioDes = StringUtil.Concat( StringUtil.RTrim( AV13menInicioDes), "%", "");
            /* Using cursor H000I2 */
            pr_default.execute(0, new Object[] {lV13menInicioDes, GXPagingFrom2, GXPagingTo2});
            nGXsfl_23_idx = 1;
            sGXsfl_23_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_23_idx), 4, 0), 4, "0");
            SubsflControlProps_232( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A187sgUsrMenNom = H000I2_A187sgUsrMenNom[0];
               A59sgUsrMenId = H000I2_A59sgUsrMenId[0];
               A185menInicioFecCap = H000I2_A185menInicioFecCap[0];
               A77menInicioStat = H000I2_A77menInicioStat[0];
               A76menInicioFecFin = H000I2_A76menInicioFecFin[0];
               A186menInicioFecIni = H000I2_A186menInicioFecIni[0];
               A150menInicioDes = H000I2_A150menInicioDes[0];
               A58menInicioId = H000I2_A58menInicioId[0];
               E140I2 ();
      ...
      protected void send_integrity_lvl_hashes0I2( )
      {
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV19Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV19Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, "gxhash_MENINICIOID"+"_"+sGXsfl_23_idx, GetSecureSignedToken( sGXsfl_23_idx, context.localUtil.Format( (decimal)(A58menInicioId), "ZZZZZ9"), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV13menInicioDes = StringUtil.Concat( StringUtil.RTrim( AV13menInicioDes), "%", "");
         /* Using cursor H000I3 */
         pr_default.execute(1, new Object[] {lV13menInicioDes});
      ...
      protected void STRUP0I0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV13menInicioDes = cgiGet( edtavMeniniciodes_Internalname);
            AssignAttri("", false, "AV13menInicioDes", AV13menInicioDes);
      ...
      protected void E120I2( )
      {
         ...
         AV15Delete = "Eliminar";
         AssignAttri("", false, edtavDelete_Internalname, AV15Delete);
         Form.Caption = "Tabla de mensajes de inicios";
      ...
      private void E140I2( )
      {
         ...
         edtmenInicioDes_Link = formatLink("ViewmenInicio") + "?" + UrlEncode("" +A58menInicioId) + "," + UrlEncode(StringUtil.RTrim(""));
         /* Load Method */
         if ( wbStart != -1 )
         {
            wbStart = 23;
      ...
      {
         /* 'DoInsert' Routine */
         CallWebObject(formatLink("meninicio.aspx") + "?" + UrlEncode(StringUtil.RTrim("INS")) + "," + UrlEncode("" +0));
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void S122( )
      {
         ...
         if ( StringUtil.StrCmp(AV7HTTPRequest.Method, "GET") == 0 )
         {
            ...
            {
               AV13menInicioDes = ((SdtGridState_FilterValue)AV8GridState.gxTpr_Filtervalues.Item(1)).gxTpr_Value;
               AssignAttri("", false, "AV13menInicioDes", AV13menInicioDes);
            }
      ...
      protected void S132( )
      {
         ...
         AV9GridStateFilterValue.gxTpr_Value = AV13menInicioDes;
      ...
      protected void S112( )
      {
         ...
         AV11TrnContext.gxTpr_Transactionname = "menInicio";
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202262714344663", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwmeninicio.js", "?202262714344663", false, true);
         }
      ...
      {
         edtmenInicioId_Internalname = "MENINICIOID_"+sGXsfl_23_idx;
         edtmenInicioDes_Internalname = "MENINICIODES_"+sGXsfl_23_idx;
         edtmenInicioFecIni_Internalname = "MENINICIOFECINI_"+sGXsfl_23_idx;
         edtmenInicioFecFin_Internalname = "MENINICIOFECFIN_"+sGXsfl_23_idx;
         cmbmenInicioStat_Internalname = "MENINICIOSTAT_"+sGXsfl_23_idx;
         edtmenInicioFecCap_Internalname = "MENINICIOFECCAP_"+sGXsfl_23_idx;
         edtsgUsrMenId_Internalname = "SGUSRMENID_"+sGXsfl_23_idx;
         edtsgUsrMenNom_Internalname = "SGUSRMENNOM_"+sGXsfl_23_idx;
      ...
      {
         edtmenInicioId_Internalname = "MENINICIOID_"+sGXsfl_23_fel_idx;
         edtmenInicioDes_Internalname = "MENINICIODES_"+sGXsfl_23_fel_idx;
         edtmenInicioFecIni_Internalname = "MENINICIOFECINI_"+sGXsfl_23_fel_idx;
         edtmenInicioFecFin_Internalname = "MENINICIOFECFIN_"+sGXsfl_23_fel_idx;
         cmbmenInicioStat_Internalname = "MENINICIOSTAT_"+sGXsfl_23_fel_idx;
         edtmenInicioFecCap_Internalname = "MENINICIOFECCAP_"+sGXsfl_23_fel_idx;
         edtsgUsrMenId_Internalname = "SGUSRMENID_"+sGXsfl_23_fel_idx;
         edtsgUsrMenNom_Internalname = "SGUSRMENNOM_"+sGXsfl_23_fel_idx;
      ...
      protected void sendrow_232( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_23_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtmenInicioId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A58menInicioId), 6, 0, ",", "")),context.localUtil.Format( (decimal)(A58menInicioId), "ZZZZZ9"),(String)"",(String)"'"+""+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtmenInicioId_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn WWOptionalColumn",(String)"",(short)-1,(short)0,(short)0,(String)"number",(String)"1",(short)0,(String)"px",(short)17,(String)"px",(short)6,(short)0,(short)0,(short)23,(short)1,(short)-1,(short)0,(bool)true,(String)"NumId",(String)"right",(bool)false,(String)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtmenInicioDes_Internalname,(String)A150menInicioDes,(String)"",(String)"",(String)"'"+""+"'"+",false,"+"'"+""+"'",(String)edtmenInicioDes_Link,(String)"",(String)"",(String)"",(String)edtmenInicioDes_Jsonclick,(short)0,(String)"DescriptionAttribute",(String)"",(String)ROClassString,(String)"WWColumn",(String)"",(short)-1,(short)0,(short)0,(String)"text",(String)"",(short)0,(String)"px",(short)17,(String)"px",(short)255,(short)0,(short)0,(short)23,(short)1,(short)-1,(short)-1,(bool)true,(String)"",(String)"left",(bool)true,(String)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
            ...
            {
               GXCCtl = "MENINICIOSTAT_" + sGXsfl_23_idx;
            ...
            AssignProp("", false, cmbmenInicioStat_Internalname, "Values", (String)(cmbmenInicioStat.ToJavascriptSource()), !bGXsfl_23_Refreshing);
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtsgUsrMenId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A59sgUsrMenId), 6, 0, ",", "")),context.localUtil.Format( (decimal)(A59sgUsrMenId), "ZZZZZ9"),(String)"",(String)"'"+""+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtsgUsrMenId_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn WWOptionalColumn",(String)"",(short)-1,(short)0,(short)0,(String)"number",(String)"1",(short)0,(String)"px",(short)17,(String)"px",(short)6,(short)0,(short)0,(short)23,(short)1,(short)-1,(short)0,(bool)true,(String)"",(String)"right",(bool)false,(String)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtsgUsrMenNom_Internalname,(String)A187sgUsrMenNom,(String)"",(String)"",(String)"'"+""+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtsgUsrMenNom_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn WWOptionalColumn",(String)"",(short)-1,(short)0,(short)0,(String)"text",(String)"",(short)0,(String)"px",(short)17,(String)"px",(short)20,(short)0,(short)0,(short)23,(short)1,(short)-1,(short)-1,(bool)true,(String)"",(String)"left",(bool)true,(String)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
      ...
      protected void init_default_properties( )
      {
         ...
         edtavMeniniciodes_Internalname = "vMENINICIODES";
      ...
      public override void initialize_properties( )
      {
         ...
         edtavDelete_Link = "";
         edtavUpdate_Link = "";
         edtmenInicioDes_Link = "";
         subGrid_Header = "";
         edtavDelete_Enabled = 0;
         edtavUpdate_Enabled = 0;
         subGrid_Class = "WorkWith";
         subGrid_Backcolorstyle = 0;
         edtavMeniniciodes_Enabled = 1;
         Form.Headerrawhtml = "";
         Form.Background = "";
         Form.Textcolor = 0;
         Form.Backcolor = (int)(0xFFFFFF);
         Form.Caption = "Work With Tabla de mensajes de inicio";
         subGrid_Rows = 0;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14Update',fld:'vUPDATE',pic:''},{av:'AV15Delete',fld:'vDELETE',pic:''},{av:'AV13menInicioDes',fld:'vMENINICIODES',pic:''},{av:'AV19Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E140I2',iparms:[{av:'A58menInicioId',fld:'MENINICIOID',pic:'ZZZZZ9',hsh:true}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtmenInicioDes_Link',ctrl:'MENINICIODES',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E110I2',iparms:[{av:'A58menInicioId',fld:'MENINICIOID',pic:'ZZZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14Update',fld:'vUPDATE',pic:''},{av:'AV15Delete',fld:'vDELETE',pic:''},{av:'AV19Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13menInicioDes',fld:'vMENINICIODES',pic:''}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14Update',fld:'vUPDATE',pic:''},{av:'AV15Delete',fld:'vDELETE',pic:''},{av:'AV19Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13menInicioDes',fld:'vMENINICIODES',pic:''}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14Update',fld:'vUPDATE',pic:''},{av:'AV15Delete',fld:'vDELETE',pic:''},{av:'AV19Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13menInicioDes',fld:'vMENINICIODES',pic:''}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14Update',fld:'vUPDATE',pic:''},{av:'AV15Delete',fld:'vDELETE',pic:''},{av:'AV19Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13menInicioDes',fld:'vMENINICIODES',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV13menInicioDes = "";
         H000I2_A187sgUsrMenNom = new String[] {""} ;
         H000I2_A59sgUsrMenId = new int[1] ;
         H000I2_A185menInicioFecCap = new DateTime[] {DateTime.MinValue} ;
         H000I2_A77menInicioStat = new short[1] ;
         H000I2_A76menInicioFecFin = new DateTime[] {DateTime.MinValue} ;
         H000I2_A186menInicioFecIni = new DateTime[] {DateTime.MinValue} ;
         H000I2_A150menInicioDes = new String[] {""} ;
         H000I2_A58menInicioId = new int[1] ;
         ...
         ROClassString = "";
         GXCCtl = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwmeninicio__default(),
            new Object[][] {
                new Object[] {
               H000I2_A187sgUsrMenNom, H000I2_A59sgUsrMenId, H000I2_A185menInicioFecCap, H000I2_A77menInicioStat, H000I2_A76menInicioFecFin, H000I2_A186menInicioFecIni, H000I2_A150menInicioDes, H000I2_A58menInicioId
               }
               , new Object[] {
      ...
      private int edtavMeniniciodes_Enabled ;
      ...
      private String edtavMeniniciodes_Internalname ;
      private String sStyleString ;
      private String subGrid_Internalname ;
      private String subGrid_Class ;
      private String subGrid_Linesclass ;
      private String subGrid_Header ;
      private String edtmenInicioDes_Link ;
      ...
      private String AV13menInicioDes ;
      private String A150menInicioDes ;
      private String A187sgUsrMenNom ;
      private String lV13menInicioDes ;
      ...
      private String[] H000I2_A187sgUsrMenNom ;
      private int[] H000I2_A59sgUsrMenId ;
      private DateTime[] H000I2_A185menInicioFecCap ;
      private short[] H000I2_A77menInicioStat ;
      private DateTime[] H000I2_A76menInicioFecFin ;
      private DateTime[] H000I2_A186menInicioFecIni ;
      private String[] H000I2_A150menInicioDes ;
      private int[] H000I2_A58menInicioId ;
   ...
   public class wwmeninicio__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H000I2( IGxContext context ,
                                             String AV13menInicioDes ,
                                             String A150menInicioDes )
      {
         String sWhereString = "" ;
         String scmdbuf ;
         short[] GXv_int1 ;
         ...
         String sFromString ;
         String sOrderString ;
         sSelectString = " `sgUsrMenNom`, `sgUsrMenId`, `menInicioFecCap`, `menInicioStat`, `menInicioFecFin`, `menInicioFecIni`, `menInicioDes`, `menInicioId`";
         sFromString = " FROM `menInicio`";
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV13menInicioDes)) )
         {
            if ( StringUtil.StrCmp("", sWhereString) != 0 )
            {
               sWhereString = sWhereString + " and (`menInicioDes` like ?)";
            }
            else
            {
               sWhereString = sWhereString + " (`menInicioDes` like ?)";
            }
         }
         else
         {
         ...
         sOrderString = sOrderString + " ORDER BY `menInicioDes`";
                                             ...
                                             String A150menInicioDes )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM `menInicio`";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV13menInicioDes)) )
         {
            if ( StringUtil.StrCmp("", sWhereString) != 0 )
            {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"lV13menInicioDes",System.Data.DbType.String,255,0} ,
