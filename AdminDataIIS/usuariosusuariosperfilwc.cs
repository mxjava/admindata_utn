...
namespace GeneXus.Programs {
   public class usuariosusuariosperfilwc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public usuariosusuariosperfilwc( )
      {
      ...
      public usuariosusuariosperfilwc( IGxContext context )
      {
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV16Pgmname = "UsuariosUsuariosPerfilWC";
               context.Gx_err = 0;
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Usuarios Usuarios Perfil WC") ;
         ...
         context.AddJavascriptSource("gxcfg.js", "?202262714344564", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("usuariosusuariosperfilwc.aspx") + "?" + UrlEncode("" +AV6UsuariosId)+"\">") ;
      ...
      protected void RenderHtmlCloseForm2O2( )
      {
         ...
         {
            context.AddJavascriptSource("usuariosusuariosperfilwc.js", "?202262714344566", false, true);
         }
      ...
      {
         return "UsuariosUsuariosPerfilWC" ;
      }

      public override String GetPgmdesc( )
      {
         return "Usuarios Usuarios Perfil WC" ;
      }
      ...
      protected void WB2O0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "usuariosusuariosperfilwc.aspx");
            }
            /* Div Control */
            ...
            ClassString = "BtnAdd";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(20), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_UsuariosUsuariosPerfilWC.htm");
         ...
         if ( wbEnd == 20 )
         {
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtUsuariosId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A11UsuariosId), 6, 0, ",", "")), ((edtUsuariosId_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(A11UsuariosId), "ZZZZZ9")) : context.localUtil.Format( (decimal)(A11UsuariosId), "ZZZZZ9")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtUsuariosId_Jsonclick, 0, "Attribute", "", "", "", "", edtUsuariosId_Visible, edtUsuariosId_Enabled, 0, "number", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 1, -1, 0, true, "NumId", "right", false, "", "HLP_UsuariosUsuariosPerfilWC.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START2O2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Usuarios Usuarios Perfil WC", 0) ;
            }
            context.wjLoc = "";
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_PERFILES_ID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A278Perfiles_Id), "ZZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"PERFILES_ID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A278Perfiles_Id), 9, 0, ".", "")));
      }
      ...
      protected void RF2O2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A11UsuariosId = H002O2_A11UsuariosId[0];
               AssignAttri(sPrefix, false, "A11UsuariosId", StringUtil.LTrimStr( (decimal)(A11UsuariosId), 6, 0));
               A280Perfiles_Estatus = H002O2_A280Perfiles_Estatus[0];
               A279Perfiles_Nombre = H002O2_A279Perfiles_Nombre[0];
               A278Perfiles_Id = H002O2_A278Perfiles_Id[0];
               A280Perfiles_Estatus = H002O2_A280Perfiles_Estatus[0];
               A279Perfiles_Nombre = H002O2_A279Perfiles_Nombre[0];
               E132O2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_PERFILES_ID"+"_"+sGXsfl_20_idx, GetSecureSignedToken( sPrefix+sGXsfl_20_idx, context.localUtil.Format( (decimal)(A278Perfiles_Id), "ZZZZZZZZ9"), context));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "usuariosusuariosperfilwc", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202262714344593", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("usuariosusuariosperfilwc.js", "?202262714344594", false, true);
         }
      ...
      {
         edtPerfiles_Id_Internalname = sPrefix+"PERFILES_ID_"+sGXsfl_20_idx;
         edtPerfiles_Nombre_Internalname = sPrefix+"PERFILES_NOMBRE_"+sGXsfl_20_idx;
         cmbPerfiles_Estatus_Internalname = sPrefix+"PERFILES_ESTATUS_"+sGXsfl_20_idx;
      ...
      {
         edtPerfiles_Id_Internalname = sPrefix+"PERFILES_ID_"+sGXsfl_20_fel_idx;
         edtPerfiles_Nombre_Internalname = sPrefix+"PERFILES_NOMBRE_"+sGXsfl_20_fel_idx;
         cmbPerfiles_Estatus_Internalname = sPrefix+"PERFILES_ESTATUS_"+sGXsfl_20_fel_idx;
      ...
      protected void sendrow_202( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_20_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtPerfiles_Id_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A278Perfiles_Id), 9, 0, ",", "")),context.localUtil.Format( (decimal)(A278Perfiles_Id), "ZZZZZZZZ9"),(String)"",(String)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtPerfiles_Id_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn WWOptionalColumn",(String)"",(short)-1,(short)0,(short)0,(String)"number",(String)"1",(short)0,(String)"px",(short)17,(String)"px",(short)9,(short)0,(short)0,(short)20,(short)1,(short)-1,(short)0,(bool)true,(String)"Id",(String)"right",(bool)false,(String)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            AssignProp(sPrefix, false, cmbPerfiles_Estatus_Internalname, "Values", (String)(cmbPerfiles_Estatus.ToJavascriptSource()), !bGXsfl_20_Refreshing);
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E132O2',iparms:[{av:'A278Perfiles_Id',fld:'PERFILES_ID',pic:'ZZZZZZZZ9',hsh:true}]");
         ...
         setEventMetadata("'DOINSERT'","{handler:'E112O2',iparms:[{av:'A278Perfiles_Id',fld:'PERFILES_ID',pic:'ZZZZZZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         scmdbuf = "";
         H002O2_A11UsuariosId = new int[1] ;
         H002O2_A280Perfiles_Estatus = new short[1] ;
         H002O2_A279Perfiles_Nombre = new String[] {""} ;
         H002O2_A278Perfiles_Id = new int[1] ;
         ...
         ROClassString = "";
         GXCCtl = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.usuariosusuariosperfilwc__default(),
            new Object[][] {
                new Object[] {
               H002O2_A11UsuariosId, H002O2_A280Perfiles_Estatus, H002O2_A279Perfiles_Nombre, H002O2_A278Perfiles_Id
               }
               , new Object[] {
      ...
      private int[] H002O2_A11UsuariosId ;
      private short[] H002O2_A280Perfiles_Estatus ;
      private String[] H002O2_A279Perfiles_Nombre ;
      private int[] H002O2_A278Perfiles_Id ;
   ...
   public class usuariosusuariosperfilwc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H002O2", "SELECT T1.`UsuariosId`, T2.`Perfiles_Estatus`, T2.`Perfiles_Nombre`, T1.`Perfiles_Id` FROM (`PerfilesUsuariosPerfil` T1 INNER JOIN `Perfiles` T2 ON T2.`Perfiles_Id` = T1.`Perfiles_Id`) WHERE T1.`UsuariosId` = ? ORDER BY T1.`UsuariosId`  LIMIT ?, ?",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002O2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H002O3", "SELECT COUNT(*) FROM (`PerfilesUsuariosPerfil` T1 INNER JOIN `Perfiles` T2 ON T2.`Perfiles_Id` = T1.`Perfiles_Id`) WHERE T1.`UsuariosId` = ? ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002O3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
