...
CREATE TABLE `numerador` (
  `NumeradorCve` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `NumeradorNo` bigint NOT NULL,
  PRIMARY KEY (`NumeradorCve`)
...
INSERT INTO `numerador` VALUES ('Usr',10);
